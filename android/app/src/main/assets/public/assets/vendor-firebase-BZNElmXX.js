const ep="modulepreload",tp=function(n,e){return new URL(n,e).href},z1={},np=function(e,t,r){let s=Promise.resolve();if(t&&t.length>0){let o=function(f){return Promise.all(f.map(p=>Promise.resolve(p).then(w=>({status:"fulfilled",value:w}),w=>({status:"rejected",reason:w}))))};const c=document.getElementsByTagName("link"),u=document.querySelector("meta[property=csp-nonce]"),h=u?.nonce||u?.getAttribute("nonce");s=o(t.map(f=>{if(f=tp(f,r),f in z1)return;z1[f]=!0;const p=f.endsWith(".css"),w=p?'[rel="stylesheet"]':"";if(!!r)for(let L=c.length-1;L>=0;L--){const x=c[L];if(x.href===f&&(!p||x.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${f}"]${w}`))return;const P=document.createElement("link");if(P.rel=p?"stylesheet":ep,p||(P.as="script"),P.crossOrigin="",P.href=f,h&&P.setAttribute("nonce",h),document.head.appendChild(P),p)return new Promise((L,x)=>{P.addEventListener("load",L),P.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${f}`)))})}))}function i(o){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=o,window.dispatchEvent(c),!c.defaultPrevented)throw o}return s.then(o=>{for(const c of o||[])c.status==="rejected"&&i(c.reason);return e().catch(i)})};/*! Capacitor: https://capacitorjs.com/ - MIT License */var Or;(function(n){n.Unimplemented="UNIMPLEMENTED",n.Unavailable="UNAVAILABLE"})(Or||(Or={}));class Ma extends Error{constructor(e,t,r){super(e),this.message=e,this.code=t,this.data=r}}const rp=n=>{var e,t;return n?.androidBridge?"android":!((t=(e=n?.webkit)===null||e===void 0?void 0:e.messageHandlers)===null||t===void 0)&&t.bridge?"ios":"web"},sp=n=>{const e=n.CapacitorCustomPlatform||null,t=n.Capacitor||{},r=t.Plugins=t.Plugins||{},s=()=>e!==null?e.name:rp(n),i=()=>s()!=="web",o=p=>{const w=h.get(p);return!!(w?.platforms.has(s())||c(p))},c=p=>{var w;return(w=t.PluginHeaders)===null||w===void 0?void 0:w.find(b=>b.name===p)},u=p=>n.console.error(p),h=new Map,f=(p,w={})=>{const b=h.get(p);if(b)return console.warn(`Capacitor plugin "${p}" already registered. Cannot register plugins twice.`),b.proxy;const P=s(),L=c(p);let x;const z=async()=>(!x&&P in w?x=typeof w[P]=="function"?x=await w[P]():x=w[P]:e!==null&&!x&&"web"in w&&(x=typeof w.web=="function"?x=await w.web():x=w.web),x),te=(g,E)=>{var R,I;if(L){const C=L?.methods.find(_=>E===_.name);if(C)return C.rtype==="promise"?_=>t.nativePromise(p,E.toString(),_):(_,Le)=>t.nativeCallback(p,E.toString(),_,Le);if(g)return(R=g[E])===null||R===void 0?void 0:R.bind(g)}else{if(g)return(I=g[E])===null||I===void 0?void 0:I.bind(g);throw new Ma(`"${p}" plugin is not implemented on ${P}`,Or.Unimplemented)}},re=g=>{let E;const R=(...I)=>{const C=z().then(_=>{const Le=te(_,g);if(Le){const It=Le(...I);return E=It?.remove,It}else throw new Ma(`"${p}.${g}()" is not implemented on ${P}`,Or.Unimplemented)});return g==="addListener"&&(C.remove=async()=>E()),C};return R.toString=()=>`${g.toString()}() { [capacitor code] }`,Object.defineProperty(R,"name",{value:g,writable:!1,configurable:!1}),R},he=re("addListener"),Ve=re("removeListener"),_e=(g,E)=>{const R=he({eventName:g},E),I=async()=>{const _=await R;Ve({eventName:g,callbackId:_},E)},C=new Promise(_=>R.then(()=>_({remove:I})));return C.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await I()},C},A=new Proxy({},{get(g,E){switch(E){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return L?_e:he;case"removeListener":return Ve;default:return re(E)}}});return r[p]=A,h.set(p,{name:p,proxy:A,platforms:new Set([...Object.keys(w),...L?[P]:[]])}),A};return t.convertFileSrc||(t.convertFileSrc=p=>p),t.getPlatform=s,t.handleError=u,t.isNativePlatform=i,t.isPluginAvailable=o,t.registerPlugin=f,t.Exception=Ma,t.DEBUG=!!t.DEBUG,t.isLoggingEnabled=!!t.isLoggingEnabled,t},ip=n=>n.Capacitor=sp(n),rc=ip(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Po=rc.registerPlugin;class bo{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(e,t){let r=!1;this.listeners[e]||(this.listeners[e]=[],r=!0),this.listeners[e].push(t);const i=this.windowListeners[e];i&&!i.registered&&this.addWindowListener(i),r&&this.sendRetainedArgumentsForEvent(e);const o=async()=>this.removeListener(e,t);return Promise.resolve({remove:o})}async removeAllListeners(){this.listeners={};for(const e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,t,r){const s=this.listeners[e];if(!s){if(r){let i=this.retainedEventArguments[e];i||(i=[]),i.push(t),this.retainedEventArguments[e]=i}return}s.forEach(i=>i(t))}hasListeners(e){var t;return!!(!((t=this.listeners[e])===null||t===void 0)&&t.length)}registerWindowListener(e,t){this.windowListeners[t]={registered:!1,windowEventName:e,pluginEventName:t,handler:r=>{this.notifyListeners(t,r)}}}unimplemented(e="not implemented"){return new rc.Exception(e,Or.Unimplemented)}unavailable(e="not available"){return new rc.Exception(e,Or.Unavailable)}async removeListener(e,t){const r=this.listeners[e];if(!r)return;const s=r.indexOf(t);this.listeners[e].splice(s,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}sendRetainedArgumentsForEvent(e){const t=this.retainedEventArguments[e];t&&(delete this.retainedEventArguments[e],t.forEach(r=>{this.notifyListeners(e,r)}))}}const K1=n=>encodeURIComponent(n).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Y1=n=>n.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class op extends bo{async getCookies(){const e=document.cookie,t={};return e.split(";").forEach(r=>{if(r.length<=0)return;let[s,i]=r.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");s=Y1(s).trim(),i=Y1(i).trim(),t[s]=i}),t}async setCookie(e){try{const t=K1(e.key),r=K1(e.value),s=e.expires?`; expires=${e.expires.replace("expires=","")}`:"",i=(e.path||"/").replace("path=",""),o=e.url!=null&&e.url.length>0?`domain=${e.url}`:"";document.cookie=`${t}=${r||""}${s}; path=${i}; ${o};`}catch(t){return Promise.reject(t)}}async deleteCookie(e){try{document.cookie=`${e.key}=; Max-Age=0`}catch(t){return Promise.reject(t)}}async clearCookies(){try{const e=document.cookie.split(";")||[];for(const t of e)document.cookie=t.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(e){return Promise.reject(e)}}async clearAllCookies(){try{await this.clearCookies()}catch(e){return Promise.reject(e)}}}Po("CapacitorCookies",{web:()=>new op});const ap=async n=>new Promise((e,t)=>{const r=new FileReader;r.onload=()=>{const s=r.result;e(s.indexOf(",")>=0?s.split(",")[1]:s)},r.onerror=s=>t(s),r.readAsDataURL(n)}),cp=(n={})=>{const e=Object.keys(n);return Object.keys(n).map(s=>s.toLocaleLowerCase()).reduce((s,i,o)=>(s[i]=n[e[o]],s),{})},up=(n,e=!0)=>n?Object.entries(n).reduce((r,s)=>{const[i,o]=s;let c,u;return Array.isArray(o)?(u="",o.forEach(h=>{c=e?encodeURIComponent(h):h,u+=`${i}=${c}&`}),u.slice(0,-1)):(c=e?encodeURIComponent(o):o,u=`${i}=${c}`),`${r}&${u}`},"").substr(1):null,lp=(n,e={})=>{const t=Object.assign({method:n.method||"GET",headers:n.headers},e),s=cp(n.headers)["content-type"]||"";if(typeof n.data=="string")t.body=n.data;else if(s.includes("application/x-www-form-urlencoded")){const i=new URLSearchParams;for(const[o,c]of Object.entries(n.data||{}))i.set(o,c);t.body=i.toString()}else if(s.includes("multipart/form-data")||n.data instanceof FormData){const i=new FormData;if(n.data instanceof FormData)n.data.forEach((c,u)=>{i.append(u,c)});else for(const c of Object.keys(n.data))i.append(c,n.data[c]);t.body=i;const o=new Headers(t.headers);o.delete("content-type"),t.headers=o}else(s.includes("application/json")||typeof n.data=="object")&&(t.body=JSON.stringify(n.data));return t};class hp extends bo{async request(e){const t=lp(e,e.webFetchExtra),r=up(e.params,e.shouldEncodeUrlParams),s=r?`${e.url}?${r}`:e.url,i=await fetch(s,t),o=i.headers.get("content-type")||"";let{responseType:c="text"}=i.ok?e:{};o.includes("application/json")&&(c="json");let u,h;switch(c){case"arraybuffer":case"blob":h=await i.blob(),u=await ap(h);break;case"json":u=await i.json();break;case"document":case"text":default:u=await i.text()}const f={};return i.headers.forEach((p,w)=>{f[w]=p}),{data:u,headers:f,status:i.status,url:i.url}}async get(e){return this.request(Object.assign(Object.assign({},e),{method:"GET"}))}async post(e){return this.request(Object.assign(Object.assign({},e),{method:"POST"}))}async put(e){return this.request(Object.assign(Object.assign({},e),{method:"PUT"}))}async patch(e){return this.request(Object.assign(Object.assign({},e),{method:"PATCH"}))}async delete(e){return this.request(Object.assign(Object.assign({},e),{method:"DELETE"}))}}Po("CapacitorHttp",{web:()=>new hp});var Q1;(function(n){n.Dark="DARK",n.Light="LIGHT",n.Default="DEFAULT"})(Q1||(Q1={}));var X1;(function(n){n.StatusBar="StatusBar",n.NavigationBar="NavigationBar"})(X1||(X1={}));class dp extends bo{async setStyle(){this.unavailable("not available for web")}async setAnimation(){this.unavailable("not available for web")}async show(){this.unavailable("not available for web")}async hide(){this.unavailable("not available for web")}}Po("SystemBars",{web:()=>new dp});/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const e2=function(n){const e=[];let t=0;for(let r=0;r<n.length;r++){let s=n.charCodeAt(r);s<128?e[t++]=s:s<2048?(e[t++]=s>>6|192,e[t++]=s&63|128):(s&64512)===55296&&r+1<n.length&&(n.charCodeAt(r+1)&64512)===56320?(s=65536+((s&1023)<<10)+(n.charCodeAt(++r)&1023),e[t++]=s>>18|240,e[t++]=s>>12&63|128,e[t++]=s>>6&63|128,e[t++]=s&63|128):(e[t++]=s>>12|224,e[t++]=s>>6&63|128,e[t++]=s&63|128)}return e},pp=function(n){const e=[];let t=0,r=0;for(;t<n.length;){const s=n[t++];if(s<128)e[r++]=String.fromCharCode(s);else if(s>191&&s<224){const i=n[t++];e[r++]=String.fromCharCode((s&31)<<6|i&63)}else if(s>239&&s<365){const i=n[t++],o=n[t++],c=n[t++],u=((s&7)<<18|(i&63)<<12|(o&63)<<6|c&63)-65536;e[r++]=String.fromCharCode(55296+(u>>10)),e[r++]=String.fromCharCode(56320+(u&1023))}else{const i=n[t++],o=n[t++];e[r++]=String.fromCharCode((s&15)<<12|(i&63)<<6|o&63)}}return e.join("")},t2={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(n,e){if(!Array.isArray(n))throw Error("encodeByteArray takes an array as a parameter");this.init_();const t=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[];for(let s=0;s<n.length;s+=3){const i=n[s],o=s+1<n.length,c=o?n[s+1]:0,u=s+2<n.length,h=u?n[s+2]:0,f=i>>2,p=(i&3)<<4|c>>4;let w=(c&15)<<2|h>>6,b=h&63;u||(b=64,o||(w=64)),r.push(t[f],t[p],t[w],t[b])}return r.join("")},encodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(n):this.encodeByteArray(e2(n),e)},decodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(n):pp(this.decodeStringToByteArray(n,e))},decodeStringToByteArray(n,e){this.init_();const t=e?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let s=0;s<n.length;){const i=t[n.charAt(s++)],c=s<n.length?t[n.charAt(s)]:0;++s;const h=s<n.length?t[n.charAt(s)]:64;++s;const p=s<n.length?t[n.charAt(s)]:64;if(++s,i==null||c==null||h==null||p==null)throw new mp;const w=i<<2|c>>4;if(r.push(w),h!==64){const b=c<<4&240|h>>2;if(r.push(b),p!==64){const P=h<<6&192|p;r.push(P)}}}return r},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let n=0;n<this.ENCODED_VALS.length;n++)this.byteToCharMap_[n]=this.ENCODED_VALS.charAt(n),this.charToByteMap_[this.byteToCharMap_[n]]=n,this.byteToCharMapWebSafe_[n]=this.ENCODED_VALS_WEBSAFE.charAt(n),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[n]]=n,n>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(n)]=n,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(n)]=n)}}};class mp extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const gp=function(n){const e=e2(n);return t2.encodeByteArray(e,!0)},io=function(n){return gp(n).replace(/\./g,"")},n2=function(n){try{return t2.decodeString(n,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ep=()=>_p().__FIREBASE_DEFAULTS__,yp=()=>{if(typeof process>"u"||typeof J1>"u")return;const n=J1.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},wp=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=n&&n2(n[1]);return e&&JSON.parse(e)},No=()=>{try{return fp()||Ep()||yp()||wp()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},r2=n=>No()?.emulatorHosts?.[n],s2=n=>{const e=r2(n);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const r=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),r]:[e.substring(0,t),r]},i2=()=>No()?.config,o2=n=>No()?.[`_${n}`];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Je(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Ip(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Je())}function Tp(){const n=No()?.forceEnvironment;if(n==="node")return!0;if(n==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function Ap(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function Rp(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function vp(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Cp(){const n=Je();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function Sp(){return!Tp()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function Pp(){try{return typeof indexedDB=="object"}catch{return!1}}function bp(){return new Promise((n,e)=>{try{let t=!0;const r="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(r);s.onsuccess=()=>{s.result.close(),t||self.indexedDB.deleteDatabase(r),n(!0)},s.onupgradeneeded=()=>{t=!1},s.onerror=()=>{e(s.error?.message||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Np="FirebaseError";class Yt extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=Np,Object.setPrototypeOf(this,Yt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,ri.prototype.create)}}class ri{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,i=this.errors[e],o=i?Op(i,r):"Error",c=`${this.serviceName}: ${o} (${s}).`;return new Yt(s,c,r)}}function Op(n,e){return n.replace(kp,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const kp=/\{\$([^}]+)}/g;function Dp(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function or(n,e){if(n===e)return!0;const t=Object.keys(n),r=Object.keys(e);for(const s of t){if(!r.includes(s))return!1;const i=n[s],o=e[s];if(Z1(i)&&Z1(o)){if(!or(i,o))return!1}else if(i!==o)return!1}for(const s of r)if(!t.includes(s))return!1;return!0}function Z1(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fr(n){const e=[];for(const[t,r]of Object.entries(n))Array.isArray(r)?r.forEach(s=>{e.push(encodeURIComponent(t)+"="+encodeURIComponent(s))}):e.push(encodeURIComponent(t)+"="+encodeURIComponent(r));return e.length?"&"+e.join("&"):""}function _s(n){const e={};return n.replace(/^\?/,"").split("&").forEach(r=>{if(r){const[s,i]=r.split("=");e[decodeURIComponent(s)]=decodeURIComponent(i)}}),e}function Es(n){const e=n.indexOf("?");if(!e)return"";const t=n.indexOf("#",e);return n.substring(e,t>0?t:void 0)}function Vp(n,e){const t=new Lp(n,e);return t.subscribe.bind(t)}class Lp{constructor(e,t){this.observers=[],this.unsubscribes=[],this.observerCount=0,this.task=Promise.resolve(),this.finalized=!1,this.onNoObservers=t,this.task.then(()=>{e(this)}).catch(r=>{this.error(r)})}next(e){this.forEachObserver(t=>{t.next(e)})}error(e){this.forEachObserver(t=>{t.error(e)}),this.close(e)}complete(){this.forEachObserver(e=>{e.complete()}),this.close()}subscribe(e,t,r){let s;if(e===void 0&&t===void 0&&r===void 0)throw new Error("Missing Observer.");xp(e,["next","error","complete"])?s=e:s={next:e,error:t,complete:r},s.next===void 0&&(s.next=Ua),s.error===void 0&&(s.error=Ua),s.complete===void 0&&(s.complete=Ua);const i=this.unsubscribeOne.bind(this,this.observers.length);return this.finalized&&this.task.then(()=>{try{this.finalError?s.error(this.finalError):s.complete()}catch{}}),this.observers.push(s),i}unsubscribeOne(e){this.observers===void 0||this.observers[e]===void 0||(delete this.observers[e],this.observerCount-=1,this.observerCount===0&&this.onNoObservers!==void 0&&this.onNoObservers(this))}forEachObserver(e){if(!this.finalized)for(let t=0;t<this.observers.length;t++)this.sendOne(t,e)}sendOne(e,t){this.task.then(()=>{if(this.observers!==void 0&&this.observers[e]!==void 0)try{t(this.observers[e])}catch(r){typeof console<"u"&&console.error&&console.error(r)}})}close(e){this.finalized||(this.finalized=!0,e!==void 0&&(this.finalError=e),this.task.then(()=>{this.observers=void 0,this.onNoObservers=void 0}))}}function xp(n,e){if(typeof n!="object"||n===null)return!1;for(const t of e)if(t in n&&typeof n[t]=="function")return!0;return!1}function Ua(){}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mp{constructor(e,t){this.name=e,this.container=t,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(e){const t=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(t)){const r=new a2;if(this.instancesDeferred.set(t,r),this.isInitialized(t)||this.shouldAutoInitialize())try{const s=this.getOrInitializeService({instanceIdentifier:t});s&&r.resolve(s)}catch{}}return this.instancesDeferred.get(t).promise}getImmediate(e){const t=this.normalizeInstanceIdentifier(e?.identifier),r=e?.optional??!1;if(this.isInitialized(t)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:t})}catch(s){if(r)return null;throw s}else{if(r)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(e){if(e.name!==this.name)throw Error(`Mismatching Component ${e.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=e,!!this.shouldAutoInitialize()){if(Fp(e))try{this.getOrInitializeService({instanceIdentifier:Jn})}catch{}for(const[t,r]of this.instancesDeferred.entries()){const s=this.normalizeInstanceIdentifier(t);try{const i=this.getOrInitializeService({instanceIdentifier:s});r.resolve(i)}catch{}}}}clearInstance(e=Jn){this.instancesDeferred.delete(e),this.instancesOptions.delete(e),this.instances.delete(e)}async delete(){const e=Array.from(this.instances.values());await Promise.all([...e.filter(t=>"INTERNAL"in t).map(t=>t.INTERNAL.delete()),...e.filter(t=>"_delete"in t).map(t=>t._delete())])}isComponentSet(){return this.component!=null}isInitialized(e=Jn){return this.instances.has(e)}getOptions(e=Jn){return this.instancesOptions.get(e)||{}}initialize(e={}){const{options:t={}}=e,r=this.normalizeInstanceIdentifier(e.instanceIdentifier);if(this.isInitialized(r))throw Error(`${this.name}(${r}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const s=this.getOrInitializeService({instanceIdentifier:r,options:t});for(const[i,o]of this.instancesDeferred.entries()){const c=this.normalizeInstanceIdentifier(i);r===c&&o.resolve(s)}return s}onInit(e,t){const r=this.normalizeInstanceIdentifier(t),s=this.onInitCallbacks.get(r)??new Set;s.add(e),this.onInitCallbacks.set(r,s);const i=this.instances.get(r);return i&&e(i,r),()=>{s.delete(e)}}invokeOnInitCallbacks(e,t){const r=this.onInitCallbacks.get(t);if(r)for(const s of r)try{s(e,t)}catch{}}getOrInitializeService({instanceIdentifier:e,options:t={}}){let r=this.instances.get(e);if(!r&&this.component&&(r=this.component.instanceFactory(this.container,{instanceIdentifier:Up(e),options:t}),this.instances.set(e,r),this.instancesOptions.set(e,t),this.invokeOnInitCallbacks(r,e),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,e,r)}catch{}return r||null}normalizeInstanceIdentifier(e=Jn){return this.component?this.component.multipleInstances?e:Jn:e}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function Up(n){return n===Jn?void 0:n}function Fp(n){return n.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var oe;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(oe||(oe={}));const $p={debug:oe.DEBUG,verbose:oe.VERBOSE,info:oe.INFO,warn:oe.WARN,error:oe.ERROR,silent:oe.SILENT},Hp=oe.INFO,qp={[oe.DEBUG]:"log",[oe.VERBOSE]:"log",[oe.INFO]:"info",[oe.WARN]:"warn",[oe.ERROR]:"error"},jp=(n,e,...t)=>{if(e<n.logLevel)return;const r=new Date().toISOString(),s=qp[e];if(s)console[s](`[${r}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Dc{constructor(e){this.name=e,this._logLevel=Hp,this._logHandler=jp,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in oe))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?$p[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,oe.DEBUG,...e),this._logHandler(this,oe.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,oe.VERBOSE,...e),this._logHandler(this,oe.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,oe.INFO,...e),this._logHandler(this,oe.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,oe.WARN,...e),this._logHandler(this,oe.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,oe.ERROR,...e),this._logHandler(this,oe.ERROR,...e)}}const Gp=(n,e)=>e.some(t=>n instanceof t);let el,tl;function Wp(){return el||(el=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function zp(){return tl||(tl=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const u2=new WeakMap,sc=new WeakMap,l2=new WeakMap,Fa=new WeakMap,Vc=new WeakMap;function Kp(n){const e=new Promise((t,r)=>{const s=()=>{n.removeEventListener("success",i),n.removeEventListener("error",o)},i=()=>{t(vn(n.result)),s()},o=()=>{r(n.error),s()};n.addEventListener("success",i),n.addEventListener("error",o)});return e.then(t=>{t instanceof IDBCursor&&u2.set(t,n)}).catch(()=>{}),Vc.set(e,n),e}function Yp(n){if(sc.has(n))return;const e=new Promise((t,r)=>{const s=()=>{n.removeEventListener("complete",i),n.removeEventListener("error",o),n.removeEventListener("abort",o)},i=()=>{t(),s()},o=()=>{r(n.error||new DOMException("AbortError","AbortError")),s()};n.addEventListener("complete",i),n.addEventListener("error",o),n.addEventListener("abort",o)});sc.set(n,e)}let ic={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return sc.get(n);if(e==="objectStoreNames")return n.objectStoreNames||l2.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return vn(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function Qp(n){ic=n(ic)}function Xp(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const r=n.call(Ba(this),e,...t);return l2.set(r,e.sort?e.sort():[e]),vn(r)}:zp().includes(n)?function(...e){return n.apply(Ba(this),e),vn(u2.get(this))}:function(...e){return vn(n.apply(Ba(this),e))}}function Jp(n){return typeof n=="function"?Xp(n):(n instanceof IDBTransaction&&Yp(n),Gp(n,Wp())?new Proxy(n,ic):n)}function vn(n){if(n instanceof IDBRequest)return Kp(n);if(Fa.has(n))return Fa.get(n);const e=Jp(n);return e!==n&&(Fa.set(n,e),Vc.set(e,n)),e}const Ba=n=>Vc.get(n);function Zp(n,e,{blocked:t,upgrade:r,blocking:s,terminated:i}={}){const o=indexedDB.open(n,e),c=vn(o);return r&&o.addEventListener("upgradeneeded",u=>{r(vn(o.result),u.oldVersion,u.newVersion,vn(o.transaction),u)}),t&&o.addEventListener("blocked",u=>t(u.oldVersion,u.newVersion,u)),c.then(u=>{i&&u.addEventListener("close",()=>i()),s&&u.addEventListener("versionchange",h=>s(h.oldVersion,h.newVersion,h))}).catch(()=>{}),c}const e0=["get","getKey","getAll","getAllKeys","count"],t0=["put","add","delete","clear"],$a=new Map;function nl(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if($a.get(e))return $a.get(e);const t=e.replace(/FromIndex$/,""),r=e!==t,s=t0.includes(t);if(!(t in(r?IDBIndex:IDBObjectStore).prototype)||!(s||e0.includes(t)))return;const i=async function(o,...c){const u=this.transaction(o,s?"readwrite":"readonly");let h=u.store;return r&&(h=h.index(c.shift())),(await Promise.all([h[t](...c),s&&u.done]))[0]};return $a.set(e,i),i}Qp(n=>({...n,get:(e,t,r)=>nl(e,t)||n.get(e,t,r),has:(e,t)=>!!nl(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class n0{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(r0(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function r0(n){return n.getComponent()?.type==="VERSION"}const oc="@firebase/app",rl="0.15.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sn=new Dc("@firebase/app"),s0="@firebase/app-compat",i0="@firebase/analytics-compat",o0="@firebase/analytics",a0="@firebase/app-check-compat",c0="@firebase/app-check",u0="@firebase/auth",l0="@firebase/auth-compat",h0="@firebase/database",d0="@firebase/data-connect",f0="@firebase/database-compat",p0="@firebase/functions",m0="@firebase/functions-compat",g0="@firebase/installations",_0="@firebase/installations-compat",E0="@firebase/messaging",y0="@firebase/messaging-compat",w0="@firebase/performance",I0="@firebase/performance-compat",T0="@firebase/remote-config",A0="@firebase/remote-config-compat",R0="@firebase/storage",v0="@firebase/storage-compat",C0="@firebase/firestore",S0="@firebase/ai",P0="@firebase/firestore-compat",b0="firebase",N0="12.15.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ac="[DEFAULT]",O0={[oc]:"fire-core",[s0]:"fire-core-compat",[o0]:"fire-analytics",[i0]:"fire-analytics-compat",[c0]:"fire-app-check",[a0]:"fire-app-check-compat",[u0]:"fire-auth",[l0]:"fire-auth-compat",[h0]:"fire-rtdb",[d0]:"fire-data-connect",[f0]:"fire-rtdb-compat",[p0]:"fire-fn",[m0]:"fire-fn-compat",[g0]:"fire-iid",[_0]:"fire-iid-compat",[E0]:"fire-fcm",[y0]:"fire-fcm-compat",[w0]:"fire-perf",[I0]:"fire-perf-compat",[T0]:"fire-rc",[A0]:"fire-rc-compat",[R0]:"fire-gcs",[v0]:"fire-gcs-compat",[C0]:"fire-fst",[P0]:"fire-fst-compat",[S0]:"fire-vertex","fire-js":"fire-js",[b0]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fr=N0;function L0(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r={name:ac,automaticDataCollectionEnabled:!0,...e},s=r.name;if(typeof s!="string"||!s)throw Cn.create("bad-app-name",{appName:String(s)});if(t||(t=i2()),!t)throw Cn.create("no-options");const i=oo.get(s);if(i){if(or(t,i.options)&&or(r,i.config))return i;throw Cn.create("duplicate-app",{appName:s})}const o=new Bp(s);for(const u of cc.values())o.addComponent(u);const c=new V0(t,r,o);return oo.set(s,c),c}function Lc(n=ac){const e=oo.get(n);if(!e&&n===ac&&i2())return L0();if(!e)throw Cn.create("no-app",{appName:n});return e}function Bt(n,e,t){let r=O0[n]??n;t&&(r+=`-${t}`);const s=r.match(/\s|\//),i=e.match(/\s|\//);if(s||i){const o=[`Unable to register library "${r}" with version "${e}":`];s&&o.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&i&&o.push("and"),i&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),sn.warn(o.join(" "));return}ar(new kn(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const x0="firebase-heartbeat-database",M0=1,Us="firebase-heartbeat-store";let Ha=null;function h2(){return Ha||(Ha=Zp(x0,M0,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Us)}catch(t){console.warn(t)}}}}).catch(n=>{throw Cn.create("idb-open",{originalErrorMessage:n.message})})),Ha}async function U0(n){try{const t=(await h2()).transaction(Us),r=await t.objectStore(Us).get(d2(n));return await t.done,r}catch(e){if(e instanceof Yt)sn.warn(e.message);else{const t=Cn.create("idb-get",{originalErrorMessage:e?.message});sn.warn(t.message)}}}async function il(n,e){try{const r=(await h2()).transaction(Us,"readwrite");await r.objectStore(Us).put(e,d2(n)),await r.done}catch(t){if(t instanceof Yt)sn.warn(t.message);else{const r=Cn.create("idb-set",{originalErrorMessage:t?.message});sn.warn(r.message)}}}function d2(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const F0=1024,B0=30;class $0{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new q0(t),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){try{const t=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),r=ol();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===r||this._heartbeatsCache.heartbeats.some(s=>s.date===r))return;if(this._heartbeatsCache.heartbeats.push({date:r,agent:t}),this._heartbeatsCache.heartbeats.length>B0){const s=j0(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(s,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){sn.warn(e)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=ol(),{heartbeatsToSend:t,unsentEntries:r}=H0(this._heartbeatsCache.heartbeats),s=io(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(e){return sn.warn(e),""}}}function ol(){return new Date().toISOString().substring(0,10)}function H0(n,e=F0){const t=[];let r=n.slice();for(const s of n){const i=t.find(o=>o.agent===s.agent);if(i){if(i.dates.push(s.date),al(t)>e){i.dates.pop();break}}else if(t.push({agent:s.agent,dates:[s.date]}),al(t)>e){t.pop();break}r=r.slice(1)}return{heartbeatsToSend:t,unsentEntries:r}}class q0{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Pp()?bp().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await U0(this.app);return t?.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return il(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return il(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function al(n){return io(JSON.stringify({version:2,heartbeats:n})).length}function j0(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let r=1;r<n.length;r++)n[r].date<t&&(t=n[r].date,e=r);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function G0(n){ar(new kn("platform-logger",e=>new n0(e),"PRIVATE")),ar(new kn("heartbeat",e=>new $0(e),"PRIVATE")),Bt(oc,rl,n),Bt(oc,rl,"esm2020"),Bt("fire-js","")}G0("");var W0="firebase",z0="12.15.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Bt(W0,z0,"app");var cl=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var Sn,f2;(function(){var n;/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(A,g){function E(){}E.prototype=g.prototype,A.F=g.prototype,A.prototype=new E,A.prototype.constructor=A,A.D=function(R,I,C){for(var _=Array(arguments.length-2),Le=2;Le<arguments.length;Le++)_[Le-2]=arguments[Le];return g.prototype[I].apply(R,_)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,t),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(A,g,E){E||(E=0);const R=Array(16);if(typeof g=="string")for(var I=0;I<16;++I)R[I]=g.charCodeAt(E++)|g.charCodeAt(E++)<<8|g.charCodeAt(E++)<<16|g.charCodeAt(E++)<<24;else for(I=0;I<16;++I)R[I]=g[E++]|g[E++]<<8|g[E++]<<16|g[E++]<<24;g=A.g[0],E=A.g[1],I=A.g[2];let C=A.g[3],_;_=g+(C^E&(I^C))+R[0]+3614090360&4294967295,g=E+(_<<7&4294967295|_>>>25),_=C+(I^g&(E^I))+R[1]+3905402710&4294967295,C=g+(_<<12&4294967295|_>>>20),_=I+(E^C&(g^E))+R[2]+606105819&4294967295,I=C+(_<<17&4294967295|_>>>15),_=E+(g^I&(C^g))+R[3]+3250441966&4294967295,E=I+(_<<22&4294967295|_>>>10),_=g+(C^E&(I^C))+R[4]+4118548399&4294967295,g=E+(_<<7&4294967295|_>>>25),_=C+(I^g&(E^I))+R[5]+1200080426&4294967295,C=g+(_<<12&4294967295|_>>>20),_=I+(E^C&(g^E))+R[6]+2821735955&4294967295,I=C+(_<<17&4294967295|_>>>15),_=E+(g^I&(C^g))+R[7]+4249261313&4294967295,E=I+(_<<22&4294967295|_>>>10),_=g+(C^E&(I^C))+R[8]+1770035416&4294967295,g=E+(_<<7&4294967295|_>>>25),_=C+(I^g&(E^I))+R[9]+2336552879&4294967295,C=g+(_<<12&4294967295|_>>>20),_=I+(E^C&(g^E))+R[10]+4294925233&4294967295,I=C+(_<<17&4294967295|_>>>15),_=E+(g^I&(C^g))+R[11]+2304563134&4294967295,E=I+(_<<22&4294967295|_>>>10),_=g+(C^E&(I^C))+R[12]+1804603682&4294967295,g=E+(_<<7&4294967295|_>>>25),_=C+(I^g&(E^I))+R[13]+4254626195&4294967295,C=g+(_<<12&4294967295|_>>>20),_=I+(E^C&(g^E))+R[14]+2792965006&4294967295,I=C+(_<<17&4294967295|_>>>15),_=E+(g^I&(C^g))+R[15]+1236535329&4294967295,E=I+(_<<22&4294967295|_>>>10),_=g+(I^C&(E^I))+R[1]+4129170786&4294967295,g=E+(_<<5&4294967295|_>>>27),_=C+(E^I&(g^E))+R[6]+3225465664&4294967295,C=g+(_<<9&4294967295|_>>>23),_=I+(g^E&(C^g))+R[11]+643717713&4294967295,I=C+(_<<14&4294967295|_>>>18),_=E+(C^g&(I^C))+R[0]+3921069994&4294967295,E=I+(_<<20&4294967295|_>>>12),_=g+(I^C&(E^I))+R[5]+3593408605&4294967295,g=E+(_<<5&4294967295|_>>>27),_=C+(E^I&(g^E))+R[10]+38016083&4294967295,C=g+(_<<9&4294967295|_>>>23),_=I+(g^E&(C^g))+R[15]+3634488961&4294967295,I=C+(_<<14&4294967295|_>>>18),_=E+(C^g&(I^C))+R[4]+3889429448&4294967295,E=I+(_<<20&4294967295|_>>>12),_=g+(I^C&(E^I))+R[9]+568446438&4294967295,g=E+(_<<5&4294967295|_>>>27),_=C+(E^I&(g^E))+R[14]+3275163606&4294967295,C=g+(_<<9&4294967295|_>>>23),_=I+(g^E&(C^g))+R[3]+4107603335&4294967295,I=C+(_<<14&4294967295|_>>>18),_=E+(C^g&(I^C))+R[8]+1163531501&4294967295,E=I+(_<<20&4294967295|_>>>12),_=g+(I^C&(E^I))+R[13]+2850285829&4294967295,g=E+(_<<5&4294967295|_>>>27),_=C+(E^I&(g^E))+R[2]+4243563512&4294967295,C=g+(_<<9&4294967295|_>>>23),_=I+(g^E&(C^g))+R[7]+1735328473&4294967295,I=C+(_<<14&4294967295|_>>>18),_=E+(C^g&(I^C))+R[12]+2368359562&4294967295,E=I+(_<<20&4294967295|_>>>12),_=g+(E^I^C)+R[5]+4294588738&4294967295,g=E+(_<<4&4294967295|_>>>28),_=C+(g^E^I)+R[8]+2272392833&4294967295,C=g+(_<<11&4294967295|_>>>21),_=I+(C^g^E)+R[11]+1839030562&4294967295,I=C+(_<<16&4294967295|_>>>16),_=E+(I^C^g)+R[14]+4259657740&4294967295,E=I+(_<<23&4294967295|_>>>9),_=g+(E^I^C)+R[1]+2763975236&4294967295,g=E+(_<<4&4294967295|_>>>28),_=C+(g^E^I)+R[4]+1272893353&4294967295,C=g+(_<<11&4294967295|_>>>21),_=I+(C^g^E)+R[7]+4139469664&4294967295,I=C+(_<<16&4294967295|_>>>16),_=E+(I^C^g)+R[10]+3200236656&4294967295,E=I+(_<<23&4294967295|_>>>9),_=g+(E^I^C)+R[13]+681279174&4294967295,g=E+(_<<4&4294967295|_>>>28),_=C+(g^E^I)+R[0]+3936430074&4294967295,C=g+(_<<11&4294967295|_>>>21),_=I+(C^g^E)+R[3]+3572445317&4294967295,I=C+(_<<16&4294967295|_>>>16),_=E+(I^C^g)+R[6]+76029189&4294967295,E=I+(_<<23&4294967295|_>>>9),_=g+(E^I^C)+R[9]+3654602809&4294967295,g=E+(_<<4&4294967295|_>>>28),_=C+(g^E^I)+R[12]+3873151461&4294967295,C=g+(_<<11&4294967295|_>>>21),_=I+(C^g^E)+R[15]+530742520&4294967295,I=C+(_<<16&4294967295|_>>>16),_=E+(I^C^g)+R[2]+3299628645&4294967295,E=I+(_<<23&4294967295|_>>>9),_=g+(I^(E|~C))+R[0]+4096336452&4294967295,g=E+(_<<6&4294967295|_>>>26),_=C+(E^(g|~I))+R[7]+1126891415&4294967295,C=g+(_<<10&4294967295|_>>>22),_=I+(g^(C|~E))+R[14]+2878612391&4294967295,I=C+(_<<15&4294967295|_>>>17),_=E+(C^(I|~g))+R[5]+4237533241&4294967295,E=I+(_<<21&4294967295|_>>>11),_=g+(I^(E|~C))+R[12]+1700485571&4294967295,g=E+(_<<6&4294967295|_>>>26),_=C+(E^(g|~I))+R[3]+2399980690&4294967295,C=g+(_<<10&4294967295|_>>>22),_=I+(g^(C|~E))+R[10]+4293915773&4294967295,I=C+(_<<15&4294967295|_>>>17),_=E+(C^(I|~g))+R[1]+2240044497&4294967295,E=I+(_<<21&4294967295|_>>>11),_=g+(I^(E|~C))+R[8]+1873313359&4294967295,g=E+(_<<6&4294967295|_>>>26),_=C+(E^(g|~I))+R[15]+4264355552&4294967295,C=g+(_<<10&4294967295|_>>>22),_=I+(g^(C|~E))+R[6]+2734768916&4294967295,I=C+(_<<15&4294967295|_>>>17),_=E+(C^(I|~g))+R[13]+1309151649&4294967295,E=I+(_<<21&4294967295|_>>>11),_=g+(I^(E|~C))+R[4]+4149444226&4294967295,g=E+(_<<6&4294967295|_>>>26),_=C+(E^(g|~I))+R[11]+3174756917&4294967295,C=g+(_<<10&4294967295|_>>>22),_=I+(g^(C|~E))+R[2]+718787259&4294967295,I=C+(_<<15&4294967295|_>>>17),_=E+(C^(I|~g))+R[9]+3951481745&4294967295,A.g[0]=A.g[0]+g&4294967295,A.g[1]=A.g[1]+(I+(_<<21&4294967295|_>>>11))&4294967295,A.g[2]=A.g[2]+I&4294967295,A.g[3]=A.g[3]+C&4294967295}r.prototype.v=function(A,g){g===void 0&&(g=A.length);const E=g-this.blockSize,R=this.C;let I=this.h,C=0;for(;C<g;){if(I==0)for(;C<=E;)s(this,A,C),C+=this.blockSize;if(typeof A=="string"){for(;C<g;)if(R[I++]=A.charCodeAt(C++),I==this.blockSize){s(this,R),I=0;break}}else for(;C<g;)if(R[I++]=A[C++],I==this.blockSize){s(this,R),I=0;break}}this.h=I,this.o+=g},r.prototype.A=function(){var A=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);A[0]=128;for(var g=1;g<A.length-8;++g)A[g]=0;g=this.o*8;for(var E=A.length-8;E<A.length;++E)A[E]=g&255,g/=256;for(this.v(A),A=Array(16),g=0,E=0;E<4;++E)for(let R=0;R<32;R+=8)A[g++]=this.g[E]>>>R&255;return A};function i(A,g){var E=c;return Object.prototype.hasOwnProperty.call(E,A)?E[A]:E[A]=g(A)}function o(A,g){this.h=g;const E=[];let R=!0;for(let I=A.length-1;I>=0;I--){const C=A[I]|0;R&&C==g||(E[I]=C,R=!1)}this.g=E}var c={};function u(A){return-128<=A&&A<128?i(A,function(g){return new o([g|0],g<0?-1:0)}):new o([A|0],A<0?-1:0)}function h(A){if(isNaN(A)||!isFinite(A))return p;if(A<0)return x(h(-A));const g=[];let E=1;for(let R=0;A>=E;R++)g[R]=A/E|0,E*=4294967296;return new o(g,0)}function f(A,g){if(A.length==0)throw Error("number format error: empty string");if(g=g||10,g<2||36<g)throw Error("radix out of range: "+g);if(A.charAt(0)=="-")return x(f(A.substring(1),g));if(A.indexOf("-")>=0)throw Error('number format error: interior "-" character');const E=h(Math.pow(g,8));let R=p;for(let C=0;C<A.length;C+=8){var I=Math.min(8,A.length-C);const _=parseInt(A.substring(C,C+I),g);I<8?(I=h(Math.pow(g,I)),R=R.j(I).add(h(_))):(R=R.j(E),R=R.add(h(_)))}return R}var p=u(0),w=u(1),b=u(16777216);n=o.prototype,n.m=function(){if(L(this))return-x(this).m();let A=0,g=1;for(let E=0;E<this.g.length;E++){const R=this.i(E);A+=(R>=0?R:4294967296+R)*g,g*=4294967296}return A},n.toString=function(A){if(A=A||10,A<2||36<A)throw Error("radix out of range: "+A);if(P(this))return"0";if(L(this))return"-"+x(this).toString(A);const g=h(Math.pow(A,6));var E=this;let R="";for(;;){const I=he(E,g).g;E=z(E,I.j(g));let C=((E.g.length>0?E.g[0]:E.h)>>>0).toString(A);if(E=I,P(E))return C+R;for(;C.length<6;)C="0"+C;R=C+R}},n.i=function(A){return A<0?0:A<this.g.length?this.g[A]:this.h};function P(A){if(A.h!=0)return!1;for(let g=0;g<A.g.length;g++)if(A.g[g]!=0)return!1;return!0}function L(A){return A.h==-1}n.l=function(A){return A=z(this,A),L(A)?-1:P(A)?0:1};function x(A){const g=A.g.length,E=[];for(let R=0;R<g;R++)E[R]=~A.g[R];return new o(E,~A.h).add(w)}n.abs=function(){return L(this)?x(this):this},n.add=function(A){const g=Math.max(this.g.length,A.g.length),E=[];let R=0;for(let I=0;I<=g;I++){let C=R+(this.i(I)&65535)+(A.i(I)&65535),_=(C>>>16)+(this.i(I)>>>16)+(A.i(I)>>>16);R=_>>>16,C&=65535,_&=65535,E[I]=_<<16|C}return new o(E,E[E.length-1]&-2147483648?-1:0)};function z(A,g){return A.add(x(g))}n.j=function(A){if(P(this)||P(A))return p;if(L(this))return L(A)?x(this).j(x(A)):x(x(this).j(A));if(L(A))return x(this.j(x(A)));if(this.l(b)<0&&A.l(b)<0)return h(this.m()*A.m());const g=this.g.length+A.g.length,E=[];for(var R=0;R<2*g;R++)E[R]=0;for(R=0;R<this.g.length;R++)for(let I=0;I<A.g.length;I++){const C=this.i(R)>>>16,_=this.i(R)&65535,Le=A.i(I)>>>16,It=A.i(I)&65535;E[2*R+2*I]+=_*It,te(E,2*R+2*I),E[2*R+2*I+1]+=C*It,te(E,2*R+2*I+1),E[2*R+2*I+1]+=_*Le,te(E,2*R+2*I+1),E[2*R+2*I+2]+=C*Le,te(E,2*R+2*I+2)}for(A=0;A<g;A++)E[A]=E[2*A+1]<<16|E[2*A];for(A=g;A<2*g;A++)E[A]=0;return new o(E,0)};function te(A,g){for(;(A[g]&65535)!=A[g];)A[g+1]+=A[g]>>>16,A[g]&=65535,g++}function re(A,g){this.g=A,this.h=g}function he(A,g){if(P(g))throw Error("division by zero");if(P(A))return new re(p,p);if(L(A))return g=he(x(A),g),new re(x(g.g),x(g.h));if(L(g))return g=he(A,x(g)),new re(x(g.g),g.h);if(A.g.length>30){if(L(A)||L(g))throw Error("slowDivide_ only works with positive integers.");for(var E=w,R=g;R.l(A)<=0;)E=Ve(E),R=Ve(R);var I=_e(E,1),C=_e(R,1);for(R=_e(R,2),E=_e(E,2);!P(R);){var _=C.add(R);_.l(A)<=0&&(I=I.add(E),C=_),R=_e(R,1),E=_e(E,1)}return g=z(A,I.j(g)),new re(I,g)}for(I=p;A.l(g)>=0;){for(E=Math.max(1,Math.floor(A.m()/g.m())),R=Math.ceil(Math.log(E)/Math.LN2),R=R<=48?1:Math.pow(2,R-48),C=h(E),_=C.j(g);L(_)||_.l(A)>0;)E-=R,C=h(E),_=C.j(g);P(C)&&(C=w),I=I.add(C),A=z(A,_)}return new re(I,A)}n.B=function(A){return he(this,A).h},n.and=function(A){const g=Math.max(this.g.length,A.g.length),E=[];for(let R=0;R<g;R++)E[R]=this.i(R)&A.i(R);return new o(E,this.h&A.h)},n.or=function(A){const g=Math.max(this.g.length,A.g.length),E=[];for(let R=0;R<g;R++)E[R]=this.i(R)|A.i(R);return new o(E,this.h|A.h)},n.xor=function(A){const g=Math.max(this.g.length,A.g.length),E=[];for(let R=0;R<g;R++)E[R]=this.i(R)^A.i(R);return new o(E,this.h^A.h)};function Ve(A){const g=A.g.length+1,E=[];for(let R=0;R<g;R++)E[R]=A.i(R)<<1|A.i(R-1)>>>31;return new o(E,A.h)}function _e(A,g){const E=g>>5;g%=32;const R=A.g.length-E,I=[];for(let C=0;C<R;C++)I[C]=g>0?A.i(C+E)>>>g|A.i(C+E+1)<<32-g:A.i(C+E);return new o(I,A.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,f2=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.B,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=f,Sn=o}).apply(typeof cl<"u"?cl:typeof self<"u"?self:typeof window<"u"?window:{});var Mi=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var p2,ys,m2,Ki,uc,g2,_2,E2;(function(){var n,e=Object.defineProperty;function t(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof Mi=="object"&&Mi];for(var l=0;l<a.length;++l){var d=a[l];if(d&&d.Math==Math)return d}throw Error("Cannot find global object")}var r=t(this);function s(a,l){if(l)e:{var d=r;a=a.split(".");for(var m=0;m<a.length-1;m++){var S=a[m];if(!(S in d))break e;d=d[S]}a=a[a.length-1],m=d[a],l=l(m),l!=m&&l!=null&&e(d,a,{configurable:!0,writable:!0,value:l})}}s("Symbol.dispose",function(a){return a||Symbol("Symbol.dispose")}),s("Array.prototype.values",function(a){return a||function(){return this[Symbol.iterator]()}}),s("Object.entries",function(a){return a||function(l){var d=[],m;for(m in l)Object.prototype.hasOwnProperty.call(l,m)&&d.push([m,l[m]]);return d}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var i=i||{},o=this||self;function c(a){var l=typeof a;return l=="object"&&a!=null||l=="function"}function u(a,l,d){return a.call.apply(a.bind,arguments)}function h(a,l,d){return h=u,h.apply(null,arguments)}function f(a,l){var d=Array.prototype.slice.call(arguments,1);return function(){var m=d.slice();return m.push.apply(m,arguments),a.apply(this,m)}}function p(a,l){function d(){}d.prototype=l.prototype,a.Z=l.prototype,a.prototype=new d,a.prototype.constructor=a,a.Ob=function(m,S,O){for(var U=Array(arguments.length-2),ee=2;ee<arguments.length;ee++)U[ee-2]=arguments[ee];return l.prototype[S].apply(m,U)}}var w=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?a=>a&&AsyncContext.Snapshot.wrap(a):a=>a;function b(a){const l=a.length;if(l>0){const d=Array(l);for(let m=0;m<l;m++)d[m]=a[m];return d}return[]}function P(a,l){for(let m=1;m<arguments.length;m++){const S=arguments[m];var d=typeof S;if(d=d!="object"?d:S?Array.isArray(S)?"array":d:"null",d=="array"||d=="object"&&typeof S.length=="number"){d=a.length||0;const O=S.length||0;a.length=d+O;for(let U=0;U<O;U++)a[d+U]=S[U]}else a.push(S)}}class L{constructor(l,d){this.i=l,this.j=d,this.h=0,this.g=null}get(){let l;return this.h>0?(this.h--,l=this.g,this.g=l.next,l.next=null):l=this.i(),l}}function x(a){o.setTimeout(()=>{throw a},0)}function z(){var a=A;let l=null;return a.g&&(l=a.g,a.g=a.g.next,a.g||(a.h=null),l.next=null),l}class te{constructor(){this.h=this.g=null}add(l,d){const m=re.get();m.set(l,d),this.h?this.h.next=m:this.g=m,this.h=m}}var re=new L(()=>new he,a=>a.reset());class he{constructor(){this.next=this.g=this.h=null}set(l,d){this.h=l,this.g=d,this.next=null}reset(){this.next=this.g=this.h=null}}let Ve,_e=!1,A=new te,g=()=>{const a=Promise.resolve(void 0);Ve=()=>{a.then(E)}};function E(){for(var a;a=z();){try{a.h.call(a.g)}catch(d){x(d)}var l=re;l.j(a),l.h<100&&(l.h++,a.next=l.g,l.g=a)}_e=!1}function R(){this.u=this.u,this.C=this.C}R.prototype.u=!1,R.prototype.dispose=function(){this.u||(this.u=!0,this.N())},R.prototype[Symbol.dispose]=function(){this.dispose()},R.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function I(a,l){this.type=a,this.g=this.target=l,this.defaultPrevented=!1}I.prototype.h=function(){this.defaultPrevented=!0};var C=(function(){if(!o.addEventListener||!Object.defineProperty)return!1;var a=!1,l=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const d=()=>{};o.addEventListener("test",d,l),o.removeEventListener("test",d,l)}catch{}return a})();function _(a){return/^[\s\xa0]*$/.test(a)}function Le(a,l){I.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a&&this.init(a,l)}p(Le,I),Le.prototype.init=function(a,l){const d=this.type=a.type,m=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement,this.g=l,l=a.relatedTarget,l||(d=="mouseover"?l=a.fromElement:d=="mouseout"&&(l=a.toElement)),this.relatedTarget=l,m?(this.clientX=m.clientX!==void 0?m.clientX:m.pageX,this.clientY=m.clientY!==void 0?m.clientY:m.pageY,this.screenX=m.screenX||0,this.screenY=m.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=a.pointerType,this.state=a.state,this.i=a,a.defaultPrevented&&Le.Z.h.call(this)},Le.prototype.h=function(){Le.Z.h.call(this);const a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var It="closure_listenable_"+(Math.random()*1e6|0),T6=0;function A6(a,l,d,m,S){this.listener=a,this.proxy=null,this.src=l,this.type=d,this.capture=!!m,this.ha=S,this.key=++T6,this.da=this.fa=!1}function Ti(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function Ai(a,l,d){for(const m in a)l.call(d,a[m],m,a)}function R6(a,l){for(const d in a)l.call(void 0,a[d],d,a)}function Wu(a){const l={};for(const d in a)l[d]=a[d];return l}const zu="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Ku(a,l){let d,m;for(let S=1;S<arguments.length;S++){m=arguments[S];for(d in m)a[d]=m[d];for(let O=0;O<zu.length;O++)d=zu[O],Object.prototype.hasOwnProperty.call(m,d)&&(a[d]=m[d])}}function Ri(a){this.src=a,this.g={},this.h=0}Ri.prototype.add=function(a,l,d,m,S){const O=a.toString();a=this.g[O],a||(a=this.g[O]=[],this.h++);const U=pa(a,l,m,S);return U>-1?(l=a[U],d||(l.fa=!1)):(l=new A6(l,this.src,O,!!m,S),l.fa=d,a.push(l)),l};function fa(a,l){const d=l.type;if(d in a.g){var m=a.g[d],S=Array.prototype.indexOf.call(m,l,void 0),O;(O=S>=0)&&Array.prototype.splice.call(m,S,1),O&&(Ti(l),a.g[d].length==0&&(delete a.g[d],a.h--))}}function pa(a,l,d,m){for(let S=0;S<a.length;++S){const O=a[S];if(!O.da&&O.listener==l&&O.capture==!!d&&O.ha==m)return S}return-1}var ma="closure_lm_"+(Math.random()*1e6|0),ga={};function Yu(a,l,d,m,S){if(Array.isArray(l)){for(let O=0;O<l.length;O++)Yu(a,l[O],d,m,S);return null}return d=Ju(d),a&&a[It]?a.J(l,d,c(m)?!!m.capture:!1,S):v6(a,l,d,!1,m,S)}function v6(a,l,d,m,S,O){if(!l)throw Error("Invalid event type");const U=c(S)?!!S.capture:!!S;let ee=Ea(a);if(ee||(a[ma]=ee=new Ri(a)),d=ee.add(l,d,m,U,O),d.proxy)return d;if(m=C6(),d.proxy=m,m.src=a,m.listener=d,a.addEventListener)C||(S=U),S===void 0&&(S=!1),a.addEventListener(l.toString(),m,S);else if(a.attachEvent)a.attachEvent(Xu(l.toString()),m);else if(a.addListener&&a.removeListener)a.addListener(m);else throw Error("addEventListener and attachEvent are unavailable.");return d}function C6(){function a(d){return l.call(a.src,a.listener,d)}const l=S6;return a}function Qu(a,l,d,m,S){if(Array.isArray(l))for(var O=0;O<l.length;O++)Qu(a,l[O],d,m,S);else m=c(m)?!!m.capture:!!m,d=Ju(d),a&&a[It]?(a=a.i,O=String(l).toString(),O in a.g&&(l=a.g[O],d=pa(l,d,m,S),d>-1&&(Ti(l[d]),Array.prototype.splice.call(l,d,1),l.length==0&&(delete a.g[O],a.h--)))):a&&(a=Ea(a))&&(l=a.g[l.toString()],a=-1,l&&(a=pa(l,d,m,S)),(d=a>-1?l[a]:null)&&_a(d))}function _a(a){if(typeof a!="number"&&a&&!a.da){var l=a.src;if(l&&l[It])fa(l.i,a);else{var d=a.type,m=a.proxy;l.removeEventListener?l.removeEventListener(d,m,a.capture):l.detachEvent?l.detachEvent(Xu(d),m):l.addListener&&l.removeListener&&l.removeListener(m),(d=Ea(l))?(fa(d,a),d.h==0&&(d.src=null,l[ma]=null)):Ti(a)}}}function Xu(a){return a in ga?ga[a]:ga[a]="on"+a}function S6(a,l){if(a.da)a=!0;else{l=new Le(l,this);const d=a.listener,m=a.ha||a.src;a.fa&&_a(a),a=d.call(m,l)}return a}function Ea(a){return a=a[ma],a instanceof Ri?a:null}var ya="__closure_events_fn_"+(Math.random()*1e9>>>0);function Ju(a){return typeof a=="function"?a:(a[ya]||(a[ya]=function(l){return a.handleEvent(l)}),a[ya])}function ze(){R.call(this),this.i=new Ri(this),this.M=this,this.G=null}p(ze,R),ze.prototype[It]=!0,ze.prototype.removeEventListener=function(a,l,d,m){Qu(this,a,l,d,m)};function et(a,l){var d,m=a.G;if(m)for(d=[];m;m=m.G)d.push(m);if(a=a.M,m=l.type||l,typeof l=="string")l=new I(l,a);else if(l instanceof I)l.target=l.target||a;else{var S=l;l=new I(m,a),Ku(l,S)}S=!0;let O,U;if(d)for(U=d.length-1;U>=0;U--)O=l.g=d[U],S=vi(O,m,!0,l)&&S;if(O=l.g=a,S=vi(O,m,!0,l)&&S,S=vi(O,m,!1,l)&&S,d)for(U=0;U<d.length;U++)O=l.g=d[U],S=vi(O,m,!1,l)&&S}ze.prototype.N=function(){if(ze.Z.N.call(this),this.i){var a=this.i;for(const l in a.g){const d=a.g[l];for(let m=0;m<d.length;m++)Ti(d[m]);delete a.g[l],a.h--}}this.G=null},ze.prototype.J=function(a,l,d,m){return this.i.add(String(a),l,!1,d,m)},ze.prototype.K=function(a,l,d,m){return this.i.add(String(a),l,!0,d,m)};function vi(a,l,d,m){if(l=a.i.g[String(l)],!l)return!0;l=l.concat();let S=!0;for(let O=0;O<l.length;++O){const U=l[O];if(U&&!U.da&&U.capture==d){const ee=U.listener,xe=U.ha||U.src;U.fa&&fa(a.i,U),S=ee.call(xe,m)!==!1&&S}}return S&&!m.defaultPrevented}function P6(a,l){if(typeof a!="function")if(a&&typeof a.handleEvent=="function")a=h(a.handleEvent,a);else throw Error("Invalid listener argument");return Number(l)>2147483647?-1:o.setTimeout(a,l||0)}function Zu(a){a.g=P6(()=>{a.g=null,a.i&&(a.i=!1,Zu(a))},a.l);const l=a.h;a.h=null,a.m.apply(null,l)}class b6 extends R{constructor(l,d){super(),this.m=l,this.l=d,this.h=null,this.i=!1,this.g=null}j(l){this.h=arguments,this.g?this.i=!0:Zu(this)}N(){super.N(),this.g&&(o.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Xr(a){R.call(this),this.h=a,this.g={}}p(Xr,R);var e1=[];function t1(a){Ai(a.g,function(l,d){this.g.hasOwnProperty(d)&&_a(l)},a),a.g={}}Xr.prototype.N=function(){Xr.Z.N.call(this),t1(this)},Xr.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var wa=o.JSON.stringify,N6=o.JSON.parse,O6=class{stringify(a){return o.JSON.stringify(a,void 0)}parse(a){return o.JSON.parse(a,void 0)}};function n1(){}function r1(){}var Jr={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Ia(){I.call(this,"d")}p(Ia,I);function Ta(){I.call(this,"c")}p(Ta,I);var zn={},s1=null;function Ci(){return s1=s1||new ze}zn.Ia="serverreachability";function i1(a){I.call(this,zn.Ia,a)}p(i1,I);function Zr(a){const l=Ci();et(l,new i1(l))}zn.STAT_EVENT="statevent";function o1(a,l){I.call(this,zn.STAT_EVENT,a),this.stat=l}p(o1,I);function tt(a){const l=Ci();et(l,new o1(l,a))}zn.Ja="timingevent";function a1(a,l){I.call(this,zn.Ja,a),this.size=l}p(a1,I);function es(a,l){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return o.setTimeout(function(){a()},l)}function ts(){this.g=!0}ts.prototype.ua=function(){this.g=!1};function k6(a,l,d,m,S,O){a.info(function(){if(a.g)if(O){var U="",ee=O.split("&");for(let fe=0;fe<ee.length;fe++){var xe=ee[fe].split("=");if(xe.length>1){const $e=xe[0];xe=xe[1];const Lt=$e.split("_");U=Lt.length>=2&&Lt[1]=="type"?U+($e+"="+xe+"&"):U+($e+"=redacted&")}}}else U=null;else U=O;return"XMLHTTP REQ ("+m+") [attempt "+S+"]: "+l+`
`+d+`
`+U})}function D6(a,l,d,m,S,O,U){a.info(function(){return"XMLHTTP RESP ("+m+") [ attempt "+S+"]: "+l+`
`+d+`
`+O+" "+U})}function _r(a,l,d,m){a.info(function(){return"XMLHTTP TEXT ("+l+"): "+L6(a,d)+(m?" "+m:"")})}function V6(a,l){a.info(function(){return"TIMEOUT: "+l})}ts.prototype.info=function(){};function L6(a,l){if(!a.g)return l;if(!l)return null;try{const O=JSON.parse(l);if(O){for(a=0;a<O.length;a++)if(Array.isArray(O[a])){var d=O[a];if(!(d.length<2)){var m=d[1];if(Array.isArray(m)&&!(m.length<1)){var S=m[0];if(S!="noop"&&S!="stop"&&S!="close")for(let U=1;U<m.length;U++)m[U]=""}}}}return wa(O)}catch{return l}}var Si={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},c1={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},u1;function Aa(){}p(Aa,n1),Aa.prototype.g=function(){return new XMLHttpRequest},u1=new Aa;function ns(a){return encodeURIComponent(String(a))}function x6(a){var l=1;a=a.split(":");const d=[];for(;l>0&&a.length;)d.push(a.shift()),l--;return a.length&&d.push(a.join(":")),d}function dn(a,l,d,m){this.j=a,this.i=l,this.l=d,this.S=m||1,this.V=new Xr(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new l1}function l1(){this.i=null,this.g="",this.h=!1}var h1={},Ra={};function va(a,l,d){a.M=1,a.A=bi(Vt(l)),a.u=d,a.R=!0,d1(a,null)}function d1(a,l){a.F=Date.now(),Pi(a),a.B=Vt(a.A);var d=a.B,m=a.S;Array.isArray(m)||(m=[String(m)]),v1(d.i,"t",m),a.C=0,d=a.j.L,a.h=new l1,a.g=q1(a.j,d?l:null,!a.u),a.P>0&&(a.O=new b6(h(a.Y,a,a.g),a.P)),l=a.V,d=a.g,m=a.ba;var S="readystatechange";Array.isArray(S)||(S&&(e1[0]=S.toString()),S=e1);for(let O=0;O<S.length;O++){const U=Yu(d,S[O],m||l.handleEvent,!1,l.h||l);if(!U)break;l.g[U.key]=U}l=a.J?Wu(a.J):{},a.u?(a.v||(a.v="POST"),l["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.B,a.v,a.u,l)):(a.v="GET",a.g.ea(a.B,a.v,null,l)),Zr(),k6(a.i,a.v,a.B,a.l,a.S,a.u)}dn.prototype.ba=function(a){a=a.target;const l=this.O;l&&mn(a)==3?l.j():this.Y(a)},dn.prototype.Y=function(a){try{if(a==this.g)e:{const ee=mn(this.g),xe=this.g.ya(),fe=this.g.ca();if(!(ee<3)&&(ee!=3||this.g&&(this.h.h||this.g.la()||k1(this.g)))){this.K||ee!=4||xe==7||(xe==8||fe<=0?Zr(3):Zr(2)),Ca(this);var l=this.g.ca();this.X=l;var d=M6(this);if(this.o=l==200,D6(this.i,this.v,this.B,this.l,this.S,ee,l),this.o){if(this.U&&!this.L){t:{if(this.g){var m,S=this.g;if((m=S.g?S.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!_(m)){var O=m;break t}}O=null}if(a=O)_r(this.i,this.l,a,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Sa(this,a);else{this.o=!1,this.m=3,tt(12),Kn(this),rs(this);break e}}if(this.R){a=!0;let $e;for(;!this.K&&this.C<d.length;)if($e=U6(this,d),$e==Ra){ee==4&&(this.m=4,tt(14),a=!1),_r(this.i,this.l,null,"[Incomplete Response]");break}else if($e==h1){this.m=4,tt(15),_r(this.i,this.l,d,"[Invalid Chunk]"),a=!1;break}else _r(this.i,this.l,$e,null),Sa(this,$e);if(f1(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),ee!=4||d.length!=0||this.h.h||(this.m=1,tt(16),a=!1),this.o=this.o&&a,!a)_r(this.i,this.l,d,"[Invalid Chunked Response]"),Kn(this),rs(this);else if(d.length>0&&!this.W){this.W=!0;var U=this.j;U.g==this&&U.aa&&!U.P&&(U.j.info("Great, no buffering proxy detected. Bytes received: "+d.length),La(U),U.P=!0,tt(11))}}else _r(this.i,this.l,d,null),Sa(this,d);ee==4&&Kn(this),this.o&&!this.K&&(ee==4?F1(this.j,this):(this.o=!1,Pi(this)))}else J6(this.g),l==400&&d.indexOf("Unknown SID")>0?(this.m=3,tt(12)):(this.m=0,tt(13)),Kn(this),rs(this)}}}catch{}finally{}};function M6(a){if(!f1(a))return a.g.la();const l=k1(a.g);if(l==="")return"";let d="";const m=l.length,S=mn(a.g)==4;if(!a.h.i){if(typeof TextDecoder>"u")return Kn(a),rs(a),"";a.h.i=new o.TextDecoder}for(let O=0;O<m;O++)a.h.h=!0,d+=a.h.i.decode(l[O],{stream:!(S&&O==m-1)});return l.length=0,a.h.g+=d,a.C=0,a.h.g}function f1(a){return a.g?a.v=="GET"&&a.M!=2&&a.j.Aa:!1}function U6(a,l){var d=a.C,m=l.indexOf(`
`,d);return m==-1?Ra:(d=Number(l.substring(d,m)),isNaN(d)?h1:(m+=1,m+d>l.length?Ra:(l=l.slice(m,m+d),a.C=m+d,l)))}dn.prototype.cancel=function(){this.K=!0,Kn(this)};function Pi(a){a.T=Date.now()+a.H,p1(a,a.H)}function p1(a,l){if(a.D!=null)throw Error("WatchDog timer not null");a.D=es(h(a.aa,a),l)}function Ca(a){a.D&&(o.clearTimeout(a.D),a.D=null)}dn.prototype.aa=function(){this.D=null;const a=Date.now();a-this.T>=0?(V6(this.i,this.B),this.M!=2&&(Zr(),tt(17)),Kn(this),this.m=2,rs(this)):p1(this,this.T-a)};function rs(a){a.j.I==0||a.K||F1(a.j,a)}function Kn(a){Ca(a);var l=a.O;l&&typeof l.dispose=="function"&&l.dispose(),a.O=null,t1(a.V),a.g&&(l=a.g,a.g=null,l.abort(),l.dispose())}function Sa(a,l){try{var d=a.j;if(d.I!=0&&(d.g==a||Pa(d.h,a))){if(!a.L&&Pa(d.h,a)&&d.I==3){try{var m=d.Ba.g.parse(l)}catch{m=null}if(Array.isArray(m)&&m.length==3){var S=m;if(S[0]==0){e:if(!d.v){if(d.g)if(d.g.F+3e3<a.F)Vi(d),ki(d);else break e;Va(d),tt(18)}}else d.xa=S[1],0<d.xa-d.K&&S[2]<37500&&d.F&&d.A==0&&!d.C&&(d.C=es(h(d.Va,d),6e3));_1(d.h)<=1&&d.ta&&(d.ta=void 0)}else Qn(d,11)}else if((a.L||d.g==a)&&Vi(d),!_(l))for(S=d.Ba.g.parse(l),l=0;l<S.length;l++){let fe=S[l];const $e=fe[0];if(!($e<=d.K))if(d.K=$e,fe=fe[1],d.I==2)if(fe[0]=="c"){d.M=fe[1],d.ba=fe[2];const Lt=fe[3];Lt!=null&&(d.ka=Lt,d.j.info("VER="+d.ka));const Xn=fe[4];Xn!=null&&(d.za=Xn,d.j.info("SVER="+d.za));const gn=fe[5];gn!=null&&typeof gn=="number"&&gn>0&&(m=1.5*gn,d.O=m,d.j.info("backChannelRequestTimeoutMs_="+m)),m=d;const _n=a.g;if(_n){const xi=_n.g?_n.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(xi){var O=m.h;O.g||xi.indexOf("spdy")==-1&&xi.indexOf("quic")==-1&&xi.indexOf("h2")==-1||(O.j=O.l,O.g=new Set,O.h&&(ba(O,O.h),O.h=null))}if(m.G){const xa=_n.g?_n.g.getResponseHeader("X-HTTP-Session-Id"):null;xa&&(m.wa=xa,pe(m.J,m.G,xa))}}d.I=3,d.l&&d.l.ra(),d.aa&&(d.T=Date.now()-a.F,d.j.info("Handshake RTT: "+d.T+"ms")),m=d;var U=a;if(m.na=H1(m,m.L?m.ba:null,m.W),U.L){E1(m.h,U);var ee=U,xe=m.O;xe&&(ee.H=xe),ee.D&&(Ca(ee),Pi(ee)),m.g=U}else M1(m);d.i.length>0&&Di(d)}else fe[0]!="stop"&&fe[0]!="close"||Qn(d,7);else d.I==3&&(fe[0]=="stop"||fe[0]=="close"?fe[0]=="stop"?Qn(d,7):Da(d):fe[0]!="noop"&&d.l&&d.l.qa(fe),d.A=0)}}Zr(4)}catch{}}var F6=class{constructor(a,l){this.g=a,this.map=l}};function m1(a){this.l=a||10,o.PerformanceNavigationTiming?(a=o.performance.getEntriesByType("navigation"),a=a.length>0&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(o.chrome&&o.chrome.loadTimes&&o.chrome.loadTimes()&&o.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function g1(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function _1(a){return a.h?1:a.g?a.g.size:0}function Pa(a,l){return a.h?a.h==l:a.g?a.g.has(l):!1}function ba(a,l){a.g?a.g.add(l):a.h=l}function E1(a,l){a.h&&a.h==l?a.h=null:a.g&&a.g.has(l)&&a.g.delete(l)}m1.prototype.cancel=function(){if(this.i=y1(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function y1(a){if(a.h!=null)return a.i.concat(a.h.G);if(a.g!=null&&a.g.size!==0){let l=a.i;for(const d of a.g.values())l=l.concat(d.G);return l}return b(a.i)}var w1=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function B6(a,l){if(a){a=a.split("&");for(let d=0;d<a.length;d++){const m=a[d].indexOf("=");let S,O=null;m>=0?(S=a[d].substring(0,m),O=a[d].substring(m+1)):S=a[d],l(S,O?decodeURIComponent(O.replace(/\+/g," ")):"")}}}function fn(a){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let l;a instanceof fn?(this.l=a.l,ss(this,a.j),this.o=a.o,this.g=a.g,is(this,a.u),this.h=a.h,Na(this,C1(a.i)),this.m=a.m):a&&(l=String(a).match(w1))?(this.l=!1,ss(this,l[1]||"",!0),this.o=os(l[2]||""),this.g=os(l[3]||"",!0),is(this,l[4]),this.h=os(l[5]||"",!0),Na(this,l[6]||"",!0),this.m=os(l[7]||"")):(this.l=!1,this.i=new cs(null,this.l))}fn.prototype.toString=function(){const a=[];var l=this.j;l&&a.push(as(l,I1,!0),":");var d=this.g;return(d||l=="file")&&(a.push("//"),(l=this.o)&&a.push(as(l,I1,!0),"@"),a.push(ns(d).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),d=this.u,d!=null&&a.push(":",String(d))),(d=this.h)&&(this.g&&d.charAt(0)!="/"&&a.push("/"),a.push(as(d,d.charAt(0)=="/"?q6:H6,!0))),(d=this.i.toString())&&a.push("?",d),(d=this.m)&&a.push("#",as(d,G6)),a.join("")},fn.prototype.resolve=function(a){const l=Vt(this);let d=!!a.j;d?ss(l,a.j):d=!!a.o,d?l.o=a.o:d=!!a.g,d?l.g=a.g:d=a.u!=null;var m=a.h;if(d)is(l,a.u);else if(d=!!a.h){if(m.charAt(0)!="/")if(this.g&&!this.h)m="/"+m;else{var S=l.h.lastIndexOf("/");S!=-1&&(m=l.h.slice(0,S+1)+m)}if(S=m,S==".."||S==".")m="";else if(S.indexOf("./")!=-1||S.indexOf("/.")!=-1){m=S.lastIndexOf("/",0)==0,S=S.split("/");const O=[];for(let U=0;U<S.length;){const ee=S[U++];ee=="."?m&&U==S.length&&O.push(""):ee==".."?((O.length>1||O.length==1&&O[0]!="")&&O.pop(),m&&U==S.length&&O.push("")):(O.push(ee),m=!0)}m=O.join("/")}else m=S}return d?l.h=m:d=a.i.toString()!=="",d?Na(l,C1(a.i)):d=!!a.m,d&&(l.m=a.m),l};function Vt(a){return new fn(a)}function ss(a,l,d){a.j=d?os(l,!0):l,a.j&&(a.j=a.j.replace(/:$/,""))}function is(a,l){if(l){if(l=Number(l),isNaN(l)||l<0)throw Error("Bad port number "+l);a.u=l}else a.u=null}function Na(a,l,d){l instanceof cs?(a.i=l,W6(a.i,a.l)):(d||(l=as(l,j6)),a.i=new cs(l,a.l))}function pe(a,l,d){a.i.set(l,d)}function bi(a){return pe(a,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),a}function os(a,l){return a?l?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function as(a,l,d){return typeof a=="string"?(a=encodeURI(a).replace(l,$6),d&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function $6(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var I1=/[#\/\?@]/g,H6=/[#\?:]/g,q6=/[#\?]/g,j6=/[#\?@]/g,G6=/#/g;function cs(a,l){this.h=this.g=null,this.i=a||null,this.j=!!l}function Yn(a){a.g||(a.g=new Map,a.h=0,a.i&&B6(a.i,function(l,d){a.add(decodeURIComponent(l.replace(/\+/g," ")),d)}))}n=cs.prototype,n.add=function(a,l){Yn(this),this.i=null,a=Er(this,a);let d=this.g.get(a);return d||this.g.set(a,d=[]),d.push(l),this.h+=1,this};function T1(a,l){Yn(a),l=Er(a,l),a.g.has(l)&&(a.i=null,a.h-=a.g.get(l).length,a.g.delete(l))}function A1(a,l){return Yn(a),l=Er(a,l),a.g.has(l)}n.forEach=function(a,l){Yn(this),this.g.forEach(function(d,m){d.forEach(function(S){a.call(l,S,m,this)},this)},this)};function R1(a,l){Yn(a);let d=[];if(typeof l=="string")A1(a,l)&&(d=d.concat(a.g.get(Er(a,l))));else for(a=Array.from(a.g.values()),l=0;l<a.length;l++)d=d.concat(a[l]);return d}n.set=function(a,l){return Yn(this),this.i=null,a=Er(this,a),A1(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[l]),this.h+=1,this},n.get=function(a,l){return a?(a=R1(this,a),a.length>0?String(a[0]):l):l};function v1(a,l,d){T1(a,l),d.length>0&&(a.i=null,a.g.set(Er(a,l),b(d)),a.h+=d.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],l=Array.from(this.g.keys());for(let m=0;m<l.length;m++){var d=l[m];const S=ns(d);d=R1(this,d);for(let O=0;O<d.length;O++){let U=S;d[O]!==""&&(U+="="+ns(d[O])),a.push(U)}}return this.i=a.join("&")};function C1(a){const l=new cs;return l.i=a.i,a.g&&(l.g=new Map(a.g),l.h=a.h),l}function Er(a,l){return l=String(l),a.j&&(l=l.toLowerCase()),l}function W6(a,l){l&&!a.j&&(Yn(a),a.i=null,a.g.forEach(function(d,m){const S=m.toLowerCase();m!=S&&(T1(this,m),v1(this,S,d))},a)),a.j=l}function z6(a,l){const d=new ts;if(o.Image){const m=new Image;m.onload=f(pn,d,"TestLoadImage: loaded",!0,l,m),m.onerror=f(pn,d,"TestLoadImage: error",!1,l,m),m.onabort=f(pn,d,"TestLoadImage: abort",!1,l,m),m.ontimeout=f(pn,d,"TestLoadImage: timeout",!1,l,m),o.setTimeout(function(){m.ontimeout&&m.ontimeout()},1e4),m.src=a}else l(!1)}function K6(a,l){const d=new ts,m=new AbortController,S=setTimeout(()=>{m.abort(),pn(d,"TestPingServer: timeout",!1,l)},1e4);fetch(a,{signal:m.signal}).then(O=>{clearTimeout(S),O.ok?pn(d,"TestPingServer: ok",!0,l):pn(d,"TestPingServer: server error",!1,l)}).catch(()=>{clearTimeout(S),pn(d,"TestPingServer: error",!1,l)})}function pn(a,l,d,m,S){try{S&&(S.onload=null,S.onerror=null,S.onabort=null,S.ontimeout=null),m(d)}catch{}}function Y6(){this.g=new O6}function Oa(a){this.i=a.Sb||null,this.h=a.ab||!1}p(Oa,n1),Oa.prototype.g=function(){return new Ni(this.i,this.h)};function Ni(a,l){ze.call(this),this.H=a,this.o=l,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}p(Ni,ze),n=Ni.prototype,n.open=function(a,l){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=a,this.D=l,this.readyState=1,ls(this)},n.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const l={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};a&&(l.body=a),(this.H||o).fetch(new Request(this.D,l)).then(this.Pa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,us(this)),this.readyState=0},n.Pa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,ls(this)),this.g&&(this.readyState=3,ls(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof o.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;S1(this)}else a.text().then(this.Oa.bind(this),this.ga.bind(this))};function S1(a){a.j.read().then(a.Ma.bind(a)).catch(a.ga.bind(a))}n.Ma=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var l=a.value?a.value:new Uint8Array(0);(l=this.B.decode(l,{stream:!a.done}))&&(this.response=this.responseText+=l)}a.done?us(this):ls(this),this.readyState==3&&S1(this)}},n.Oa=function(a){this.g&&(this.response=this.responseText=a,us(this))},n.Na=function(a){this.g&&(this.response=a,us(this))},n.ga=function(){this.g&&us(this)};function us(a){a.readyState=4,a.l=null,a.j=null,a.B=null,ls(a)}n.setRequestHeader=function(a,l){this.A.append(a,l)},n.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],l=this.h.entries();for(var d=l.next();!d.done;)d=d.value,a.push(d[0]+": "+d[1]),d=l.next();return a.join(`\r
`)};function ls(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(Ni.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function P1(a){let l="";return Ai(a,function(d,m){l+=m,l+=":",l+=d,l+=`\r
`}),l}function ka(a,l,d){e:{for(m in d){var m=!1;break e}m=!0}m||(d=P1(d),typeof a=="string"?d!=null&&ns(d):pe(a,l,d))}function we(a){ze.call(this),this.headers=new Map,this.L=a||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}p(we,ze);var Q6=/^https?$/i,X6=["POST","PUT"];n=we.prototype,n.Fa=function(a){this.H=a},n.ea=function(a,l,d,m){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);l=l?l.toUpperCase():"GET",this.D=a,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():u1.g(),this.g.onreadystatechange=w(h(this.Ca,this));try{this.B=!0,this.g.open(l,String(a),!0),this.B=!1}catch(O){b1(this,O);return}if(a=d||"",d=new Map(this.headers),m)if(Object.getPrototypeOf(m)===Object.prototype)for(var S in m)d.set(S,m[S]);else if(typeof m.keys=="function"&&typeof m.get=="function")for(const O of m.keys())d.set(O,m.get(O));else throw Error("Unknown input type for opt_headers: "+String(m));m=Array.from(d.keys()).find(O=>O.toLowerCase()=="content-type"),S=o.FormData&&a instanceof o.FormData,!(Array.prototype.indexOf.call(X6,l,void 0)>=0)||m||S||d.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[O,U]of d)this.g.setRequestHeader(O,U);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(a),this.v=!1}catch(O){b1(this,O)}};function b1(a,l){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=l,a.o=5,N1(a),Oi(a)}function N1(a){a.A||(a.A=!0,et(a,"complete"),et(a,"error"))}n.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=a||7,et(this,"complete"),et(this,"abort"),Oi(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Oi(this,!0)),we.Z.N.call(this)},n.Ca=function(){this.u||(this.B||this.v||this.j?O1(this):this.Xa())},n.Xa=function(){O1(this)};function O1(a){if(a.h&&typeof i<"u"){if(a.v&&mn(a)==4)setTimeout(a.Ca.bind(a),0);else if(et(a,"readystatechange"),mn(a)==4){a.h=!1;try{const O=a.ca();e:switch(O){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var l=!0;break e;default:l=!1}var d;if(!(d=l)){var m;if(m=O===0){let U=String(a.D).match(w1)[1]||null;!U&&o.self&&o.self.location&&(U=o.self.location.protocol.slice(0,-1)),m=!Q6.test(U?U.toLowerCase():"")}d=m}if(d)et(a,"complete"),et(a,"success");else{a.o=6;try{var S=mn(a)>2?a.g.statusText:""}catch{S=""}a.l=S+" ["+a.ca()+"]",N1(a)}}finally{Oi(a)}}}}function Oi(a,l){if(a.g){a.m&&(clearTimeout(a.m),a.m=null);const d=a.g;a.g=null,l||et(a,"ready");try{d.onreadystatechange=null}catch{}}}n.isActive=function(){return!!this.g};function mn(a){return a.g?a.g.readyState:0}n.ca=function(){try{return mn(this)>2?this.g.status:-1}catch{return-1}},n.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.La=function(a){if(this.g){var l=this.g.responseText;return a&&l.indexOf(a)==0&&(l=l.substring(a.length)),N6(l)}};function k1(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.F){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function J6(a){const l={};a=(a.g&&mn(a)>=2&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let m=0;m<a.length;m++){if(_(a[m]))continue;var d=x6(a[m]);const S=d[0];if(d=d[1],typeof d!="string")continue;d=d.trim();const O=l[S]||[];l[S]=O,O.push(d)}R6(l,function(m){return m.join(", ")})}n.ya=function(){return this.o},n.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function hs(a,l,d){return d&&d.internalChannelParams&&d.internalChannelParams[a]||l}function D1(a){this.za=0,this.i=[],this.j=new ts,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=hs("failFast",!1,a),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=hs("baseRetryDelayMs",5e3,a),this.Za=hs("retryDelaySeedMs",1e4,a),this.Ta=hs("forwardChannelMaxRetries",2,a),this.va=hs("forwardChannelRequestTimeoutMs",2e4,a),this.ma=a&&a.xmlHttpFactory||void 0,this.Ua=a&&a.Rb||void 0,this.Aa=a&&a.useFetchStreams||!1,this.O=void 0,this.L=a&&a.supportsCrossDomainXhr||!1,this.M="",this.h=new m1(a&&a.concurrentRequestLimit),this.Ba=new Y6,this.S=a&&a.fastHandshake||!1,this.R=a&&a.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=a&&a.Pb||!1,a&&a.ua&&this.j.ua(),a&&a.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&a&&a.detectBufferingProxy||!1,this.ia=void 0,a&&a.longPollingTimeout&&a.longPollingTimeout>0&&(this.ia=a.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}n=D1.prototype,n.ka=8,n.I=1,n.connect=function(a,l,d,m){tt(0),this.W=a,this.H=l||{},d&&m!==void 0&&(this.H.OSID=d,this.H.OAID=m),this.F=this.X,this.J=H1(this,null,this.W),Di(this)};function Da(a){if(V1(a),a.I==3){var l=a.V++,d=Vt(a.J);if(pe(d,"SID",a.M),pe(d,"RID",l),pe(d,"TYPE","terminate"),ds(a,d),l=new dn(a,a.j,l),l.M=2,l.A=bi(Vt(d)),d=!1,o.navigator&&o.navigator.sendBeacon)try{d=o.navigator.sendBeacon(l.A.toString(),"")}catch{}!d&&o.Image&&(new Image().src=l.A,d=!0),d||(l.g=q1(l.j,null),l.g.ea(l.A)),l.F=Date.now(),Pi(l)}$1(a)}function ki(a){a.g&&(La(a),a.g.cancel(),a.g=null)}function V1(a){ki(a),a.v&&(o.clearTimeout(a.v),a.v=null),Vi(a),a.h.cancel(),a.m&&(typeof a.m=="number"&&o.clearTimeout(a.m),a.m=null)}function Di(a){if(!g1(a.h)&&!a.m){a.m=!0;var l=a.Ea;Ve||g(),_e||(Ve(),_e=!0),A.add(l,a),a.D=0}}function Z6(a,l){return _1(a.h)>=a.h.j-(a.m?1:0)?!1:a.m?(a.i=l.G.concat(a.i),!0):a.I==1||a.I==2||a.D>=(a.Sa?0:a.Ta)?!1:(a.m=es(h(a.Ea,a,l),B1(a,a.D)),a.D++,!0)}n.Ea=function(a){if(this.m)if(this.m=null,this.I==1){if(!a){this.V=Math.floor(Math.random()*1e5),a=this.V++;const S=new dn(this,this.j,a);let O=this.o;if(this.U&&(O?(O=Wu(O),Ku(O,this.U)):O=this.U),this.u!==null||this.R||(S.J=O,O=null),this.S)e:{for(var l=0,d=0;d<this.i.length;d++){t:{var m=this.i[d];if("__data__"in m.map&&(m=m.map.__data__,typeof m=="string")){m=m.length;break t}m=void 0}if(m===void 0)break;if(l+=m,l>4096){l=d;break e}if(l===4096||d===this.i.length-1){l=d+1;break e}}l=1e3}else l=1e3;l=x1(this,S,l),d=Vt(this.J),pe(d,"RID",a),pe(d,"CVER",22),this.G&&pe(d,"X-HTTP-Session-Id",this.G),ds(this,d),O&&(this.R?l="headers="+ns(P1(O))+"&"+l:this.u&&ka(d,this.u,O)),ba(this.h,S),this.Ra&&pe(d,"TYPE","init"),this.S?(pe(d,"$req",l),pe(d,"SID","null"),S.U=!0,va(S,d,null)):va(S,d,l),this.I=2}}else this.I==3&&(a?L1(this,a):this.i.length==0||g1(this.h)||L1(this))};function L1(a,l){var d;l?d=l.l:d=a.V++;const m=Vt(a.J);pe(m,"SID",a.M),pe(m,"RID",d),pe(m,"AID",a.K),ds(a,m),a.u&&a.o&&ka(m,a.u,a.o),d=new dn(a,a.j,d,a.D+1),a.u===null&&(d.J=a.o),l&&(a.i=l.G.concat(a.i)),l=x1(a,d,1e3),d.H=Math.round(a.va*.5)+Math.round(a.va*.5*Math.random()),ba(a.h,d),va(d,m,l)}function ds(a,l){a.H&&Ai(a.H,function(d,m){pe(l,m,d)}),a.l&&Ai({},function(d,m){pe(l,m,d)})}function x1(a,l,d){d=Math.min(a.i.length,d);const m=a.l?h(a.l.Ka,a.l,a):null;e:{var S=a.i;let ee=-1;for(;;){const xe=["count="+d];ee==-1?d>0?(ee=S[0].g,xe.push("ofs="+ee)):ee=0:xe.push("ofs="+ee);let fe=!0;for(let $e=0;$e<d;$e++){var O=S[$e].g;const Lt=S[$e].map;if(O-=ee,O<0)ee=Math.max(0,S[$e].g-100),fe=!1;else try{O="req"+O+"_"||"";try{var U=Lt instanceof Map?Lt:Object.entries(Lt);for(const[Xn,gn]of U){let _n=gn;c(gn)&&(_n=wa(gn)),xe.push(O+Xn+"="+encodeURIComponent(_n))}}catch(Xn){throw xe.push(O+"type="+encodeURIComponent("_badmap")),Xn}}catch{m&&m(Lt)}}if(fe){U=xe.join("&");break e}}U=void 0}return a=a.i.splice(0,d),l.G=a,U}function M1(a){if(!a.g&&!a.v){a.Y=1;var l=a.Da;Ve||g(),_e||(Ve(),_e=!0),A.add(l,a),a.A=0}}function Va(a){return a.g||a.v||a.A>=3?!1:(a.Y++,a.v=es(h(a.Da,a),B1(a,a.A)),a.A++,!0)}n.Da=function(){if(this.v=null,U1(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var a=4*this.T;this.j.info("BP detection timer enabled: "+a),this.B=es(h(this.Wa,this),a)}},n.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,tt(10),ki(this),U1(this))};function La(a){a.B!=null&&(o.clearTimeout(a.B),a.B=null)}function U1(a){a.g=new dn(a,a.j,"rpc",a.Y),a.u===null&&(a.g.J=a.o),a.g.P=0;var l=Vt(a.na);pe(l,"RID","rpc"),pe(l,"SID",a.M),pe(l,"AID",a.K),pe(l,"CI",a.F?"0":"1"),!a.F&&a.ia&&pe(l,"TO",a.ia),pe(l,"TYPE","xmlhttp"),ds(a,l),a.u&&a.o&&ka(l,a.u,a.o),a.O&&(a.g.H=a.O);var d=a.g;a=a.ba,d.M=1,d.A=bi(Vt(l)),d.u=null,d.R=!0,d1(d,a)}n.Va=function(){this.C!=null&&(this.C=null,ki(this),Va(this),tt(19))};function Vi(a){a.C!=null&&(o.clearTimeout(a.C),a.C=null)}function F1(a,l){var d=null;if(a.g==l){Vi(a),La(a),a.g=null;var m=2}else if(Pa(a.h,l))d=l.G,E1(a.h,l),m=1;else return;if(a.I!=0){if(l.o)if(m==1){d=l.u?l.u.length:0,l=Date.now()-l.F;var S=a.D;m=Ci(),et(m,new a1(m,d)),Di(a)}else M1(a);else if(S=l.m,S==3||S==0&&l.X>0||!(m==1&&Z6(a,l)||m==2&&Va(a)))switch(d&&d.length>0&&(l=a.h,l.i=l.i.concat(d)),S){case 1:Qn(a,5);break;case 4:Qn(a,10);break;case 3:Qn(a,6);break;default:Qn(a,2)}}}function B1(a,l){let d=a.Qa+Math.floor(Math.random()*a.Za);return a.isActive()||(d*=2),d*l}function Qn(a,l){if(a.j.info("Error code "+l),l==2){var d=h(a.bb,a),m=a.Ua;const S=!m;m=new fn(m||"//www.google.com/images/cleardot.gif"),o.location&&o.location.protocol=="http"||ss(m,"https"),bi(m),S?z6(m.toString(),d):K6(m.toString(),d)}else tt(2);a.I=0,a.l&&a.l.pa(l),$1(a),V1(a)}n.bb=function(a){a?(this.j.info("Successfully pinged google.com"),tt(2)):(this.j.info("Failed to ping google.com"),tt(1))};function $1(a){if(a.I=0,a.ja=[],a.l){const l=y1(a.h);(l.length!=0||a.i.length!=0)&&(P(a.ja,l),P(a.ja,a.i),a.h.i.length=0,b(a.i),a.i.length=0),a.l.oa()}}function H1(a,l,d){var m=d instanceof fn?Vt(d):new fn(d);if(m.g!="")l&&(m.g=l+"."+m.g),is(m,m.u);else{var S=o.location;m=S.protocol,l=l?l+"."+S.hostname:S.hostname,S=+S.port;const O=new fn(null);m&&ss(O,m),l&&(O.g=l),S&&is(O,S),d&&(O.h=d),m=O}return d=a.G,l=a.wa,d&&l&&pe(m,d,l),pe(m,"VER",a.ka),ds(a,m),m}function q1(a,l,d){if(l&&!a.L)throw Error("Can't create secondary domain capable XhrIo object.");return l=a.Aa&&!a.ma?new we(new Oa({ab:d})):new we(a.ma),l.Fa(a.L),l}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function j1(){}n=j1.prototype,n.ra=function(){},n.qa=function(){},n.pa=function(){},n.oa=function(){},n.isActive=function(){return!0},n.Ka=function(){};function Li(){}Li.prototype.g=function(a,l){return new mt(a,l)};function mt(a,l){ze.call(this),this.g=new D1(l),this.l=a,this.h=l&&l.messageUrlParams||null,a=l&&l.messageHeaders||null,l&&l.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=l&&l.initMessageHeaders||null,l&&l.messageContentType&&(a?a["X-WebChannel-Content-Type"]=l.messageContentType:a={"X-WebChannel-Content-Type":l.messageContentType}),l&&l.sa&&(a?a["X-WebChannel-Client-Profile"]=l.sa:a={"X-WebChannel-Client-Profile":l.sa}),this.g.U=a,(a=l&&l.Qb)&&!_(a)&&(this.g.u=a),this.A=l&&l.supportsCrossDomainXhr||!1,this.v=l&&l.sendRawJson||!1,(l=l&&l.httpSessionIdParam)&&!_(l)&&(this.g.G=l,a=this.h,a!==null&&l in a&&(a=this.h,l in a&&delete a[l])),this.j=new yr(this)}p(mt,ze),mt.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},mt.prototype.close=function(){Da(this.g)},mt.prototype.o=function(a){var l=this.g;if(typeof a=="string"){var d={};d.__data__=a,a=d}else this.v&&(d={},d.__data__=wa(a),a=d);l.i.push(new F6(l.Ya++,a)),l.I==3&&Di(l)},mt.prototype.N=function(){this.g.l=null,delete this.j,Da(this.g),delete this.g,mt.Z.N.call(this)};function G1(a){Ia.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var l=a.__sm__;if(l){e:{for(const d in l){a=d;break e}a=void 0}(this.i=a)&&(a=this.i,l=l!==null&&a in l?l[a]:void 0),this.data=l}else this.data=a}p(G1,Ia);function W1(){Ta.call(this),this.status=1}p(W1,Ta);function yr(a){this.g=a}p(yr,j1),yr.prototype.ra=function(){et(this.g,"a")},yr.prototype.qa=function(a){et(this.g,new G1(a))},yr.prototype.pa=function(a){et(this.g,new W1)},yr.prototype.oa=function(){et(this.g,"b")},Li.prototype.createWebChannel=Li.prototype.g,mt.prototype.send=mt.prototype.o,mt.prototype.open=mt.prototype.m,mt.prototype.close=mt.prototype.close,E2=function(){return new Li},_2=function(){return Ci()},g2=zn,uc={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},Si.NO_ERROR=0,Si.TIMEOUT=8,Si.HTTP_ERROR=6,Ki=Si,c1.COMPLETE="complete",m2=c1,r1.EventType=Jr,Jr.OPEN="a",Jr.CLOSE="b",Jr.ERROR="c",Jr.MESSAGE="d",ze.prototype.listen=ze.prototype.J,ys=r1,we.prototype.listenOnce=we.prototype.K,we.prototype.getLastError=we.prototype.Ha,we.prototype.getLastErrorCode=we.prototype.ya,we.prototype.getStatus=we.prototype.ca,we.prototype.getResponseJson=we.prototype.La,we.prototype.getResponseText=we.prototype.la,we.prototype.send=we.prototype.ea,we.prototype.setWithCredentials=we.prototype.Fa,p2=we}).apply(typeof Mi<"u"?Mi:typeof self<"u"?self:typeof window<"u"?window:{});/*!
 * re2js
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Br="12.15.0";function s7(n){Br=n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function W(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,w2(n,r,t)}function w2(n,e,t){let r=`FIRESTORE (${Br}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw an(r),new Error(r)}function q(n,e,t,r){let s="Unexpected state";typeof t=="string"?s=t:r=t,n||w2(e,s,r)}function J(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class I2{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class i7{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable((()=>t(Qe.UNAUTHENTICATED)))}shutdown(){}}class o7{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable((()=>t(this.token.user)))}shutdown(){this.changeListener=null}}class a7{constructor(e){this.t=e,this.currentUser=Qe.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){q(this.o===void 0,42304);let r=this.i;const s=u=>this.i!==r?(r=this.i,t(u)):Promise.resolve();let i=new nn;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new nn,e.enqueueRetryable((()=>s(this.currentUser)))};const o=()=>{const u=i;e.enqueueRetryable((async()=>{await u.promise,await s(this.currentUser)}))},c=u=>{H("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=u,this.o&&(this.auth.addAuthTokenListener(this.o),o())};this.t.onInit((u=>c(u))),setTimeout((()=>{if(!this.auth){const u=this.t.getImmediate({optional:!0});u?c(u):(H("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new nn)}}),0),o()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then((r=>this.i!==e?(H("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(q(typeof r.accessToken=="string",31837,{l:r}),new I2(r.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return q(e===null||typeof e=="string",2055,{h:e}),new Qe(e)}}class c7{constructor(e,t,r){this.T=e,this.P=t,this.R=r,this.type="FirstParty",this.user=Qe.FIRST_PARTY,this.I=new Map}A(){return this.R?this.R():null}get headers(){this.I.set("X-Goog-AuthUser",this.T);const e=this.A();return e&&this.I.set("Authorization",e),this.P&&this.I.set("X-Goog-Iam-Authorization-Token",this.P),this.I}}class u7{constructor(e,t,r){this.T=e,this.P=t,this.R=r}getToken(){return Promise.resolve(new c7(this.T,this.P,this.R))}start(e,t){e.enqueueRetryable((()=>t(Qe.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}class Nl{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class l7{constructor(e,t){this.V=t,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,Pe(e)&&e.settings.appCheckToken&&(this.p=e.settings.appCheckToken)}start(e,t){q(this.o===void 0,3512);const r=i=>{i.error!=null&&H("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const o=i.token!==this.m;return this.m=i.token,H("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?t(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable((()=>r(i)))};const s=i=>{H("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit((i=>s(i))),setTimeout((()=>{if(!this.appCheck){const i=this.V.getImmediate({optional:!0});i?s(i):H("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}}),0)}getToken(){if(this.p)return Promise.resolve(new Nl(this.p));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then((t=>t?(q(typeof t.token=="string",44558,{tokenResult:t}),this.m=t.token,new Nl(t.token)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function h7(n){const e=typeof self<"u"&&(self.crypto||self.msCrypto),t=new Uint8Array(n);if(e&&typeof e.getRandomValues=="function")e.getRandomValues(t);else for(let r=0;r<n;r++)t[r]=Math.floor(256*Math.random());return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ne(n,e){const t={typeString:n};return e&&(t.value=e),t}function ii(n,e){if(!si(n))throw new F(D.INVALID_ARGUMENT,"JSON must be an object");let t;for(const r in e)if(e[r]){const s=e[r].typeString,i="value"in e[r]?{value:e[r].value}:void 0;if(!(r in n)){t=`JSON missing required field: '${r}'`;break}const o=n[r];if(s&&typeof o!==s){t=`JSON field '${r}' must be a ${s}.`;break}if(i!==void 0&&o!==i.value){t=`Expected '${r}' field to equal '${i.value}'`;break}}if(t)throw new F(D.INVALID_ARGUMENT,t);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dl=-62135596800,Vl=1e6;class me{static now(){return me.fromMillis(Date.now())}static fromDate(e){return me.fromMillis(e.getTime())}static fromMillis(e){const t=Math.floor(e/1e3),r=Math.floor((e-1e3*t)*Vl);return new me(t,r)}constructor(e,t){if(this.seconds=e,this.nanoseconds=t,t<0)throw new F(D.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(t>=1e9)throw new F(D.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(e<Dl)throw new F(D.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new F(D.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/Vl}_compareTo(e){return this.seconds===e.seconds?ie(this.nanoseconds,e.nanoseconds):ie(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{type:me._jsonSchemaVersion,seconds:this.seconds,nanoseconds:this.nanoseconds}}static fromJSON(e){if(ii(e,me._jsonSchema))return new me(e.seconds,e.nanoseconds)}valueOf(){const e=this.seconds-Dl;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}me._jsonSchemaVersion="firestore/timestamp/1.0",me._jsonSchema={type:Ne("string",me._jsonSchemaVersion),seconds:Ne("number"),nanoseconds:Ne("number")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fs=-1;function g7(n,e){const t=n.toTimestamp().seconds,r=n.toTimestamp().nanoseconds+1,s=Q.fromTimestamp(r===1e9?new me(t+1,0):new me(t,r));return new Dn(s,j.empty(),e)}function _7(n){return new Dn(n.readTime,n.key,Fs)}class Dn{constructor(e,t,r){this.readTime=e,this.documentKey=t,this.largestBatchId=r}static min(){return new Dn(Q.min(),j.empty(),Fs)}static max(){return new Dn(Q.max(),j.empty(),Fs)}}function E7(n,e){let t=n.readTime.compareTo(e.readTime);return t!==0?t:(t=j.comparator(n.documentKey,e.documentKey),t!==0?t:ie(n.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const y7="The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";class w7{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(e){this.onCommittedListeners.push(e)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach((e=>e()))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $r(n){if(n.code!==D.FAILED_PRECONDITION||n.message!==y7)throw n;H("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Uc=-1;function Lo(n){return n==null}function Bs(n){return n===0&&1/n==-1/0}function T7(n){return typeof n=="number"&&Number.isInteger(n)&&!Bs(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}function A7(n){return typeof n=="string"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const A2="";function R7(n){let e="";for(let t=0;t<n.length;t++)e.length>0&&(e=Ll(e)),e=v7(n.get(t),e);return Ll(e)}function v7(n,e){let t=e;const r=n.length;for(let s=0;s<r;s++){const i=n.charAt(s);switch(i){case"\0":t+="";break;case A2:t+="";break;default:t+=i}}return t}function Ll(n){return n+A2+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ke{constructor(e){this.binaryString=e}static fromBase64String(e){const t=(function(s){try{return atob(s)}catch(i){throw typeof DOMException<"u"&&i instanceof DOMException?new v2("Invalid base64 string: "+i):i}})(e);return new ke(t)}static fromUint8Array(e){const t=(function(s){let i="";for(let o=0;o<s.length;++o)i+=String.fromCharCode(s[o]);return i})(e);return new ke(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return(function(t){return btoa(t)})(this.binaryString)}toUint8Array(){return(function(t){const r=new Uint8Array(t.length);for(let s=0;s<t.length;s++)r[s]=t.charCodeAt(s);return r})(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return ie(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}ke.EMPTY_BYTE_STRING=new ke("");const S7=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Vn(n){if(q(!!n,39018),typeof n=="string"){let e=0;const t=S7.exec(n);if(q(!!t,46558,{timestamp:n}),t[1]){let s=t[1];s=(s+"000000000").substr(0,9),e=Number(s)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:Ee(n.seconds),nanos:Ee(n.nanos)}}function Ee(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function Ln(n){return typeof n=="string"?ke.fromBase64String(n):ke.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const C2="server_timestamp",S2="__type__",P2="__previous_value__",b2="__local_write_time__";function xo(n){return(n?.mapValue?.fields||{})[S2]?.stringValue===C2}function oi(n){const e=n.mapValue.fields[P2];return xo(e)?oi(e):e}function Dr(n){const e=Vn(n.mapValue.fields[b2].timestampValue);return new me(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class P7{constructor(e,t,r,s,i,o,c,u,h,f,p){this.databaseId=e,this.appId=t,this.persistenceKey=r,this.host=s,this.ssl=i,this.forceLongPolling=o,this.autoDetectLongPolling=c,this.longPollingOptions=u,this.useFetchStreams=h,this.isUsingEmulator=f,this.apiKey=p}}const hc="(default)";class $s{constructor(e,t){this.projectId=e,this.database=t||hc}static empty(){return new $s("","")}get isDefaultDatabase(){return this.database===hc}isEqual(e){return e instanceof $s&&e.projectId===this.projectId&&e.database===this.database}}function b7(n,e){if(!Object.prototype.hasOwnProperty.apply(n.options,["projectId"]))throw new F(D.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new $s(n.options.projectId,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const N2="__type__",N7="__max__",Bi={mapValue:{}},O2="__vector__",Hs="value",Vr={nullValue:"NULL_VALUE"},dt={booleanValue:!0},qe={booleanValue:!1};function De(n){return"nullValue"in n?0:"booleanValue"in n?1:"integerValue"in n||"doubleValue"in n?2:"timestampValue"in n?3:"stringValue"in n?5:"bytesValue"in n?6:"referenceValue"in n?7:"geoPointValue"in n?8:"arrayValue"in n?9:"mapValue"in n?xo(n)?4:O7(n)?9007199254740991:uo(n)?10:11:W(28295,{value:n})}function Pt(n,e,t){if(n===e)return!0;const r=De(n);if(r!==De(e))return!1;switch(r){case 0:case 9007199254740991:return!0;case 1:return n.booleanValue===e.booleanValue;case 4:return Dr(n).isEqual(Dr(e));case 3:return(function(i,o){if(typeof i.timestampValue=="string"&&typeof o.timestampValue=="string"&&i.timestampValue.length===o.timestampValue.length)return i.timestampValue===o.timestampValue;const c=Vn(i.timestampValue),u=Vn(o.timestampValue);return c.seconds===u.seconds&&c.nanos===u.nanos})(n,e);case 5:return n.stringValue===e.stringValue;case 6:return(function(i,o){return Ln(i.bytesValue).isEqual(Ln(o.bytesValue))})(n,e);case 7:return n.referenceValue===e.referenceValue;case 8:return(function(i,o){return Ee(i.geoPointValue.latitude)===Ee(o.geoPointValue.latitude)&&Ee(i.geoPointValue.longitude)===Ee(o.geoPointValue.longitude)})(n,e);case 2:return(function(i,o,c){if("integerValue"in i&&"integerValue"in o)return Ee(i.integerValue)===Ee(o.integerValue);let u,h;if("doubleValue"in i&&"doubleValue"in o)u=Ee(i.doubleValue),h=Ee(o.doubleValue);else{if(!c?.Ee)return!1;u=Ee(i.integerValue??i.doubleValue),h=Ee(o.integerValue??o.doubleValue)}return u===h?!!c?.he||Bs(u)===Bs(h):!!(c===void 0||c.Te)&&isNaN(u)&&isNaN(h)})(n,e,t);case 9:return kr(n.arrayValue.values||[],e.arrayValue.values||[],((s,i)=>Pt(s,i,t)));case 10:case 11:return(function(i,o,c){const u=i.mapValue.fields||{},h=o.mapValue.fields||{};if(co(u)!==co(h))return!1;for(const f in u)if(u.hasOwnProperty(f)&&(h[f]===void 0||!Pt(u[f],h[f],c)))return!1;return!0})(n,e,t);default:return W(52216,{left:n})}}function qs(n,e){return(n.values||[]).find((t=>Pt(t,e)))!==void 0}function ft(n,e){if(n===e)return 0;const t=De(n),r=De(e);if(t!==r)return ie(t,r);switch(t){case 0:case 9007199254740991:return 0;case 1:return ie(n.booleanValue,e.booleanValue);case 2:return(function(i,o){const c=Ee(i.integerValue||i.doubleValue),u=Ee(o.integerValue||o.doubleValue);return c<u?-1:c>u?1:c===u?0:isNaN(c)?isNaN(u)?0:-1:1})(n,e);case 3:return Ml(n.timestampValue,e.timestampValue);case 4:return Ml(Dr(n),Dr(e));case 5:return lc(n.stringValue,e.stringValue);case 6:return(function(i,o){const c=Ln(i),u=Ln(o);return c.compareTo(u)})(n.bytesValue,e.bytesValue);case 7:return(function(i,o){const c=i.split("/"),u=o.split("/");for(let h=0;h<c.length&&h<u.length;h++){const f=ie(c[h],u[h]);if(f!==0)return f}return ie(c.length,u.length)})(n.referenceValue,e.referenceValue);case 8:return(function(i,o){const c=ie(Ee(i.latitude),Ee(o.latitude));return c!==0?c:ie(Ee(i.longitude),Ee(o.longitude))})(n.geoPointValue,e.geoPointValue);case 9:return Ul(n.arrayValue,e.arrayValue);case 10:return(function(i,o){const c=i.fields||{},u=o.fields||{},h=c[Hs]?.arrayValue,f=u[Hs]?.arrayValue,p=ie(h?.values?.length||0,f?.values?.length||0);return p!==0?p:Ul(h,f)})(n.mapValue,e.mapValue);case 11:return(function(i,o){if(i===Bi.mapValue&&o===Bi.mapValue)return 0;if(i===Bi.mapValue)return 1;if(o===Bi.mapValue)return-1;const c=i.fields||{},u=Object.keys(c),h=o.fields||{},f=Object.keys(h);u.sort(),f.sort();for(let p=0;p<u.length&&p<f.length;++p){const w=lc(u[p],f[p]);if(w!==0)return w;const b=ft(c[u[p]],h[f[p]]);if(b!==0)return b}return ie(u.length,f.length)})(n.mapValue,e.mapValue);default:throw W(23264,{Pe:t})}}function Ml(n,e){if(typeof n=="string"&&typeof e=="string"&&n.length===e.length)return ie(n,e);const t=Vn(n),r=Vn(e),s=ie(t.seconds,r.seconds);return s!==0?s:ie(t.nanos,r.nanos)}function Ul(n,e){const t=n.values||[],r=e.values||[];for(let s=0;s<t.length&&s<r.length;++s){const i=ft(t[s],r[s]);if(i!==void 0&&i!==0)return i}return ie(t.length,r.length)}function Lr(n){return dc(n)}function dc(n){return"nullValue"in n?"null":"booleanValue"in n?""+n.booleanValue:"integerValue"in n?""+n.integerValue:"doubleValue"in n?""+n.doubleValue:"timestampValue"in n?(function(t){const r=Vn(t);return`time(${r.seconds},${r.nanos})`})(n.timestampValue):"stringValue"in n?n.stringValue:"bytesValue"in n?(function(t){return Ln(t).toBase64()})(n.bytesValue):"referenceValue"in n?(function(t){return j.fromName(t).toString()})(n.referenceValue):"geoPointValue"in n?(function(t){return`geo(${t.latitude},${t.longitude})`})(n.geoPointValue):"arrayValue"in n?(function(t){let r="[",s=!0;for(const i of t.values||[])s?s=!1:r+=",",r+=dc(i);return r+"]"})(n.arrayValue):"mapValue"in n?(function(t){const r=Object.keys(t.fields||{}).sort();let s="{",i=!0;for(const o of r)i?i=!1:s+=",",s+=`${o}:${dc(t.fields[o])}`;return s+"}"})(n.mapValue):W(61005,{value:n})}function Yi(n){switch(De(n)){case 0:case 1:return 4;case 2:return 8;case 3:case 8:return 16;case 4:const e=oi(n);return e?16+Yi(e):16;case 5:return 2*n.stringValue.length;case 6:return Ln(n.bytesValue).approximateByteSize();case 7:return n.referenceValue.length;case 9:return(function(r){return(r.values||[]).reduce(((s,i)=>s+Yi(i)),0)})(n.arrayValue);case 10:case 11:return(function(r){let s=0;return jn(r.fields,((i,o)=>{s+=i.length+Yi(o)})),s})(n.mapValue);default:throw W(13486,{value:n})}}function Fl(n,e){return{referenceValue:`projects/${n.projectId}/databases/${n.database}/documents/${e.path.canonicalString()}`}}function Ut(n){return!!n&&"integerValue"in n}function er(n){return!!n&&"doubleValue"in n}function xn(n){return Ut(n)||er(n)}function xr(n){return!!n&&"arrayValue"in n}function Et(n){return!!n&&"nullValue"in n}function pt(n){return!!n&&"doubleValue"in n&&isNaN(Number(n.doubleValue))}function tr(n){return!!n&&"mapValue"in n}function uo(n){return(n?.mapValue?.fields||{})[N2]?.stringValue===O2}function fc(n){return(n?.mapValue?.fields||{})[Hs]?.arrayValue}function Cs(n){if(n.geoPointValue)return{geoPointValue:{...n.geoPointValue}};if(n.timestampValue&&typeof n.timestampValue=="object")return{timestampValue:{...n.timestampValue}};if(n.mapValue){const e={mapValue:{fields:{}}};return jn(n.mapValue.fields,((t,r)=>e.mapValue.fields[t]=Cs(r))),e}if(n.arrayValue){const e={arrayValue:{values:[]}};for(let t=0;t<(n.arrayValue.values||[]).length;++t)e.arrayValue.values[t]=Cs(n.arrayValue.values[t]);return e}return{...n}}function O7(n){return(((n.mapValue||{}).fields||{}).__type__||{}).stringValue===N7}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class st{constructor(e){this.value=e}static empty(){return new st({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!tr(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Cs(t)}setAll(e){let t=Me.emptyPath(),r={},s=[];e.forEach(((o,c)=>{if(!t.isImmediateParentOf(c)){const u=this.getFieldsMap(t);this.applyChanges(u,r,s),r={},s=[],t=c.popLast()}o?r[c.lastSegment()]=Cs(o):s.push(c.lastSegment())}));const i=this.getFieldsMap(t);this.applyChanges(i,r,s)}delete(e){const t=this.field(e.popLast());tr(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return Pt(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];tr(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){jn(t,((s,i)=>e[s]=i));for(const s of r)delete e[s]}clone(){return new st(Cs(this.value))}}function k2(n){const e=[];return jn(n.fields,((t,r)=>{const s=new Me([t]);if(tr(r)){const i=k2(r.mapValue).fields;if(i.length===0)e.push(s);else for(const o of i)e.push(s.child(o))}else e.push(s)})),new _t(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mo(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Bs(e)?"-0":e}}function Fc(n){return{integerValue:""+n}}function Uo(n,e,t){return Number.isInteger(e)&&t?.preferIntegers||T7(e)?Fc(e):Mo(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fo{constructor(){this._=void 0}}function k7(n,e,t){return n instanceof js?(function(s,i){const o={fields:{[S2]:{stringValue:C2},[b2]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&xo(i)&&(i=oi(i)),i&&(o.fields[P2]=i),{mapValue:o}})(t,e):n instanceof Gs?V2(n,e):n instanceof Ws?L2(n,e):n instanceof Mr?(function(s,i){const o=D2(s,i),c=fo(o)+fo(s.Re);return Ut(o)&&Ut(s.Re)?Fc(c):Mo(s.serializer,c)})(n,e):n instanceof lo?(function(s,i){return Bl(s,i,Math.min)})(n,e):n instanceof ho?(function(s,i){return Bl(s,i,Math.max)})(n,e):void 0}function D7(n,e,t){return n instanceof Gs?V2(n,e):n instanceof Ws?L2(n,e):t}function D2(n,e){return n instanceof Mr?xn(e)?e:{integerValue:0}:null}class js extends Fo{}class Gs extends Fo{constructor(e){super(),this.elements=e}}function V2(n,e){const t=x2(e);for(const r of n.elements)t.some((s=>Pt(s,r)))||t.push(r);return{arrayValue:{values:t}}}class Ws extends Fo{constructor(e){super(),this.elements=e}}function L2(n,e){let t=x2(e);for(const r of n.elements)t=t.filter((s=>!Pt(s,r)));return{arrayValue:{values:t}}}class Bc extends Fo{constructor(e,t){super(),this.serializer=e,this.Re=t}}class Mr extends Bc{}class lo extends Bc{}class ho extends Bc{}function Bl(n,e,t){if(!xn(e))return n.Re;const r=t(fo(e),fo(n.Re));return Ut(e)&&Ut(n.Re)?Fc(r):Mo(n.serializer,r)}function fo(n){return Ee(n.integerValue||n.doubleValue)}function x2(n){return xr(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class M2{constructor(e,t){this.field=e,this.transform=t}}function V7(n,e){return n.field.isEqual(e.field)&&(function(r,s){return r instanceof Gs&&s instanceof Gs||r instanceof Ws&&s instanceof Ws?kr(r.elements,s.elements,Pt):r instanceof Mr&&s instanceof Mr||r instanceof lo&&s instanceof lo||r instanceof ho&&s instanceof ho?Pt(r.Re,s.Re):r instanceof js&&s instanceof js})(n.transform,e.transform)}class L7{constructor(e,t){this.version=e,this.transformResults=t}}class ot{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new ot}static exists(e){return new ot(void 0,e)}static updateTime(e){return new ot(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function Qi(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class Bo{}function U2(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new $o(n.key,ot.none()):new ai(n.key,n.data,ot.none());{const t=n.data,r=st.empty();let s=new Oe(Me.comparator);for(let i of e.fields)if(!s.has(i)){let o=t.field(i);o===null&&i.length>1&&(i=i.popLast(),o=t.field(i)),o===null?r.delete(i):r.set(i,o),s=s.add(i)}return new Gn(n.key,r,new _t(s.toArray()),ot.none())}}function x7(n,e,t){n instanceof ai?(function(s,i,o){const c=s.value.clone(),u=Hl(s.fieldTransforms,i,o.transformResults);c.setAll(u),i.convertToFoundDocument(o.version,c).setHasCommittedMutations()})(n,e,t):n instanceof Gn?(function(s,i,o){if(!Qi(s.precondition,i))return void i.convertToUnknownDocument(o.version);const c=Hl(s.fieldTransforms,i,o.transformResults),u=i.data;u.setAll(F2(s)),u.setAll(c),i.convertToFoundDocument(o.version,u).setHasCommittedMutations()})(n,e,t):(function(s,i,o){i.convertToNoDocument(o.version).setHasCommittedMutations()})(0,e,t)}function Ss(n,e,t,r){return n instanceof ai?(function(i,o,c,u){if(!Qi(i.precondition,o))return c;const h=i.value.clone(),f=ql(i.fieldTransforms,u,o);return h.setAll(f),o.convertToFoundDocument(o.version,h).setHasLocalMutations(),null})(n,e,t,r):n instanceof Gn?(function(i,o,c,u){if(!Qi(i.precondition,o))return c;const h=ql(i.fieldTransforms,u,o),f=o.data;return f.setAll(F2(i)),f.setAll(h),o.convertToFoundDocument(o.version,f).setHasLocalMutations(),c===null?null:c.unionWith(i.fieldMask.fields).unionWith(i.fieldTransforms.map((p=>p.field)))})(n,e,t,r):(function(i,o,c){return Qi(i.precondition,o)?(o.convertToNoDocument(o.version).setHasLocalMutations(),null):c})(n,e,t)}function M7(n,e){let t=null;for(const r of n.fieldTransforms){const s=e.data.field(r.field),i=D2(r.transform,s||null);i!=null&&(t===null&&(t=st.empty()),t.set(r.field,i))}return t||null}function $l(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!(function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&kr(r,s,((i,o)=>V7(i,o)))})(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class ai extends Bo{constructor(e,t,r,s=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class Gn extends Bo{constructor(e,t,r,s,i=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=s,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function F2(n){const e=new Map;return n.fieldMask.fields.forEach((t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}})),e}function Hl(n,e,t){const r=new Map;q(n.length===t.length,32656,{Ie:t.length,Ae:n.length});for(let s=0;s<t.length;s++){const i=n[s],o=i.transform,c=e.data.field(i.field);r.set(i.field,D7(o,c,t[s]))}return r}function ql(n,e,t){const r=new Map;for(const s of n){const i=s.transform,o=t.data.field(s.field);r.set(s.field,k7(i,o,e))}return r}class $o extends Bo{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class U7 extends Bo{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class po{constructor(e,t){this.position=e,this.inclusive=t}}function jl(n,e,t){let r=0;for(let s=0;s<n.position.length;s++){const i=e[s],o=n.position[s];if(i.field.isKeyField()?r=j.comparator(j.fromName(o.referenceValue),t.key):r=ft(o,t.data.field(i.field)),i.dir==="desc"&&(r*=-1),r!==0)break}return r}function Gl(n,e){if(n===null)return e===null;if(e===null||n.inclusive!==e.inclusive||n.position.length!==e.position.length)return!1;for(let t=0;t<n.position.length;t++)if(!Pt(n.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class B2{}class be extends B2{constructor(e,t,r){super(),this.field=e,this.op=t,this.value=r}static create(e,t,r){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,r):new B7(e,t,r):t==="array-contains"?new q7(e,r):t==="in"?new j7(e,r):t==="not-in"?new G7(e,r):t==="array-contains-any"?new W7(e,r):new be(e,t,r)}static createKeyFieldInFilter(e,t,r){return t==="in"?new $7(e,r):new H7(e,r)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&t.nullValue===void 0&&this.matchesComparison(ft(t,this.value)):t!==null&&De(this.value)===De(t)&&this.matchesComparison(ft(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return W(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Dt extends B2{constructor(e,t){super(),this.filters=e,this.op=t,this.Ve=null}static create(e,t){return new Dt(e,t)}matches(e){return $2(this)?this.filters.find((t=>!t.matches(e)))===void 0:this.filters.find((t=>t.matches(e)))!==void 0}getFlattenedFilters(){return this.Ve!==null||(this.Ve=this.filters.reduce(((e,t)=>e.concat(t.getFlattenedFilters())),[])),this.Ve}getFilters(){return Object.assign([],this.filters)}}function $2(n){return n.op==="and"}function H2(n){return F7(n)&&$2(n)}function F7(n){for(const e of n.filters)if(e instanceof Dt)return!1;return!0}function pc(n){if(n instanceof be)return n.field.canonicalString()+n.op.toString()+Lr(n.value);if(H2(n))return n.filters.map((e=>pc(e))).join(",");{const e=n.filters.map((t=>pc(t))).join(",");return`${n.op}(${e})`}}function q2(n,e){return n instanceof be?(function(r,s){return s instanceof be&&r.op===s.op&&r.field.isEqual(s.field)&&Pt(r.value,s.value)})(n,e):n instanceof Dt?(function(r,s){return s instanceof Dt&&r.op===s.op&&r.filters.length===s.filters.length?r.filters.reduce(((i,o,c)=>i&&q2(o,s.filters[c])),!0):!1})(n,e):void W(19439)}function j2(n){return n instanceof be?(function(t){return`${t.field.canonicalString()} ${t.op} ${Lr(t.value)}`})(n):n instanceof Dt?(function(t){return t.op.toString()+" {"+t.getFilters().map(j2).join(" ,")+"}"})(n):"Filter"}class B7 extends be{constructor(e,t,r){super(e,t,r),this.key=j.fromName(r.referenceValue)}matches(e){const t=j.comparator(e.key,this.key);return this.matchesComparison(t)}}class $7 extends be{constructor(e,t){super(e,"in",t),this.keys=G2("in",t)}matches(e){return this.keys.some((t=>t.isEqual(e.key)))}}class H7 extends be{constructor(e,t){super(e,"not-in",t),this.keys=G2("not-in",t)}matches(e){return!this.keys.some((t=>t.isEqual(e.key)))}}function G2(n,e){return(e.arrayValue?.values||[]).map((t=>j.fromName(t.referenceValue)))}class q7 extends be{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return xr(t)&&qs(t.arrayValue,this.value)}}class j7 extends be{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&qs(this.value.arrayValue,t)}}class G7 extends be{constructor(e,t){super(e,"not-in",t)}matches(e){if(qs(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&t.nullValue===void 0&&!qs(this.value.arrayValue,t)}}class W7 extends be{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!xr(t)||!t.arrayValue.values)&&t.arrayValue.values.some((r=>qs(this.value.arrayValue,r)))}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zs{constructor(e,t="asc"){this.field=e,this.dir=t}}function z7(n,e){return n.dir===e.dir&&n.field.isEqual(e.field)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xe{constructor(e,t,r,s,i,o,c){this.key=e,this.documentType=t,this.version=r,this.readTime=s,this.createTime=i,this.data=o,this.documentState=c}static newInvalidDocument(e){return new Xe(e,0,Q.min(),Q.min(),Q.min(),st.empty(),0)}static newFoundDocument(e,t,r,s){return new Xe(e,1,t,Q.min(),r,s,0)}static newNoDocument(e,t){return new Xe(e,2,t,Q.min(),Q.min(),st.empty(),0)}static newUnknownDocument(e,t){return new Xe(e,3,t,Q.min(),Q.min(),st.empty(),2)}convertToFoundDocument(e,t){return!this.createTime.isEqual(Q.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=e),this.version=e,this.documentType=1,this.data=t,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=st.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=st.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=Q.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof Xe&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new Xe(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class K7{constructor(e,t=null,r=[],s=[],i=null,o=null,c=null){this.path=e,this.collectionGroup=t,this.orderBy=r,this.filters=s,this.limit=i,this.startAt=o,this.endAt=c,this.de=null}}function Wl(n,e=null,t=[],r=[],s=null,i=null,o=null){return new K7(n,e,t,r,s,i,o)}function W2(n){const e=J(n);if(e.de===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map((r=>pc(r))).join(","),t+="|ob:",t+=e.orderBy.map((r=>(function(i){return i.field.canonicalString()+i.dir})(r))).join(","),Lo(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map((r=>Lr(r))).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map((r=>Lr(r))).join(",")),e.de=t}return e.de}function z2(n,e){if(n.limit!==e.limit||n.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<n.orderBy.length;t++)if(!z7(n.orderBy[t],e.orderBy[t]))return!1;if(n.filters.length!==e.filters.length)return!1;for(let t=0;t<n.filters.length;t++)if(!q2(n.filters[t],e.filters[t]))return!1;return n.collectionGroup===e.collectionGroup&&!!n.path.isEqual(e.path)&&!!Gl(n.startAt,e.startAt)&&Gl(n.endAt,e.endAt)}function Zn(n){return!!n.isCorePipeline}function K2(n){return!!n.path&&j.isDocumentKey(n.path)&&n.collectionGroup===null&&n.filters.length===0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qr{constructor(e,t=null,r=[],s=[],i=null,o="F",c=null,u=null){this.path=e,this.collectionGroup=t,this.explicitOrderBy=r,this.filters=s,this.limit=i,this.limitType=o,this.startAt=c,this.endAt=u,this.fe=null,this.me=null,this.pe=null,this.startAt,this.endAt}}function Y7(n,e,t,r,s,i,o,c){return new qr(n,e,t,r,s,i,o,c)}function Ho(n){return new qr(n)}function zl(n){return n.filters.length===0&&n.limit===null&&n.startAt==null&&n.endAt==null&&(n.explicitOrderBy.length===0||n.explicitOrderBy.length===1&&n.explicitOrderBy[0].field.isKeyField())}function Q7(n){return j.isDocumentKey(n.path)&&n.collectionGroup===null&&n.filters.length===0}function Y2(n){return n.collectionGroup!==null}function Ps(n){const e=J(n);if(e.fe===null){e.fe=[];const t=new Set;for(const i of e.explicitOrderBy)e.fe.push(i),t.add(i.field.canonicalString());const r=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc";(function(o){let c=new Oe(Me.comparator);return o.filters.forEach((u=>{u.getFlattenedFilters().forEach((h=>{h.isInequality()&&(c=c.add(h.field))}))})),c})(e).forEach((i=>{t.has(i.canonicalString())||i.isKeyField()||e.fe.push(new zs(i,r))})),t.has(Me.keyField().canonicalString())||e.fe.push(new zs(Me.keyField(),r))}return e.fe}function $t(n){const e=J(n);return e.me||(e.me=X7(e,Ps(n))),e.me}function X7(n,e){if(n.limitType==="F")return Wl(n.path,n.collectionGroup,e,n.filters,n.limit,n.startAt,n.endAt);{e=e.map((s=>{const i=s.dir==="desc"?"asc":"desc";return new zs(s.field,i)}));const t=n.endAt?new po(n.endAt.position,n.endAt.inclusive):null,r=n.startAt?new po(n.startAt.position,n.startAt.inclusive):null;return Wl(n.path,n.collectionGroup,e,n.filters,n.limit,t,r)}}function mc(n,e){const t=n.filters.concat([e]);return new qr(n.path,n.collectionGroup,n.explicitOrderBy.slice(),t,n.limit,n.limitType,n.startAt,n.endAt)}function J7(n,e){const t=n.explicitOrderBy.concat([e]);return new qr(n.path,n.collectionGroup,t,n.filters.slice(),n.limit,n.limitType,n.startAt,n.endAt)}function gc(n,e,t){return new qr(n.path,n.collectionGroup,n.explicitOrderBy.slice(),n.filters.slice(),e,t,n.startAt,n.endAt)}function Z7(n,e){return z2($t(n),$t(e))&&n.limitType===e.limitType}function bs(n){return`Query(target=${(function(t){let r=t.path.canonicalString();return t.collectionGroup!==null&&(r+=" collectionGroup="+t.collectionGroup),t.filters.length>0&&(r+=`, filters: [${t.filters.map((s=>j2(s))).join(", ")}]`),Lo(t.limit)||(r+=", limit: "+t.limit),t.orderBy.length>0&&(r+=`, orderBy: [${t.orderBy.map((s=>(function(o){return`${o.field.canonicalString()} (${o.dir})`})(s))).join(", ")}]`),t.startAt&&(r+=", startAt: ",r+=t.startAt.inclusive?"b:":"a:",r+=t.startAt.position.map((s=>Lr(s))).join(",")),t.endAt&&(r+=", endAt: ",r+=t.endAt.inclusive?"a:":"b:",r+=t.endAt.position.map((s=>Lr(s))).join(",")),`Target(${r})`})($t(n))}; limitType=${n.limitType})`}function qo(n,e){return e.isFoundDocument()&&(function(r,s){const i=s.key.path;return r.collectionGroup!==null?s.key.hasCollectionId(r.collectionGroup)&&r.path.isPrefixOf(i):j.isDocumentKey(r.path)?r.path.isEqual(i):r.path.isImmediateParentOf(i)})(n,e)&&(function(r,s){for(const i of Ps(r))if(!i.field.isKeyField()&&s.data.field(i.field)===null)return!1;return!0})(n,e)&&(function(r,s){for(const i of r.filters)if(!i.matches(s))return!1;return!0})(n,e)&&(function(r,s){return!(r.startAt&&!(function(o,c,u){const h=jl(o,c,u);return o.inclusive?h<=0:h<0})(r.startAt,Ps(r),s)||r.endAt&&!(function(o,c,u){const h=jl(o,c,u);return o.inclusive?h>=0:h>0})(r.endAt,Ps(r),s))})(n,e)}function $c(n){return(e,t)=>{let r=!1;for(const s of Ps(n)){const i=e4(s,e,t);if(i!==0)return i;r=r||s.field.isKeyField()}return 0}}function e4(n,e,t){const r=n.field.isKeyField()?j.comparator(e.key,t.key):(function(i,o,c){const u=o.data.field(i),h=c.data.field(i);return u!==null&&h!==null?ft(u,h):W(42886)})(n.field,e,t);switch(n.dir){case"asc":return r;case"desc":return-1*r;default:return W(19790,{direction:n.dir})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const r4=new ge(j.comparator);function ut(){return r4}const X2=new ge(j.comparator);function Ir(...n){let e=X2;for(const t of n)e=e.insert(t.key,t);return e}function J2(n){let e=X2;return n.forEach(((t,r)=>e=e.insert(t,r.overlayedDocument))),e}function Tn(){return Ns()}function Z2(){return Ns()}function Ns(){return new pr((n=>n.toString()),((n,e)=>n.isEqual(e)))}const s4=new ge(j.comparator),i4=new Oe(j.comparator);function ne(...n){let e=i4;for(const t of n)e=e.add(t);return e}const o4=new Oe(ie);function a4(){return o4}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const u4=new Sn([4294967295,4294967295],0);function Kl(n){const e=c4().encode(n),t=new f2;return t.update(e),new Uint8Array(t.digest())}function Yl(n){const e=new DataView(n.buffer),t=e.getUint32(0,!0),r=e.getUint32(4,!0),s=e.getUint32(8,!0),i=e.getUint32(12,!0);return[new Sn([t,r],0),new Sn([s,i],0)]}class Hc{constructor(e,t,r){if(this.bitmap=e,this.padding=t,this.hashCount=r,t<0||t>=8)throw new ws(`Invalid padding: ${t}`);if(r<0)throw new ws(`Invalid hash count: ${r}`);if(e.length>0&&this.hashCount===0)throw new ws(`Invalid hash count: ${r}`);if(e.length===0&&t!==0)throw new ws(`Invalid padding when bitmap length is 0: ${t}`);this.ge=8*e.length-t,this.ye=Sn.fromNumber(this.ge)}we(e,t,r){let s=e.add(t.multiply(Sn.fromNumber(r)));return s.compare(u4)===1&&(s=new Sn([s.getBits(0),s.getBits(1)],0)),s.modulo(this.ye).toNumber()}be(e){return!!(this.bitmap[Math.floor(e/8)]&1<<e%8)}mightContain(e){if(this.ge===0)return!1;const t=Kl(e),[r,s]=Yl(t);for(let i=0;i<this.hashCount;i++){const o=this.we(r,s,i);if(!this.be(o))return!1}return!0}static create(e,t,r){const s=e%8==0?0:8-e%8,i=new Uint8Array(Math.ceil(e/8)),o=new Hc(i,s,t);return r.forEach((c=>o.insert(c))),o}insert(e){if(this.ge===0)return;const t=Kl(e),[r,s]=Yl(t);for(let i=0;i<this.hashCount;i++){const o=this.we(r,s,i);this.ve(o)}}ve(e){const t=Math.floor(e/8),r=e%8;this.bitmap[t]|=1<<r}}class ws extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ci{constructor(e,t,r,s,i,o){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.augmentedDocumentUpdates=i,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,ui.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new ci(Q.min(),s,new ge(ie),ut(),ut(),ne())}}class ui{constructor(e,t,r,s,i){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new ui(r,t,ne(),ne(),ne())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xi{constructor(e,t,r,s){this.Se=e,this.removedTargetIds=t,this.key=r,this.De=s}}class ed{constructor(e,t){this.targetId=e,this.xe=t}}class td{constructor(e,t,r=ke.EMPTY_BYTE_STRING,s=null){this.state=e,this.targetIds=t,this.resumeToken=r,this.cause=s}}class Ql{constructor(e){this.targetId=e,this.Ce=0,this.Fe=Xl(),this.Oe=ke.EMPTY_BYTE_STRING,this.Me=!1,this.Ne=!0}get current(){return this.Me}get resumeToken(){return this.Oe}get Le(){return this.Ce!==0}get Be(){return this.Ne}Ue(e){e.approximateByteSize()>0&&(this.Ne=!0,this.Oe=e)}ke(){let e=ne(),t=ne(),r=ne();return this.Fe.forEach(((s,i)=>{switch(i){case 0:e=e.add(s);break;case 2:t=t.add(s);break;case 1:r=r.add(s);break;default:W(38017,{changeType:i})}})),new ui(this.Oe,this.Me,e,t,r)}qe(){this.Ne=!1,this.Fe=Xl()}$e(e,t){this.Ne=!0,this.Fe=this.Fe.insert(e,t)}Ke(e){this.Ne=!0,this.Fe=this.Fe.remove(e)}We(){this.Ce+=1}Qe(){this.Ce-=1,q(this.Ce>=0,3241,{Ce:this.Ce,targetId:this.targetId})}Ge(){this.Ne=!0,this.Me=!0}}const fs="WatchChangeAggregator";class l4{constructor(e){this.ze=e,this.je=new Map,this.He=ut(),this.Je=$i(),this.Ye=ut(),this.Ze=$i(),this.Xe=new ge(ie)}et(e){for(const t of e.Se)e.De&&e.De.isFoundDocument()?this.tt(t,e.De):this.nt(t,e.key,e.De);for(const t of e.removedTargetIds)this.nt(t,e.key,e.De)}rt(e){this.forEachTarget(e,(t=>{const r=this.je.get(t);if(r)switch(e.state){case 0:this.it(t)&&r.Ue(e.resumeToken);break;case 1:r.Qe(),r.Le||r.qe(),r.Ue(e.resumeToken);break;case 2:r.Qe(),r.Le||this.removeTarget(t);break;case 3:this.it(t)&&(r.Ge(),r.Ue(e.resumeToken));break;case 4:this.it(t)&&(this.st(t),r.Ue(e.resumeToken));break;default:W(56790,{state:e.state})}else H(fs,`handleTargetChange received targetChange for untracked target ID (${t}) with state (${e.state})`)}))}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.je.forEach(((r,s)=>{this.it(s)&&t(s)}))}_t(e){return Zn(e)?e.getPipelineSourceType()==="documents"&&e.getPipelineDocuments()?.length===1:K2(e)}ot(e){const t=e.targetId,r=e.xe.count,s=this.ut(t);if(s){const i=s.target;if(this._t(i))if(r===0){const o=new j(Zn(i)?de.fromString(i.getPipelineDocuments()[0]):i.path);this.nt(t,o,Xe.newNoDocument(o,Q.min()))}else q(r===1,20013,"Single document existence filter with count: "+r);else{const o=this.ct(t);if(o!==r){const c=this.lt(e),u=c?this.Et(c,e,o):1;if(u!==0){this.st(t);const h=u===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Xe=this.Xe.insert(t,h)}}}}}lt(e){const t=e.xe.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:r="",padding:s=0},hashCount:i=0}=t;let o,c;try{o=Ln(r).toUint8Array()}catch(u){if(u instanceof v2)return kt("Decoding the base64 bloom filter in existence filter failed ("+u.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw u}try{c=new Hc(o,s,i)}catch(u){return kt(u instanceof ws?"BloomFilter error: ":"Applying bloom filter failed: ",u),null}return c.ge===0?null:c}Et(e,t,r){return t.xe.count===r-this.Pt(e,t.targetId)?0:2}Pt(e,t){const r=this.ze.getRemoteKeysForTarget(t);let s=0;return r.forEach((i=>{const o=this.ze.Tt(),c=`projects/${o.projectId}/databases/${o.database}/documents/${i.path.canonicalString()}`;e.mightContain(c)||(this.nt(t,i,null),s++)})),s}Rt(e){const t=new Map;this.je.forEach(((i,o)=>{const c=this.ut(o);if(c){if(i.current&&this._t(c.target)){const u=Zn(c.target)?de.fromString(c.target.getPipelineDocuments()[0]):c.target.path,h=new j(u);this.It(h).has(o)||this.At(o,h)||this.nt(o,h,Xe.newNoDocument(h,e))}i.Be&&(t.set(o,i.ke()),i.qe())}}));let r=ne();this.Ze.forEach(((i,o)=>{let c=!0;o.forEachWhile((u=>{const h=this.ut(u);return!h||h.purpose==="TargetPurposeLimboResolution"||(c=!1,!1)})),c&&(r=r.add(i))})),this.He.forEach(((i,o)=>o.setReadTime(e))),this.Ye.forEach(((i,o)=>o.setReadTime(e)));const s=new ci(e,t,this.Xe,this.He,this.Ye,r);return this.He=ut(),this.Je=$i(),this.Ye=ut(),this.Ze=$i(),this.Xe=new ge(ie),s}tt(e,t){const r=this.je.get(e);if(!r||!this.it(e))return void H(fs,`addDocumentToTarget received document for unknown inactive target (${e})`);const s=this.At(e,t.key)?2:0;r.$e(t.key,s),Zn(this.ut(e).target)&&this.ut(e).target.getPipelineFlavor()!=="exact"?this.Ye=this.Ye.insert(t.key,t):this.He=this.He.insert(t.key,t),this.Je=this.Je.insert(t.key,this.It(t.key).add(e)),this.Ze=this.Ze.insert(t.key,this.Vt(t.key).add(e))}nt(e,t,r){const s=this.je.get(e);s&&this.it(e)?(this.At(e,t)?s.$e(t,1):s.Ke(t),this.Ze=this.Ze.insert(t,this.Vt(t).delete(e)),this.Ze=this.Ze.insert(t,this.Vt(t).add(e)),r&&(Zn(this.ut(e).target)&&this.ut(e).target.getPipelineFlavor()!=="exact"?this.Ye=this.Ye.insert(t,r):this.He=this.He.insert(t,r))):H(fs,`removeDocumentFromTarget received document for unknown or inactive target (${e})`)}removeTarget(e){this.je.delete(e)}ct(e){const t=this.je.get(e);if(!t)return 0;const r=t.ke();return this.ze.getRemoteKeysForTarget(e).size+r.addedDocuments.size-r.removedDocuments.size}We(e){let t=this.je.get(e);t||(H(fs,`recordPendingTargetRequest set up tracking for target ID ${e}`),t=new Ql(e),this.je.set(e,t)),t.We()}Vt(e){let t=this.Ze.get(e);return t||(t=new Oe(ie),this.Ze=this.Ze.insert(e,t)),t}It(e){let t=this.Je.get(e);return t||(t=new Oe(ie),this.Je=this.Je.insert(e,t)),t}it(e){const t=this.ut(e)!==null;return t||H(fs,"Detected inactive target",e),t}ut(e){const t=this.je.get(e);return t===void 0||t.Le?null:this.ze.dt(e)}st(e){this.je.set(e,new Ql(e)),this.ze.getRemoteKeysForTarget(e).forEach((t=>{this.nt(e,t,null)}))}At(e,t){return this.ze.getRemoteKeysForTarget(e).has(t)}}function $i(){return new ge(j.comparator)}function Xl(){return new ge(j.comparator)}const h4={asc:"ASCENDING",desc:"DESCENDING"},d4={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},f4={and:"AND",or:"OR"};class p4{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function _c(n,e){return n.useProto3Json||Lo(e)?e:{value:e}}function mo(n,e){return n.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function qc(n){const e=Vn(n);return new me(e.seconds,e.nanos)}function nd(n,e){return n.useProto3Json?e.toBase64():e.toUint8Array()}function Ji(n,e){return mo(n,e.toTimestamp())}function Ht(n){return q(!!n,49232),Q.fromTimestamp(qc(n))}function jc(n,e){return Ec(n,e).canonicalString()}function Ec(n,e){const t=(function(s){return new de(["projects",s.projectId,"databases",s.database])})(n).child("documents");return e===void 0?t:t.child(e)}function rd(n){const e=de.fromString(n);return q(cd(e),10190,{key:e.toString()}),e}function go(n,e){return jc(n.databaseId,e.path)}function ja(n,e){const t=rd(e);if(t.get(1)!==n.databaseId.projectId)throw new F(D.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+n.databaseId.projectId);if(t.get(3)!==n.databaseId.database)throw new F(D.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+n.databaseId.database);return new j(id(t))}function sd(n,e){return jc(n.databaseId,e)}function m4(n){const e=rd(n);return e.length===4?de.emptyPath():id(e)}function yc(n){return new de(["projects",n.databaseId.projectId,"databases",n.databaseId.database]).canonicalString()}function id(n){return q(n.length>4&&n.get(4)==="documents",29091,{key:n.toString()}),n.popFirst(5)}function Jl(n,e,t){return{name:go(n,e),fields:t.value.mapValue.fields}}function g4(n,e){let t;if("targetChange"in e){e.targetChange;const r=(function(h){return h==="NO_CHANGE"?0:h==="ADD"?1:h==="REMOVE"?2:h==="CURRENT"?3:h==="RESET"?4:W(39313,{state:h})})(e.targetChange.targetChangeType||"NO_CHANGE"),s=e.targetChange.targetIds||[],i=(function(h,f){return h.useProto3Json?(q(f===void 0||typeof f=="string",58123),ke.fromBase64String(f||"")):(q(f===void 0||f instanceof Buffer||f instanceof Uint8Array,16193),ke.fromUint8Array(f||new Uint8Array))})(n,e.targetChange.resumeToken),o=e.targetChange.cause,c=o&&(function(h){const f=h.code===void 0?D.UNKNOWN:Q2(h.code);return new F(f,h.message||"")})(o);t=new td(r,s,i,c||null)}else if("documentChange"in e){e.documentChange;const r=e.documentChange;r.document,r.document.name,r.document.updateTime;const s=ja(n,r.document.name),i=Ht(r.document.updateTime),o=r.document.createTime?Ht(r.document.createTime):Q.min(),c=new st({mapValue:{fields:r.document.fields}}),u=Xe.newFoundDocument(s,i,o,c),h=r.targetIds||[],f=r.removedTargetIds||[];t=new Xi(h,f,u.key,u)}else if("documentDelete"in e){e.documentDelete;const r=e.documentDelete;r.document;const s=ja(n,r.document),i=r.readTime?Ht(r.readTime):Q.min(),o=Xe.newNoDocument(s,i),c=r.removedTargetIds||[];t=new Xi([],c,o.key,o)}else if("documentRemove"in e){e.documentRemove;const r=e.documentRemove;r.document;const s=ja(n,r.document),i=r.removedTargetIds||[];t=new Xi([],i,s,null)}else{if(!("filter"in e))return W(11601,{ft:e});{e.filter;const r=e.filter;r.targetId;const{count:s=0,unchangedNames:i}=r,o=new t4(s,i),c=r.targetId;t=new ed(c,o)}}return t}function _4(n,e){let t;if(e instanceof ai)t={update:Jl(n,e.key,e.value)};else if(e instanceof $o)t={delete:go(n,e.key)};else if(e instanceof Gn)t={update:Jl(n,e.key,e.data),updateMask:S4(e.fieldMask)};else{if(!(e instanceof U7))return W(16599,{gt:e.type});t={verify:go(n,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map((r=>(function(i,o){const c=o.transform;if(c instanceof js)return{fieldPath:o.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(c instanceof Gs)return{fieldPath:o.field.canonicalString(),appendMissingElements:{values:c.elements}};if(c instanceof Ws)return{fieldPath:o.field.canonicalString(),removeAllFromArray:{values:c.elements}};if(c instanceof Mr)return{fieldPath:o.field.canonicalString(),increment:c.Re};if(c instanceof lo)return{fieldPath:o.field.canonicalString(),minimum:c.Re};if(c instanceof ho)return{fieldPath:o.field.canonicalString(),maximum:c.Re};throw W(20930,{transform:o.transform})})(0,r)))),e.precondition.isNone||(t.currentDocument=(function(s,i){return i.updateTime!==void 0?{updateTime:Ji(s,i.updateTime)}:i.exists!==void 0?{exists:i.exists}:W(27497)})(n,e.precondition)),t}function E4(n,e){return n&&n.length>0?(q(e!==void 0,14353),n.map((t=>(function(s,i){let o=s.updateTime?Ht(s.updateTime):Ht(i);return o.isEqual(Q.min())&&(o=Ht(i)),new L7(o,s.transformResults||[])})(t,e)))):[]}function y4(n,e){return{documents:[sd(n,e.path)]}}function w4(n,e){const t={structuredQuery:{}},r=e.path;let s;e.collectionGroup!==null?(s=r,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(s=r.popLast(),t.structuredQuery.from=[{collectionId:r.lastSegment()}]),t.parent=sd(n,s);const i=(function(h){if(h.length!==0)return ad(Dt.create(h,"and"))})(e.filters);i&&(t.structuredQuery.where=i);const o=(function(h){if(h.length!==0)return h.map((f=>(function(w){return{field:Tr(w.field),direction:R4(w.dir)}})(f)))})(e.orderBy);o&&(t.structuredQuery.orderBy=o);const c=_c(n,e.limit);return c!==null&&(t.structuredQuery.limit=c),e.startAt&&(t.structuredQuery.startAt=(function(h){return{before:h.inclusive,values:h.position}})(e.startAt)),e.endAt&&(t.structuredQuery.endAt=(function(h){return{before:!h.inclusive,values:h.position}})(e.endAt)),{yt:t,parent:s}}function I4(n){let e=m4(n.parent);const t=n.structuredQuery,r=t.from?t.from.length:0;let s=null;if(r>0){q(r===1,65062);const f=t.from[0];f.allDescendants?s=f.collectionId:e=e.child(f.collectionId)}let i=[];t.where&&(i=(function(p){const w=od(p);return w instanceof Dt&&H2(w)?w.getFilters():[w]})(t.where));let o=[];t.orderBy&&(o=(function(p){return p.map((w=>(function(P){return new zs(Ar(P.field),(function(x){switch(x){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}})(P.direction))})(w)))})(t.orderBy));let c=null;t.limit&&(c=(function(p){let w;return w=typeof p=="object"?p.value:p,Lo(w)?null:w})(t.limit));let u=null;t.startAt&&(u=(function(p){const w=!!p.before,b=p.values||[];return new po(b,w)})(t.startAt));let h=null;return t.endAt&&(h=(function(p){const w=!p.before,b=p.values||[];return new po(b,w)})(t.endAt)),Y7(e,s,o,i,c,"F",u,h)}function T4(n,e){const t=(function(s){switch(s){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return W(28987,{purpose:s})}})(e.purpose);return t==null?null:{"goog-listen-tags":t}}function A4(n,e){return{structuredPipeline:{pipeline:{stages:e.stages.map((t=>t._toProto(n)))}}}}function od(n){return n.unaryFilter!==void 0?(function(t){switch(t.unaryFilter.op){case"IS_NAN":const r=Ar(t.unaryFilter.field);return be.create(r,"==",{doubleValue:NaN});case"IS_NULL":const s=Ar(t.unaryFilter.field);return be.create(s,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const i=Ar(t.unaryFilter.field);return be.create(i,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const o=Ar(t.unaryFilter.field);return be.create(o,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":return W(61313);default:return W(60726)}})(n):n.fieldFilter!==void 0?(function(t){return be.create(Ar(t.fieldFilter.field),(function(s){switch(s){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":return W(58110);default:return W(50506)}})(t.fieldFilter.op),t.fieldFilter.value)})(n):n.compositeFilter!==void 0?(function(t){return Dt.create(t.compositeFilter.filters.map((r=>od(r))),(function(s){switch(s){case"AND":return"and";case"OR":return"or";default:return W(1026)}})(t.compositeFilter.op))})(n):W(30097,{filter:n})}function R4(n){return h4[n]}function v4(n){return d4[n]}function C4(n){return f4[n]}function Tr(n){return{fieldPath:n.canonicalString()}}function Ar(n){return Me.fromServerFormat(n.fieldPath)}function ad(n){return n instanceof be?(function(t){if(t.op==="=="){if(pt(t.value))return{unaryFilter:{field:Tr(t.field),op:"IS_NAN"}};if(Et(t.value))return{unaryFilter:{field:Tr(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(pt(t.value))return{unaryFilter:{field:Tr(t.field),op:"IS_NOT_NAN"}};if(Et(t.value))return{unaryFilter:{field:Tr(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:Tr(t.field),op:v4(t.op),value:t.value}}})(n):n instanceof Dt?(function(t){const r=t.getFilters().map((s=>ad(s)));return r.length===1?r[0]:{compositeFilter:{op:C4(t.op),filters:r}}})(n):W(54877,{filter:n})}function S4(n){const e=[];return n.fields.forEach((t=>e.push(t.canonicalString()))),{fieldPaths:e}}function cd(n){return n.length>=4&&n.get(0)==="projects"&&n.get(2)==="databases"}function ud(n){return!!n&&typeof n._toProto=="function"&&n._protoValueType==="ProtoValue"}function Ks(n,e){const t={fields:{}};return e.forEach(((r,s)=>{if(typeof s!="string")throw new Error(`Cannot encode map with non-string key: ${s}`);t.fields[s]=r._toProto(n)})),{mapValue:t}}function ld(n){return{stringValue:n}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jo(n){return new p4(n,!0)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class li{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new F(D.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Me(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}function P4(){return new li(Mt)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qt{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new F(D.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new F(D.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return ie(this._lat,e._lat)||ie(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:qt._jsonSchemaVersion}}static fromJSON(e){if(ii(e,qt._jsonSchema))return new qt(e.latitude,e.longitude)}}function hd(n){const e={};return n.timeoutSeconds!==void 0&&(e.timeoutSeconds=n.timeoutSeconds),e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */qt._jsonSchemaVersion="firestore/geoPoint/1.0",qt._jsonSchema={type:Ne("string",qt._jsonSchemaVersion),latitude:Ne("number"),longitude:Ne("number")};class b4{bt(e){}shutdown(){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zl="ConnectivityMonitor";class eh{constructor(){this.vt=()=>this.St(),this.Dt=()=>this.xt(),this.Ct=[],this.Ft()}bt(e){this.Ct.push(e)}shutdown(){window.removeEventListener("online",this.vt),window.removeEventListener("offline",this.Dt)}Ft(){window.addEventListener("online",this.vt),window.addEventListener("offline",this.Dt)}St(){H(Zl,"Network connectivity changed: AVAILABLE");for(const e of this.Ct)e(0)}xt(){H(Zl,"Network connectivity changed: UNAVAILABLE");for(const e of this.Ct)e(1)}static C(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ga="RestConnection",N4={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class O4{get Ot(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Mt=t+"://"+e.host,this.Nt=`projects/${r}/databases/${s}`,this.Lt=this.databaseId.database===hc?`project_id=${r}`:`project_id=${r}&database_id=${s}`}Bt(e,t,r,s,i){const o=wc(),c=this.Ut(e,t.toUriEncodedString());H(Ga,`Sending RPC '${e}' ${o}:`,c,r);const u={"google-cloud-resource-prefix":this.Nt,"x-goog-request-params":this.Lt};this.kt(u,s,i);const{host:h}=new URL(c),f=dr(h);return this.qt(e,c,u,r,f).then((p=>(H(Ga,`Received RPC '${e}' ${o}: `,p),p)),(p=>{throw kt(Ga,`RPC '${e}' ${o} failed with error: `,p,"url: ",c,"request:",r),p}))}$t(e,t,r,s,i,o){return this.Bt(e,t,r,s,i)}kt(e,t,r){e["X-Goog-Api-Client"]=(function(){return"gl-js/ fire/"+Br})(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach(((s,i)=>e[i]=s)),r&&r.headers.forEach(((s,i)=>e[i]=s))}Ut(e,t){const r=N4[e];let s=`${this.Mt}/v1/${t}:${r}`;return this.databaseInfo.apiKey&&(s=`${s}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),s}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class k4{constructor(e){this.Kt=e.Kt,this.Wt=e.Wt}Qt(e){this.Gt=e}zt(e){this.jt=e}Ht(e){this.Jt=e}onMessage(e){this.Yt=e}close(){this.Wt()}send(e){this.Kt(e)}Zt(){this.Gt()}Xt(){this.jt()}en(e){this.Jt(e)}tn(e){this.Yt(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ke="WebChannelConnection",ps=(n,e,t)=>{n.listen(e,(r=>{try{t(r)}catch(s){setTimeout((()=>{throw s}),0)}}))};class Cr extends O4{constructor(e){super(e),this.nn=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static rn(){if(!Cr.sn){const e=_2();ps(e,g2.STAT_EVENT,(t=>{t.stat===uc.PROXY?H(Ke,"STAT_EVENT: detected buffering proxy"):t.stat===uc.NOPROXY&&H(Ke,"STAT_EVENT: detected no buffering proxy")})),Cr.sn=!0}}qt(e,t,r,s,i){const o=wc();return new Promise(((c,u)=>{const h=new p2;h.setWithCredentials(!0),h.listenOnce(m2.COMPLETE,(()=>{try{switch(h.getLastErrorCode()){case Ki.NO_ERROR:const p=h.getResponseJson();H(Ke,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),c(p);break;case Ki.TIMEOUT:H(Ke,`RPC '${e}' ${o} timed out`),u(new F(D.DEADLINE_EXCEEDED,"Request time out"));break;case Ki.HTTP_ERROR:const w=h.getStatus();if(H(Ke,`RPC '${e}' ${o} failed with status:`,w,"response text:",h.getResponseText()),w>0){let b=h.getResponseJson();Array.isArray(b)&&(b=b[0]);const P=b?.error;if(P&&P.status&&P.message){const L=(function(z){const te=z.toLowerCase().replace(/_/g,"-");return Object.values(D).indexOf(te)>=0?te:D.UNKNOWN})(P.status);u(new F(L,P.message))}else u(new F(D.UNKNOWN,"Server responded with status "+h.getStatus()))}else u(new F(D.UNAVAILABLE,"Connection failed."));break;default:W(9055,{_n:e,streamId:o,an:h.getLastErrorCode(),un:h.getLastError()})}}finally{H(Ke,`RPC '${e}' ${o} completed.`)}}));const f=JSON.stringify(s);H(Ke,`RPC '${e}' ${o} sending request:`,s),h.send(t,"POST",f,r,15)}))}cn(e,t,r){const s=wc(),i=[this.Mt,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=this.createWebChannelTransport(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(c.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(c.useFetchStreams=!0),this.kt(c.initMessageHeaders,t,r),c.encodeInitMessageHeaders=!0;const h=i.join("");H(Ke,`Creating RPC '${e}' stream ${s}: ${h}`,c);const f=o.createWebChannel(h,c);this.En(f);let p=!1,w=!1;const b=new k4({Kt:P=>{w?H(Ke,`Not sending because RPC '${e}' stream ${s} is closed:`,P):(p||(H(Ke,`Opening RPC '${e}' stream ${s} transport.`),f.open(),p=!0),H(Ke,`RPC '${e}' stream ${s} sending:`,P),f.send(P))},Wt:()=>f.close()});return ps(f,ys.EventType.OPEN,(()=>{w||(H(Ke,`RPC '${e}' stream ${s} transport opened.`),b.Zt())})),ps(f,ys.EventType.CLOSE,(()=>{w||(w=!0,H(Ke,`RPC '${e}' stream ${s} transport closed`),b.en(),this.hn(f))})),ps(f,ys.EventType.ERROR,(P=>{w||(w=!0,kt(Ke,`RPC '${e}' stream ${s} transport errored. Name:`,P.name,"Message:",P.message),b.en(new F(D.UNAVAILABLE,"The operation could not be completed")))})),ps(f,ys.EventType.MESSAGE,(P=>{if(!w){const L=P.data[0];q(!!L,16349);const x=L,z=x?.error||x[0]?.error;if(z){H(Ke,`RPC '${e}' stream ${s} received error:`,z);const te=z.status;let re=(function(_e){const A=Ce[_e];if(A!==void 0)return Q2(A)})(te),he=z.message;te==="NOT_FOUND"&&he.includes("database")&&he.includes("does not exist")&&he.includes(this.databaseId.database)&&kt(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),re===void 0&&(re=D.INTERNAL,he="Unknown error status: "+te+" with message "+z.message),w=!0,b.en(new F(re,he)),f.close()}else H(Ke,`RPC '${e}' stream ${s} received:`,L),b.tn(L)}})),Cr.rn(),setTimeout((()=>{b.Xt()}),0),b}terminate(){this.nn.forEach((e=>e.close())),this.nn=[]}En(e){this.nn.push(e)}hn(e){this.nn=this.nn.filter((t=>t===e))}kt(e,t,r){super.kt(e,t,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return E2()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const th="PersistentStream";class fd{constructor(e,t,r,s,i,o,c,u){this.Tn=e,this.yn=r,this.wn=s,this.connection=i,this.authCredentialsProvider=o,this.appCheckCredentialsProvider=c,this.listener=u,this.state=0,this.bn=0,this.vn=null,this.Sn=null,this.stream=null,this.Dn=0,this.xn=new dd(e,t)}Cn(){return this.state===1||this.state===5||this.Fn()}Fn(){return this.state===2||this.state===3}start(){this.Dn=0,this.state!==4?this.auth():this.On()}async stop(){this.Cn()&&await this.close(0)}Mn(){this.state=0,this.xn.reset()}Nn(){this.Fn()&&this.vn===null&&(this.vn=this.Tn.enqueueAfterDelay(this.yn,6e4,(()=>this.Ln())))}Bn(e){this.Un(),this.stream.send(e)}async Ln(){if(this.Fn())return this.close(0)}Un(){this.vn&&(this.vn.cancel(),this.vn=null)}kn(){this.Sn&&(this.Sn.cancel(),this.Sn=null)}async close(e,t){this.Un(),this.kn(),this.xn.cancel(),this.bn++,e!==4?this.xn.reset():t&&t.code===D.RESOURCE_EXHAUSTED?(an(t.toString()),an("Using maximum backoff delay to prevent overloading the backend."),this.xn.fn()):t&&t.code===D.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.qn(),this.stream.close(),this.stream=null),this.state=e,await this.listener.Ht(t)}qn(){}auth(){this.state=1;const e=this.$n(this.bn),t=this.bn;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then((([r,s])=>{this.bn===t&&this.Kn(r,s)}),(r=>{e((()=>{const s=new F(D.UNKNOWN,"Fetching auth token failed: "+r.message);return this.Wn(s)}))}))}Kn(e,t){const r=this.$n(this.bn);this.stream=this.Qn(e,t),this.stream.Qt((()=>{r((()=>this.listener.Qt()))})),this.stream.zt((()=>{r((()=>(this.state=2,this.Sn=this.Tn.enqueueAfterDelay(this.wn,1e4,(()=>(this.Fn()&&(this.state=3),Promise.resolve()))),this.listener.zt())))})),this.stream.Ht((s=>{r((()=>this.Wn(s)))})),this.stream.onMessage((s=>{r((()=>++this.Dn==1?this.Gn(s):this.onNext(s)))}))}On(){this.state=5,this.xn.mn((async()=>{this.state=0,this.start()}))}Wn(e){return H(th,`close with error: ${e}`),this.stream=null,this.close(4,e)}$n(e){return t=>{this.Tn.enqueueAndForget((()=>this.bn===e?t():(H(th,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve())))}}}class V4 extends fd{constructor(e,t,r,s,i,o){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,r,s,o),this.serializer=i}Qn(e,t){return this.connection.cn("Listen",e,t)}Gn(e){return this.onNext(e)}onNext(e){this.xn.reset();const t=g4(this.serializer,e),r=(function(i){if(!("targetChange"in i))return Q.min();const o=i.targetChange;return o.targetIds&&o.targetIds.length?Q.min():o.readTime?Ht(o.readTime):Q.min()})(e);return this.listener.zn(t,r)}jn(e){const t={};t.database=yc(this.serializer),t.addTarget=(function(i,o){let c;const u=o.target;if(c=Zn(u)?{pipelineQuery:A4(i,u)}:K2(u)?{documents:y4(i,u)}:{query:w4(i,u).yt},c.targetId=o.targetId,o.resumeToken.approximateByteSize()>0){c.resumeToken=nd(i,o.resumeToken);const h=_c(i,o.expectedCount);h!==null&&(c.expectedCount=h)}else if(o.snapshotVersion.compareTo(Q.min())>0){c.readTime=mo(i,o.snapshotVersion.toTimestamp());const h=_c(i,o.expectedCount);h!==null&&(c.expectedCount=h)}return c})(this.serializer,e);const r=T4(this.serializer,e);r&&(t.labels=r),this.Bn(t)}Hn(e){const t={};t.database=yc(this.serializer),t.removeTarget=e,this.Bn(t)}}class L4 extends fd{constructor(e,t,r,s,i,o){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,r,s,o),this.serializer=i}get Jn(){return this.Dn>0}start(){this.lastStreamToken=void 0,super.start()}qn(){this.Jn&&this.Yn([])}Qn(e,t){return this.connection.cn("Write",e,t)}Gn(e){return q(!!e.streamToken,31322),this.lastStreamToken=e.streamToken,q(!e.writeResults||e.writeResults.length===0,55816),this.listener.Zn()}onNext(e){q(!!e.streamToken,12678),this.lastStreamToken=e.streamToken,this.xn.reset();const t=E4(e.writeResults,e.commitTime),r=Ht(e.commitTime);return this.listener.Xn(r,t)}er(){const e={};e.database=yc(this.serializer),this.Bn(e)}Yn(e){const t={streamToken:this.lastStreamToken,writes:e.map((r=>_4(this.serializer,r)))};this.Bn(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const F4="ComponentProvider",nh=new Map;function B4(n,e,t,r,s){return new P7(n,e,t,s.host,s.ssl,s.experimentalForceLongPolling,s.experimentalAutoDetectLongPolling,hd(s.experimentalLongPollingOptions),s.useFetchStreams,s.isUsingEmulator,r)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sh="LruGarbageCollector",$4=1048576;function ih([n,e],[t,r]){const s=ie(n,t);return s===0?ie(e,r):s}class H4{constructor(e){this.rr=e,this.buffer=new Oe(ih),this.ir=0}sr(){return++this.ir}_r(e){const t=[e,this.sr()];if(this.buffer.size<this.rr)this.buffer=this.buffer.add(t);else{const r=this.buffer.last();ih(t,r)<0&&(this.buffer=this.buffer.delete(r).add(t))}}get maxValue(){return this.buffer.last()[0]}}class q4{constructor(e,t,r){this.garbageCollector=e,this.asyncQueue=t,this.localStore=r,this.ar=null}start(){this.garbageCollector.params.cacheSizeCollectionThreshold!==-1&&this.ur(6e4)}stop(){this.ar&&(this.ar.cancel(),this.ar=null)}get started(){return this.ar!==null}ur(e){H(sh,`Garbage collection scheduled in ${e}ms`),this.ar=this.asyncQueue.enqueueAfterDelay("lru_garbage_collection",e,(async()=>{this.ar=null;try{await this.localStore.collectGarbage(this.garbageCollector)}catch(t){Hr(t)?H(sh,"Ignoring IndexedDB error during garbage collection: ",t):await $r(t)}await this.ur(3e5)}))}}class j4{constructor(e,t){this.cr=e,this.params=t}calculateTargetCount(e,t){return this.cr.lr(e).next((r=>Math.floor(t/100*r)))}nthSequenceNumber(e,t){if(t===0)return V.resolve(Vo.ce);const r=new H4(t);return this.cr.forEachTarget(e,(s=>r._r(s.sequenceNumber))).next((()=>this.cr.Er(e,(s=>r._r(s))))).next((()=>r.maxValue))}removeTargets(e,t,r){return this.cr.removeTargets(e,t,r)}removeOrphanedDocuments(e,t){return this.cr.removeOrphanedDocuments(e,t)}collect(e,t){return this.params.cacheSizeCollectionThreshold===-1?(H("LruGarbageCollector","Garbage collection skipped; disabled"),V.resolve(rh)):this.getCacheSize(e).next((r=>r<this.params.cacheSizeCollectionThreshold?(H("LruGarbageCollector",`Garbage collection skipped; Cache size ${r} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`),rh):this.hr(e,t)))}getCacheSize(e){return this.cr.getCacheSize(e)}hr(e,t){let r,s,i,o,c,u,h;const f=Date.now();return this.calculateTargetCount(e,this.params.percentileToCollect).next((p=>(p>this.params.maximumSequenceNumbersToCollect?(H("LruGarbageCollector",`Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${p}`),s=this.params.maximumSequenceNumbersToCollect):s=p,o=Date.now(),this.nthSequenceNumber(e,s)))).next((p=>(r=p,c=Date.now(),this.removeTargets(e,r,t)))).next((p=>(i=p,u=Date.now(),this.removeOrphanedDocuments(e,r)))).next((p=>(h=Date.now(),wr()<=oe.DEBUG&&H("LruGarbageCollector",`LRU Garbage Collection
	Counted targets in ${o-f}ms
	Determined least recently used ${s} in `+(c-o)+`ms
	Removed ${i} targets in `+(u-c)+`ms
	Removed ${p} documents in `+(h-u)+`ms
Total Duration: ${h-f}ms`),V.resolve({didRun:!0,sequenceNumbersCollected:s,targetsRemoved:i,documentsRemoved:p}))))}}function G4(n,e){return new j4(n,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const md="firestore.googleapis.com",oh=!0;class ah{constructor(e){if(e.host===void 0){if(e.ssl!==void 0)throw new F(D.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host=md,this.ssl=oh}else this.host=e.host,this.ssl=e.ssl??oh;if(this.isUsingEmulator=e.emulatorOptions!==void 0,this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,e.cacheSizeBytes===void 0)this.cacheSizeBytes=pd;else{if(e.cacheSizeBytes!==-1&&e.cacheSizeBytes<$4)throw new F(D.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}m7("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:e.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=hd(e.experimentalLongPollingOptions??{}),(function(r){if(r.timeoutSeconds!==void 0){if(isNaN(r.timeoutSeconds))throw new F(D.INVALID_ARGUMENT,`invalid long polling timeout: ${r.timeoutSeconds} (must not be NaN)`);if(r.timeoutSeconds<5)throw new F(D.INVALID_ARGUMENT,`invalid long polling timeout: ${r.timeoutSeconds} (minimum allowed value is 5)`);if(r.timeoutSeconds>30)throw new F(D.INVALID_ARGUMENT,`invalid long polling timeout: ${r.timeoutSeconds} (maximum allowed value is 30)`)}})(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&(function(r,s){return r.timeoutSeconds===s.timeoutSeconds})(this.experimentalLongPollingOptions,e.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}class Go{constructor(e,t,r,s){this._authCredentials=e,this._appCheckCredentials=t,this._databaseId=r,this._app=s,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new ah({}),this._settingsFrozen=!1,this._emulatorOptions={},this._terminateTask="notTerminated"}get app(){if(!this._app)throw new F(D.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(e){if(this._settingsFrozen)throw new F(D.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new ah(e),this._emulatorOptions=e.emulatorOptions||{},e.credentials!==void 0&&(this._authCredentials=(function(r){if(!r)return new i7;switch(r.type){case"firstParty":return new u7(r.sessionIndex||"0",r.iamToken||null,r.authTokenFactory||null);case"provider":return r.client;default:throw new F(D.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}})(e.credentials))}_getSettings(){return this._settings}_getEmulatorOptions(){return this._emulatorOptions}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return(function(t){const r=nh.get(t);r&&(H(F4,"Removing Datastore"),nh.delete(t),r.terminate())})(this),Promise.resolve()}}function W4(n,e,t,r={}){n=it(n,Go);const s=dr(e),i=n._getSettings(),o={...i,emulatorOptions:n._getEmulatorOptions()},c=`${e}:${t}`;s&&kc(`https://${c}`),i.host!==md&&i.host!==c&&kt("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");const u={...i,host:c,ssl:s,emulatorOptions:r};if(!or(u,o)&&(n._setSettings(u),r.mockUserToken)){let h,f;if(typeof r.mockUserToken=="string")h=r.mockUserToken,f=Qe.MOCK_USER;else{h=c2(r.mockUserToken,n._app?.options.projectId);const p=r.mockUserToken.sub||r.mockUserToken.user_id;if(!p)throw new F(D.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");f=new Qe(p)}n._authCredentials=new o7(new I2(h,f))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wn{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new Wn(this.firestore,e,this._query)}}class ye{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Pn(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new ye(this.firestore,e,this._key)}toJSON(){return{type:ye._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(e,t,r){if(ii(t,ye._jsonSchema))return new ye(e,r||null,new j(de.fromString(t.referencePath)))}}ye._jsonSchemaVersion="firestore/documentReference/1.0",ye._jsonSchema={type:Ne("string",ye._jsonSchemaVersion),referencePath:Ne("string")};class Pn extends Wn{constructor(e,t,r){super(e,t,Ho(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new ye(this.firestore,null,new j(e))}withConverter(e){return new Pn(this.firestore,e,this._path)}}function dE(n,e,...t){if(n=X(n),T2("collection","path",e),n instanceof Go){const r=de.fromString(e,...t);return kl(r),new Pn(n,null,r)}{if(!(n instanceof ye||n instanceof Pn))throw new F(D.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(de.fromString(e,...t));return kl(r),new Pn(n.firestore,null,r)}}function z4(n,e,...t){if(n=X(n),arguments.length===1&&(e=Mc.newId()),T2("doc","path",e),n instanceof Go){const r=de.fromString(e,...t);return Ol(r),new ye(n,null,new j(r))}{if(!(n instanceof ye||n instanceof Pn))throw new F(D.INVALID_ARGUMENT,"Expected first argument to doc() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(de.fromString(e,...t));return Ol(r),new ye(n.firestore,n instanceof Pn?n.converter:null,new j(r))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lt{constructor(e){this._values=(e||[]).map((t=>t))}toArray(){return this._values.map((e=>e))}isEqual(e){return(function(r,s){if(r.length!==s.length)return!1;for(let i=0;i<r.length;++i)if(r[i]!==s[i])return!1;return!0})(this._values,e._values)}toJSON(){return{type:lt._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(ii(e,lt._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every((t=>typeof t=="number")))return new lt(e.vectorValues);throw new F(D.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}lt._jsonSchemaVersion="firestore/vectorValue/1.0",lt._jsonSchema={type:Ne("string",lt._jsonSchemaVersion),vectorValues:Ne("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const K4=/^__.*__$/;class Y4{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return this.fieldMask!==null?new Gn(e,this.data,this.fieldMask,t,this.fieldTransforms):new ai(e,this.data,t,this.fieldTransforms)}}class gd{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return new Gn(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function _d(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw W(40011,{dataSource:n})}}class Gc{constructor(e,t,r,s,i,o){this.settings=e,this.databaseId=t,this.serializer=r,this.ignoreUndefinedProperties=s,i===void 0&&this.validatePath(),this.fieldTransforms=i||[],this.fieldMask=o||[]}get path(){return this.settings.path}get dataSource(){return this.settings.dataSource}contextWith(e){return new Gc({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}childContextForField(e){const t=this.path?.child(e),r=this.contextWith({path:t,arrayElement:!1});return r.validatePathSegment(e),r}childContextForFieldPath(e){const t=this.path?.child(e),r=this.contextWith({path:t,arrayElement:!1});return r.validatePath(),r}childContextForArray(e){return this.contextWith({path:void 0,arrayElement:!0})}createError(e){return _o(e,this.settings.methodName,this.settings.hasConverter||!1,this.path,this.settings.targetDoc)}contains(e){return this.fieldMask.find((t=>e.isPrefixOf(t)))!==void 0||this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))!==void 0}validatePath(){if(this.path)for(let e=0;e<this.path.length;e++)this.validatePathSegment(this.path.get(e))}validatePathSegment(e){if(e.length===0)throw this.createError("Document fields must not be empty");if(_d(this.dataSource)&&K4.test(e))throw this.createError('Document fields cannot begin and end with "__"')}}class Q4{constructor(e,t,r){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=r||jo(e)}createContext(e,t,r,s=!1){return new Gc({dataSource:e,methodName:t,targetDoc:r,path:Me.emptyPath(),arrayElement:!1,hasConverter:s},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function di(n){const e=n._freezeSettings(),t=jo(n._databaseId);return new Q4(n._databaseId,!!e.ignoreUndefinedProperties,t)}function Wc(n,e,t,r,s,i={}){const o=n.createContext(i.merge||i.mergeFields?2:0,e,t,s);Yc("Data must be an object, but it was:",o,r);const c=wd(r,o);let u,h;if(i.merge)u=new _t(o.fieldMask),h=o.fieldTransforms;else if(i.mergeFields){const f=[];for(const p of i.mergeFields){const w=Un(e,p,t);if(!o.contains(w))throw new F(D.INVALID_ARGUMENT,`Field '${w}' is specified in your field mask but missing from your input data.`);Ad(f,w)||f.push(w)}u=new _t(f),h=o.fieldTransforms.filter((p=>u.covers(p.field)))}else u=null,h=o.fieldTransforms;return new Y4(new st(c),u,h)}class Wo extends hi{_toFieldTransform(e){if(e.dataSource!==2)throw e.dataSource===1?e.createError(`${this._methodName}() can only appear at the top level of your update data`):e.createError(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof Wo}}class zc extends hi{_toFieldTransform(e){return new M2(e.path,new js)}isEqual(e){return e instanceof zc}}class Kc extends hi{constructor(e,t){super(e),this.Pr=t}_toFieldTransform(e){const t=new Mr(e.serializer,Uo(e.serializer,this.Pr));return new M2(e.path,t)}isEqual(e){return e instanceof Kc&&(this.Pr===e.Pr||Number.isNaN(this.Pr)&&Number.isNaN(e.Pr))}}function Ed(n,e,t,r){const s=n.createContext(1,e,t);Yc("Data must be an object, but it was:",s,r);const i=[],o=st.empty();jn(r,((u,h)=>{const f=Td(e,u,t);h=X(h);const p=s.childContextForFieldPath(f);if(h instanceof Wo)i.push(f);else{const w=Mn(h,p);w!=null&&(i.push(f),o.set(f,w))}}));const c=new _t(i);return new gd(o,c,s.fieldTransforms)}function yd(n,e,t,r,s,i){const o=n.createContext(1,e,t),c=[Un(e,r,t)],u=[s];if(i.length%2!=0)throw new F(D.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let w=0;w<i.length;w+=2)c.push(Un(e,i[w])),u.push(i[w+1]);const h=[],f=st.empty();for(let w=c.length-1;w>=0;--w)if(!Ad(h,c[w])){const b=c[w];let P=u[w];P=X(P);const L=o.childContextForFieldPath(b);if(P instanceof Wo)h.push(b);else{const x=Mn(P,L);x!=null&&(h.push(b),f.set(b,x))}}const p=new _t(h);return new gd(f,p,o.fieldTransforms)}function X4(n,e,t,r=!1){return Mn(t,n.createContext(r?4:3,e))}function Mn(n,e,t){if(Id(n=X(n)))return Yc("Unsupported field value:",e,n),wd(n,e);if(n instanceof hi)return(function(s,i){if(!_d(i.dataSource))throw i.createError(`${s._methodName}() can only be used with update() and set()`);if(!i.path)throw i.createError(`${s._methodName}() is not currently supported inside arrays`);const o=s._toFieldTransform(i);o&&i.fieldTransforms.push(o)})(n,e),null;if(n===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),n instanceof Array){if(e.settings.arrayElement&&e.dataSource!==4)throw e.createError("Nested arrays are not supported");return(function(s,i){const o=[];let c=0;for(const u of s){let h=Mn(u,i.childContextForArray(c));h==null&&(h={nullValue:"NULL_VALUE"}),o.push(h),c++}return{arrayValue:{values:o}}})(n,e)}return(function(s,i,o){if((s=X(s))===null)return{nullValue:"NULL_VALUE"};if(typeof s=="number")return Uo(i.serializer,s,o);if(typeof s=="boolean")return{booleanValue:s};if(typeof s=="string")return{stringValue:s};if(s instanceof Date){const c=me.fromDate(s);return{timestampValue:mo(i.serializer,c)}}if(s instanceof me){const c=new me(s.seconds,1e3*Math.floor(s.nanoseconds/1e3));return{timestampValue:mo(i.serializer,c)}}if(s instanceof qt)return{geoPointValue:{latitude:s.latitude,longitude:s.longitude}};if(s instanceof At)return{bytesValue:nd(i.serializer,s._byteString)};if(s instanceof ye){const c=i.databaseId,u=s.firestore._databaseId;if(!u.isEqual(c))throw i.createError(`Document reference is for database ${u.projectId}/${u.database} but should be for database ${c.projectId}/${c.database}`);return{referenceValue:jc(s.firestore._databaseId||i.databaseId,s._key.path)}}if(s instanceof lt)return(function(u,h){const f=u instanceof lt?u.toArray():u;return{mapValue:{fields:{[N2]:{stringValue:O2},[Hs]:{arrayValue:{values:f.map((w=>{if(typeof w!="number")throw h.createError("VectorValues must only contain numeric values.");return Mo(h.serializer,w)}))}}}}}})(s,i);if(ud(s))return s._toProto(i.serializer);throw i.createError(`Unsupported field value: ${Do(s)}`)})(n,e,t)}function wd(n,e){const t={};return R2(n)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):jn(n,((r,s)=>{const i=Mn(s,e.childContextForField(r));i!=null&&(t[r]=i)})),{mapValue:{fields:t}}}function Id(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof me||n instanceof qt||n instanceof At||n instanceof ye||n instanceof hi||n instanceof lt||ud(n))}function Yc(n,e,t){if(!Id(t)||!si(t)){const r=Do(t);throw r==="an object"?e.createError(n+" a custom object"):e.createError(n+" "+r)}}function Un(n,e,t){if((e=X(e))instanceof li)return e._internalPath;if(typeof e=="string")return Td(n,e);throw _o("Field path arguments must be of type string or ",n,!1,void 0,t)}const J4=new RegExp("[~\\*/\\[\\]]");function Td(n,e,t){if(e.search(J4)>=0)throw _o(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,t);try{return new li(...e.split("."))._internalPath}catch{throw _o(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,t)}}function _o(n,e,t,r,s){const i=r&&!r.isEmpty(),o=s!==void 0;let c=`Function ${e}() called with invalid data`;t&&(c+=" (via `toFirestore()`)"),c+=". ";let u="";return(i||o)&&(u+=" (found",i&&(u+=` in field ${r}`),o&&(u+=` in document ${s}`),u+=")"),new F(D.INVALID_ARGUMENT,c+n+u)}function Ad(n,e){return n.some((t=>t.isEqual(e)))}function Rd(n){return typeof n._readUserData=="function"}/**
 * @license
 * Copyright 2025 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ze{constructor(e){this.optionDefinitions=e}_getKnownOptions(e,t){const r=st.empty();for(const s in this.optionDefinitions)if(this.optionDefinitions.hasOwnProperty(s)){const i=this.optionDefinitions[s];if(s in e){const o=e[s];let c;i.nestedOptions&&si(o)?c={mapValue:{fields:new Ze(i.nestedOptions).getOptionsProto(t,o)}}:o&&(c=Mn(o,t)??void 0),c&&r.set(Me.fromServerFormat(i.serverName),c)}}return r}getOptionsProto(e,t,r){const s=this._getKnownOptions(t,e);if(r){const i=new Map(C7(r,((o,c)=>[Me.fromServerFormat(c),o!==void 0?Mn(o,e):null])));s.setAll(i)}return s.value.mapValue.fields??{}}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Z4(n){return typeof n=="object"&&n!==null&&!!("nullValue"in n&&(n.nullValue===null||n.nullValue==="NULL_VALUE")||"booleanValue"in n&&(n.booleanValue===null||typeof n.booleanValue=="boolean")||"integerValue"in n&&(n.integerValue===null||typeof n.integerValue=="number"||typeof n.integerValue=="string")||"doubleValue"in n&&(n.doubleValue===null||typeof n.doubleValue=="number")||"timestampValue"in n&&(n.timestampValue===null||(function(t){return typeof t=="object"&&t!==null&&"seconds"in t&&(t.seconds===null||typeof t.seconds=="number"||typeof t.seconds=="string")&&"nanos"in t&&(t.nanos===null||typeof t.nanos=="number")})(n.timestampValue))||"stringValue"in n&&(n.stringValue===null||typeof n.stringValue=="string")||"bytesValue"in n&&(n.bytesValue===null||n.bytesValue instanceof Uint8Array)||"referenceValue"in n&&(n.referenceValue===null||typeof n.referenceValue=="string")||"geoPointValue"in n&&(n.geoPointValue===null||(function(t){return typeof t=="object"&&t!==null&&"latitude"in t&&(t.latitude===null||typeof t.latitude=="number")&&"longitude"in t&&(t.longitude===null||typeof t.longitude=="number")})(n.geoPointValue))||"arrayValue"in n&&(n.arrayValue===null||(function(t){return typeof t=="object"&&t!==null&&!(!("values"in t)||t.values!==null&&!Array.isArray(t.values))})(n.arrayValue))||"mapValue"in n&&(n.mapValue===null||(function(t){return typeof t=="object"&&t!==null&&!(!("fields"in t)||t.fields!==null&&!si(t.fields))})(n.mapValue))||"fieldReferenceValue"in n&&(n.fieldReferenceValue===null||typeof n.fieldReferenceValue=="string")||"functionValue"in n&&(n.functionValue===null||(function(t){return typeof t=="object"&&t!==null&&!(!("name"in t)||t.name!==null&&typeof t.name!="string"||!("args"in t)||t.args!==null&&!Array.isArray(t.args))})(n.functionValue))||"pipelineValue"in n&&(n.pipelineValue===null||(function(t){return typeof t=="object"&&t!==null&&!(!("stages"in t)||t.stages!==null&&!Array.isArray(t.stages))})(n.pipelineValue)))}function fE(){return new zc("serverTimestamp")}function pE(n){return new Kc("increment",n)}function em(n){return new lt(n)}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wt{constructor(e){this.optionsProto=void 0,{rawOptions:this.rawOptions,...this.knownOptions}=e}_readUserData(e){this.optionsProto=this._optionsUtil.getOptionsProto(e,this.knownOptions,this.rawOptions)}_toProto(e){return{name:this._name,options:this.optionsProto}}}class bd extends wt{get _name(){return"add_fields"}get _optionsUtil(){return new Ze({})}constructor(e,t){super(t),this.fields=e}_toProto(e){return{...super._toProto(e),args:[Ks(e,this.fields)]}}_readUserData(e){super._readUserData(e),Bn(this.fields,e)}}class Nd extends wt{get _name(){return"aggregate"}get _optionsUtil(){return new Ze({})}constructor(e,t,r){super(r),this.groups=e,this.accumulators=t}_toProto(e){return{...super._toProto(e),args:[Ks(e,this.accumulators),Ks(e,this.groups)]}}_readUserData(e){super._readUserData(e),Bn(this.groups,e),Bn(this.accumulators,e)}}class Od extends wt{get _name(){return"distinct"}get _optionsUtil(){return new Ze({})}constructor(e,t){super(t),this.groups=e}_toProto(e){return{...super._toProto(e),args:[Ks(e,this.groups)]}}_readUserData(e){super._readUserData(e),Bn(this.groups,e)}}class zo extends wt{get _name(){return"collection"}get _optionsUtil(){return new Ze({forceIndex:{serverName:"force_index"}})}constructor(e,t){super(t),this.Vr=e.startsWith("/")?e:"/"+e}_toProto(e){return{...super._toProto(e),args:[{referenceValue:this.Vr}]}}_readUserData(e){super._readUserData(e)}}class Ko extends wt{get _name(){return"collection_group"}get _optionsUtil(){return new Ze({forceIndex:{serverName:"force_index"}})}constructor(e,t){super(t),this.collectionId=e}_toProto(e){return{...super._toProto(e),args:[{referenceValue:""},{stringValue:this.collectionId}]}}_readUserData(e){super._readUserData(e)}}class Xc extends wt{get _name(){return"database"}get _optionsUtil(){return new Ze({})}_toProto(e){return{...super._toProto(e)}}_readUserData(e){super._readUserData(e)}}class Jc extends wt{get _name(){return"documents"}get _optionsUtil(){return new Ze({})}constructor(e,t){if(super(t),!e||e.length===0)throw new F(D.INVALID_ARGUMENT,"Empty document paths are not allowed in DocumentsSource");const r=e.map((i=>i.startsWith("/")?i:"/"+i)),s=new Set(r);if(s.size!==r.length)throw new F(D.INVALID_ARGUMENT,"Duplicate document paths are not allowed in DocumentsSource");this.dr=r,this.mr=s}_toProto(e){return{...super._toProto(e),args:this.dr.map((t=>({referenceValue:t})))}}_readUserData(e){super._readUserData(e)}}class Yo extends wt{get _name(){return"where"}get _optionsUtil(){return new Ze({})}constructor(e,t){super(t),this.condition=e}_toProto(e){return{...super._toProto(e),args:[this.condition._toProto(e)]}}_readUserData(e){super._readUserData(e),Bn(this.condition,e)}}class ur extends wt{get _name(){return"limit"}get _optionsUtil(){return new Ze({})}constructor(e,t){q(!isNaN(e)&&e!==1/0&&e!==-1/0,34860),super(t),this.limit=e}_toProto(e){return{...super._toProto(e),args:[Uo(e,this.limit)]}}}class ch extends wt{get _name(){return"offset"}get _optionsUtil(){return new Ze({})}constructor(e,t){super(t),this.offset=e}_toProto(e){return{...super._toProto(e),args:[Uo(e,this.offset)]}}}class um extends wt{get _name(){return"select"}get _optionsUtil(){return new Ze({})}constructor(e,t){super(t),this.selections=e}_toProto(e){return{...super._toProto(e),args:[Ks(e,this.selections)]}}_readUserData(e){super._readUserData(e),Bn(this.selections,e)}}class Jt extends wt{get _name(){return"sort"}get _optionsUtil(){return new Ze({})}constructor(e,t){super(t),this.orderings=e}_toProto(e){return{...super._toProto(e),args:this.orderings.map((t=>t._toProto(e)))}}_readUserData(e){super._readUserData(e),Bn(this.orderings,e)}}class Zc extends wt{get _name(){return"replace_with"}get _optionsUtil(){return new Ze({})}constructor(e,t){super(t),this.map=e}_toProto(e){return{...super._toProto(e),args:[this.map._toProto(e),ld(Zc.pr)]}}_readUserData(e){super._readUserData(e),Bn(this.map,e)}}Zc.pr="full_replace";function Bn(n,e){return Rd(n)?n._readUserData(e):Array.isArray(n)?n.forEach((t=>t._readUserData(e))):n instanceof Map?n.forEach((t=>t._readUserData(e))):Object.values(n).forEach((t=>t._readUserData(e))),n}// Copyright 2024 Google LLC* @license
class rt{constructor(e,t,r){this.serializer=e,this.stages=t,this.listenOptions=r,this.isCorePipeline=!0}getPipelineCollection(){return Qo(this)}getPipelineCollectionGroup(){return eu(this)}getPipelineCollectionId(){return lm(this)}getPipelineDocuments(){return Ic(this)}getPipelineFlavor(){return(function(t){let r="exact";return t.stages.forEach(((s,i)=>{s._name!==Od.name&&s._name!==Nd.name||(r="keyless"),s._name===um.name&&r==="exact"&&(r="augmented"),s._name===bd.name&&i<t.stages.length-1&&r==="exact"&&(r="augmented")})),r})(this)}getPipelineSourceType(){return bn(this)}}function bn(n){const e=n.stages[0];return e instanceof zo||e instanceof Ko||e instanceof Xc||e instanceof Jc?e._name:"unknown"}function Qo(n){if(bn(n)==="collection")return n.stages[0].Vr}function eu(n){if(bn(n)==="collection_group")return n.stages[0].collectionId}function lm(n){switch(bn(n)){case"collection":return de.fromString(Qo(n)).lastSegment();case"collection_group":return eu(n);default:return}}function Ic(n){if(bn(n)==="documents")return n.stages[0].dr}class Os{constructor(e,t,r,s){this._db=e,this.userDataReader=t,this._userDataWriter=r,this.stages=s}wr(e,t){const r=this.userDataReader.createContext(3,e);return Rd(t)?t._readUserData(r):Array.isArray(t)?t.forEach((s=>s._readUserData(r))):t.forEach((s=>s._readUserData(r))),t}where(e){const t=this.stages.map((r=>r));return this.wr("where",e),t.push(new Yo(e,{})),new Os(this._db,this.userDataReader,this._userDataWriter,t)}limit(e){const t=this.stages.map((r=>r));return t.push(new ur(e,{})),new Os(this._db,this.userDataReader,this._userDataWriter,t)}sort(e,...t){const r=this.stages.map((s=>s));return"orderings"in e?r.push(new Jt(this.wr("sort",e.orderings),{})):r.push(new Jt(this.wr("sort",[e,...t]),{})),new Os(this._db,this.userDataReader,this._userDataWriter,r)}br(e){return{pipeline:{stages:this.stages.map((t=>t._toProto(e)))}}}}// Copyright 2024 Google LLC* @license
class T{constructor(e,t){this.type=e,this.value=t}static vr(){return new T("ERROR",void 0)}static Sr(){return new T("UNSET",void 0)}static Dr(){return new T("NULL",Vr)}static newValue(e){return Et(e)?new T("NULL",Vr):(function(r){return!!r&&"booleanValue"in r})(e)?new T("BOOLEAN",e):Ut(e)?new T("INT",e):er(e)?new T("DOUBLE",e):(function(r){return!!r&&"timestampValue"in r&&!!r.timestampValue})(e)?new T("TIMESTAMP",e):(function(r){return!!r&&"stringValue"in r})(e)?new T("STRING",e):(function(r){return!!r&&"bytesValue"in r})(e)?new T("BYTES",e):e.referenceValue?new T("REFERENCE",e):e.geoPointValue?new T("GEO_POINT",e):xr(e)?new T("ARRAY",e):uo(e)?new T("VECTOR",e):tr(e)?new T("MAP",e):new T("ERROR",void 0)}Cr(){return this.type==="ERROR"||this.type==="UNSET"}Fr(){return this.type==="NULL"}}function ks(n){if(!n.Cr())return n.value}function kd(n){return n instanceof Fn?n._expr:n}function K(n){if((n=kd(n))instanceof jr)return new hm(n);if(n instanceof Gr)return new dm(n);if(n instanceof Is)return new fm(n);if(n instanceof k){if(n.name==="add")return new gm(n);if(n.name==="subtract")return new _m(n);if(n.name==="multiply")return new Em(n);if(n.name==="divide")return new ym(n);if(n.name==="mod")return new wm(n);if(n.name==="and")return new Im(n);if(n.name==="equal")return new Dm(n);if(n.name==="not_equal")return new Vm(n);if(n.name==="less_than")return new Lm(n);if(n.name==="less_than_or_equal")return new xm(n);if(n.name==="greater_than")return new Mm(n);if(n.name==="greater_than_or_equal")return new Um(n);if(n.name==="array_concat")return new Fm(n);if(n.name==="array_reverse")return new Bm(n);if(n.name==="array_contains")return new $m(n);if(n.name==="array_contains_all")return new Hm(n);if(n.name==="array_contains_any")return new qm(n);if(n.name==="array_length")return new jm(n);if(n.name==="array_element")return new Gm(n);if(n.name==="equal_any")return new Dd(n);if(n.name==="not_equal_any")return new Am(n);if(n.name==="is_nan")return new Rm(n);if(n.name==="is_not_nan")return new vm(n);if(n.name==="is_null")return new Cm(n);if(n.name==="is_not_null")return new Sm(n);if(n.name==="is_error")return new Pm(n);if(n.name==="exists")return new bm(n);if(n.name==="not")return new Xo(n);if(n.name==="or")return new Tm(n);if(n.name==="xor")return new tu(n);if(n.name==="conditional")return new Nm(n);if(n.name==="maximum")return new Om(n);if(n.name==="minimum")return new km(n);if(n.name==="reverse")return new Wm(n);if(n.name==="replace_first")return new zm(n);if(n.name==="replace_all")return new Km(n);if(n.name==="char_length")return new Ym(n);if(n.name==="byte_length")return new Qm(n);if(n.name==="like")return new Xm(n);if(n.name==="regex_contains")return new Jm(n);if(n.name==="regex_match")return new Zm(n);if(n.name==="string_contains")return new eg(n);if(n.name==="starts_with")return new tg(n);if(n.name==="ends_with")return new ng(n);if(n.name==="to_lower")return new rg(n);if(n.name==="to_upper")return new sg(n);if(n.name==="trim")return new ig(n);if(n.name==="string_concat")return new og(n);if(n.name==="map_get")return new ag(n);if(n.name==="cosine_distance")return new cg(n);if(n.name==="dot_product")return new ug(n);if(n.name==="euclidean_distance")return new lg(n);if(n.name==="vector_length")return new hg(n);if(n.name==="unix_micros_to_timestamp")return new gg(n);if(n.name==="timestamp_to_unix_micros")return new yg(n);if(n.name==="unix_millis_to_timestamp")return new _g(n);if(n.name==="timestamp_to_unix_millis")return new wg(n);if(n.name==="unix_seconds_to_timestamp")return new Eg(n);if(n.name==="timestamp_to_unix_seconds")return new Ig(n);if(n.name==="timestamp_add")return new Tg(n);if(n.name==="timestamp_subtract")return new Ag(n)}throw new Error(`Unknown Expr : ${n}`)}class hm{constructor(e){this.expr=e}evaluate(e,t){if(this.expr.fieldName===Mt)return T.newValue({referenceValue:go(e.serializer,t.key)});if(this.expr.fieldName==="__update_time__")return T.newValue({timestampValue:Ji(e.serializer,t.version)});if(this.expr.fieldName==="__create_time__")return T.newValue({timestampValue:Ji(e.serializer,t.createTime)});const r=t.data.field(this.expr._fieldPath);return r?xo(r)?T.newValue((function(i,o){if(i.serverTimestampBehavior==="estimate")return{timestampValue:Ji(i.serializer,Q.fromTimestamp(Dr(o)))};if(i.serverTimestampBehavior==="previous"){const c=oi(o);if(c)return c}return{nullValue:"NULL_VALUE"}})(e,r)):T.newValue(r):T.Sr()}}class dm{constructor(e){this.expr=e}evaluate(e,t){return T.newValue(this.expr._getValue())}}class fm{constructor(e){this.expr=e}evaluate(e,t){const r=this.expr.Rr.map((s=>K(s).evaluate(e,t)));return r.some((s=>s.Cr()))?T.vr():T.newValue({arrayValue:{values:r.map((s=>s.value))}})}}function We(n){return er(n)?Number(n.doubleValue):Number(n.integerValue)}function jt(n){return BigInt(n.integerValue)}const pm=BigInt("0x7fffffffffffffff"),mm=-BigInt("0x8000000000000000");class fi{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length>=2,24778);const r=K(this.expr.params[0]).evaluate(e,t),s=K(this.expr.params[1]).evaluate(e,t);let i=this.Or(r,s);for(const o of this.expr.params.slice(2)){const c=K(o).evaluate(e,t);i=this.Or(i,c)}return i}Or(e,t){if(e.Cr()||t.Cr())return T.vr();if(e.Fr()||t.Fr())return T.Dr();const r=e.value,s=t.value;if(!er(r)&&!Ut(r)||!er(s)&&!Ut(s))return T.vr();if(er(r)||er(s)){const i=this.Mr(r,s);return i?T.newValue(i):T.vr()}if(Ut(r)&&Ut(s)){const i=this.Nr(r,s);return i===void 0?T.vr():typeof i=="number"?T.newValue({doubleValue:i}):i<mm||i>pm?T.vr():T.newValue({integerValue:`${i}`})}return T.vr()}}function cn(n,e){return De(n)!==De(e)?"TYPE_MISMATCH":pt(n)||pt(e)?"NOT_EQ":Et(n)&&Et(e)?"EQ":Et(n)||Et(e)?"NULL":xr(n)&&xr(e)?(function(r,s){if(r.values?.length!==s.values?.length)return"NOT_EQ";let i=!1;for(let o=0;o<(r.values?.length??0);o++){const c=r.values[o],u=s.values[o];switch(cn(c,u)){case"EQ":break;case"NOT_EQ":case"TYPE_MISMATCH":return"NOT_EQ";case"NULL":i=!0;break;default:W(44609,{Lr:c,Br:u})}}return i?"NULL":"EQ"})(n.arrayValue,e.arrayValue):uo(n)&&uo(e)||tr(n)&&tr(e)?(function(r,s){const i=r.fields||{},o=s.fields||{};if(co(i)!==co(o))return"NOT_EQ";let c=!1;for(const u in i)if(i.hasOwnProperty(u)){if(o[u]===void 0)return"NOT_EQ";switch(cn(i[u],o[u])){case"NOT_EQ":case"TYPE_MISMATCH":return"NOT_EQ";case"NULL":c=!0}}return c?"NULL":"EQ"})(n.mapValue,e.mapValue):(function(r,s){return Pt(r,s,{Te:!1,Ee:!0,he:!0})})(n,e)?"EQ":"NOT_EQ"}class gm extends fi{Nr(e,t){return jt(e)+jt(t)}Mr(e,t){return{doubleValue:We(e)+We(t)}}}class _m extends fi{constructor(e){super(e),this.expr=e}Nr(e,t){return jt(e)-jt(t)}Mr(e,t){return{doubleValue:We(e)-We(t)}}}class Em extends fi{constructor(e){super(e),this.expr=e}Nr(e,t){return jt(e)*jt(t)}Mr(e,t){return{doubleValue:We(e)*We(t)}}}class ym extends fi{constructor(e){super(e),this.expr=e}Nr(e,t){const r=jt(t);if(r!==BigInt(0))return jt(e)/r}Mr(e,t){const r=We(t);return r===0?{doubleValue:Bs(r)?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY}:{doubleValue:We(e)/r}}}class wm extends fi{constructor(e){super(e),this.expr=e}Nr(e,t){const r=jt(t);if(r!==BigInt(0))return jt(e)%r}Mr(e,t){const r=We(t);if(r!==0)return{doubleValue:We(e)%r}}}class Im{constructor(e){this.expr=e}evaluate(e,t){let r=!1,s=!1;for(const i of this.expr.params){const o=K(i).evaluate(e,t);switch(o.type){case"BOOLEAN":if(!o.value?.booleanValue)return T.newValue(qe);break;case"NULL":s=!0;break;default:r=!0}}return r?T.vr():s?T.Dr():T.newValue(dt)}}class Xo{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===1,9634);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"BOOLEAN":return T.newValue({booleanValue:!r.value?.booleanValue});case"NULL":return T.Dr();default:return T.vr()}}}class Tm{constructor(e){this.expr=e}evaluate(e,t){let r=!1,s=!1;for(const i of this.expr.params){const o=K(i).evaluate(e,t);switch(o.type){case"BOOLEAN":if(o.value?.booleanValue)return T.newValue(dt);break;case"NULL":s=!0;break;default:r=!0}}return r?T.vr():s?T.Dr():T.newValue(qe)}}class tu{constructor(e){this.expr=e}evaluate(e,t){let r=!1,s=!1;for(const i of this.expr.params){const o=K(i).evaluate(e,t);switch(o.type){case"BOOLEAN":r=tu.xor(r,!!o.value?.booleanValue);break;case"NULL":s=!0;break;default:return T.vr()}}return s?T.Dr():T.newValue({booleanValue:r})}static xor(e,t){return(e||t)&&!(e&&t)}}class Dd{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===2,55094);let r=!1;const s=K(this.expr.params[0]).evaluate(e,t);switch(s.type){case"NULL":r=!0;break;case"ERROR":case"UNSET":return T.vr()}const i=K(this.expr.params[1]).evaluate(e,t);switch(i.type){case"ARRAY":break;case"NULL":r=!0;break;default:return T.vr()}if(r)return T.Dr();for(const o of i.value?.arrayValue?.values??[])switch(Et(s.value)&&Et(o)?"EQ":cn(s.value,o)){case"EQ":return T.newValue(dt);case"NOT_EQ":case"TYPE_MISMATCH":break;case"NULL":r=!0;break;default:W(44608,{value:s.value,candidate:o})}return r?T.Dr():T.newValue(qe)}}class Am{constructor(e){this.expr=e}evaluate(e,t){return new Xo(new k("not",[new k("equal_any",this.expr.params)])).evaluate(e,t)}}class Rm{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===1,23322);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"INT":return T.newValue(qe);case"DOUBLE":return T.newValue({booleanValue:isNaN(We(r.value))});case"NULL":return T.Dr();default:return T.vr()}}}class vm{constructor(e){this.expr=e}evaluate(e,t){return q(this.expr.params.length===1,50406),new Xo(new k("not",[new k("is_nan",this.expr.params)])).evaluate(e,t)}}class Cm{constructor(e){this.expr=e}evaluate(e,t){switch(q(this.expr.params.length===1,23123),K(this.expr.params[0]).evaluate(e,t).type){case"NULL":return T.newValue(dt);case"UNSET":case"ERROR":return T.vr();default:return T.newValue(qe)}}}class Sm{constructor(e){this.expr=e}evaluate(e,t){return q(this.expr.params.length===1,23167),new Xo(new k("not",[new k("is_null",this.expr.params)])).evaluate(e,t)}}class Pm{constructor(e){this.expr=e}evaluate(e,t){return q(this.expr.params.length===1,5228),K(this.expr.params[0]).evaluate(e,t).type==="ERROR"?T.newValue(dt):T.newValue(qe)}}class bm{constructor(e){this.expr=e}evaluate(e,t){switch(q(this.expr.params.length===1,6877),K(this.expr.params[0]).evaluate(e,t).type){case"ERROR":return T.vr();case"UNSET":return T.newValue(qe);default:return T.newValue(dt)}}}class Nm{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===3,11706);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"BOOLEAN":return r.value?.booleanValue?K(this.expr.params[1]).evaluate(e,t):K(this.expr.params[2]).evaluate(e,t);case"NULL":return K(this.expr.params[2]).evaluate(e,t);default:return T.vr()}}}class Om{constructor(e){this.expr=e}evaluate(e,t){const r=this.expr.params.map((i=>K(i).evaluate(e,t)));let s;for(const i of r)switch(i.type){case"ERROR":case"UNSET":case"NULL":continue;default:s=s===void 0||ft(i.value,s.value)>0?i:s}return s===void 0?T.Dr():s}}class km{constructor(e){this.expr=e}evaluate(e,t){const r=this.expr.params.map((i=>K(i).evaluate(e,t)));let s;for(const i of r)switch(i.type){case"ERROR":case"UNSET":case"NULL":continue;default:s=s===void 0||ft(i.value,s.value)<0?i:s}return s===void 0?T.Dr():s}}class Wr{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===2,31033,`${this.expr.name}() function should have exactly 2 params`);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"ERROR":case"UNSET":return T.vr()}const s=K(this.expr.params[1]).evaluate(e,t);switch(s.type){case"ERROR":case"UNSET":return T.vr()}return this.Ur(r,s)}}class Dm extends Wr{constructor(e){super(e),this.expr=e}Ur(e,t){if(e.Fr()&&t.Fr())return T.newValue(dt);if(e.Fr()||t.Fr()||pt(e.value)||pt(t.value)||De(e.value)!==De(t.value))return T.newValue(qe);switch(cn(e.value,t.value)){case"EQ":return T.newValue(dt);case"NOT_EQ":return T.newValue(qe);case"NULL":return T.Dr();default:W(44615,{left:e,right:t})}}}class Vm extends Wr{constructor(e){super(e),this.expr=e}Ur(e,t){switch(cn(e.value,t.value)){case"EQ":return T.newValue(qe);case"NOT_EQ":case"TYPE_MISMATCH":return T.newValue(dt);case"NULL":return T.Dr();default:W(44614,{left:e,right:t})}}}class Lm extends Wr{constructor(e){super(e),this.expr=e}Ur(e,t){return De(e.value)!==De(t.value)||pt(e.value)||pt(t.value)?T.newValue(qe):T.newValue({booleanValue:ft(e.value,t.value)<0})}}class xm extends Wr{constructor(e){super(e),this.expr=e}Ur(e,t){return De(e.value)!==De(t.value)||pt(e.value)||pt(t.value)?T.newValue(qe):cn(e.value,t.value)==="EQ"?T.newValue(dt):T.newValue({booleanValue:ft(e.value,t.value)<0})}}class Mm extends Wr{constructor(e){super(e),this.expr=e}Ur(e,t){return De(e.value)!==De(t.value)||pt(e.value)||pt(t.value)?T.newValue(qe):T.newValue({booleanValue:ft(e.value,t.value)>0})}}class Um extends Wr{constructor(e){super(e),this.expr=e}Ur(e,t){return De(e.value)!==De(t.value)||pt(e.value)||pt(t.value)?T.newValue(qe):cn(e.value,t.value)==="EQ"?T.newValue(dt):T.newValue({booleanValue:ft(e.value,t.value)>0})}}class Fm{constructor(e){this.expr=e}evaluate(e,t){throw new Error("Unimplemented")}}class Bm{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===1,216);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"NULL":return T.Dr();case"ARRAY":{const s=r.value.arrayValue?.values??[];return T.newValue({arrayValue:{values:[...s].reverse()}})}default:return T.vr()}}}class $m{constructor(e){this.expr=e}evaluate(e,t){return q(this.expr.params.length===2,52884),new Dd(new k("eq_any",[this.expr.params[1],this.expr.params[0]])).evaluate(e,t)}}class Hm{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===2,1392);let r=!1;const s=K(this.expr.params[0]).evaluate(e,t);switch(s.type){case"ARRAY":break;case"NULL":r=!0;break;default:return T.vr()}const i=K(this.expr.params[1]).evaluate(e,t);switch(i.type){case"ARRAY":break;case"NULL":r=!0;break;default:return T.vr()}if(r)return T.Dr();const o=i.value?.arrayValue?.values??[],c=s.value?.arrayValue?.values??[];for(const u of o){let h=!1;r=!1;for(const f of c){switch(Et(u)&&Et(f)?"EQ":cn(u,f)){case"EQ":h=!0;break;case"NOT_EQ":case"TYPE_MISMATCH":break;case"NULL":r=!0;break;default:W(44613,{value:f,search:u})}if(h)break}if(!h)return T.newValue(qe)}return T.newValue(dt)}}class qm{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===2,2680);let r=!1;const s=K(this.expr.params[0]).evaluate(e,t);switch(s.type){case"ARRAY":break;case"NULL":r=!0;break;default:return T.vr()}const i=K(this.expr.params[1]).evaluate(e,t);switch(i.type){case"ARRAY":break;case"NULL":r=!0;break;default:return T.vr()}if(r)return T.Dr();const o=i.value?.arrayValue?.values??[],c=s.value?.arrayValue?.values??[];for(const u of c)for(const h of o)switch(Et(u)&&Et(h)?"EQ":cn(u,h)){case"EQ":return T.newValue(dt);case"NOT_EQ":case"TYPE_MISMATCH":break;case"NULL":r=!0;break;default:W(44608,{value:u,search:h})}return r?T.Dr():T.newValue(qe)}}class jm{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===1,38605);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"NULL":return T.Dr();case"ARRAY":return T.newValue({integerValue:`${r.value?.arrayValue?.values?.length??0}`});default:return T.vr()}}}class Gm{constructor(e){this.expr=e}evaluate(e,t){throw new Error("Unimplemented")}}class Wm{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===1,1508);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"NULL":return T.Dr();case"BYTES":{const s=r.value?.bytesValue;if(typeof s=="string"){const i=ke.fromBase64String(s).toUint8Array();return i.reverse(),T.newValue({bytesValue:ke.fromUint8Array(i).toBase64()})}return T.newValue({bytesValue:new Uint8Array(s).reverse()})}case"STRING":{const s=r.value?.stringValue,i=new Intl.__PRIVATE_Segmenter(void 0,{granularity:"grapheme"}).segment(s),o=Array.from(i,(c=>c.segment)).reverse();return T.newValue({stringValue:o.join("")})}default:return T.vr()}}}class zm{constructor(e){this.expr=e}evaluate(e,t){throw new Error("Unimplemented")}}class Km{constructor(e){this.expr=e}evaluate(e,t){throw new Error("Unimplemented")}}class Ym{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===1,19400);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"NULL":return T.Dr();case"STRING":{const s=(function(o){let c=0;for(let u=0;u<o.length;u++){const h=o.codePointAt(u);if(h===void 0)return;if(h<=65535)if(h>=55296&&h<=57343)if(h<=56319){const f=o.codePointAt(u+1);f!==void 0&&f>=56320&&f<=57343?(c+=1,u++):c+=1}else c+=1;else c+=1;else{if(!(h<=1114111))return;c+=1,u++}}return c})(r.value.stringValue);return s===void 0?T.vr():T.newValue({integerValue:s})}default:return T.vr()}}}class Qm{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===1,8486);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"BYTES":{const s=r.value?.bytesValue;return typeof s=="string"?T.newValue({integerValue:ke.fromBase64String(s).toUint8Array().length}):T.newValue({integerValue:new Uint8Array(s).length})}case"STRING":{const s=(function(o){let c=0;for(let u=0;u<o.length;u++){const h=o.codePointAt(u);if(h===void 0)return;if(h>=55296&&h<=57343){if(!(h<=56319))return;{const f=o.codePointAt(u+1);if(f===void 0||!(f>=56320&&f<=57343))return;c+=4,u++}}else if(h<=127)c+=1;else if(h<=2047)c+=2;else if(h<=65535)c+=3;else{if(!(h<=1114111))return;c+=4,u++}}return c})(r.value?.stringValue);return s===void 0?T.vr():T.newValue({integerValue:s})}case"NULL":return T.Dr();default:return T.vr()}}}class zr{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===2,39773,`${this.expr.name}() function should have exactly two parameters`);let r=!1;const s=K(this.expr.params[0]).evaluate(e,t);switch(s.type){case"STRING":break;case"NULL":r=!0;break;default:return T.vr()}const i=K(this.expr.params[1]).evaluate(e,t);switch(i.type){case"STRING":break;case"NULL":r=!0;break;default:return T.vr()}return r?T.Dr():this.kr(s.value?.stringValue,i.value?.stringValue)}}class Xm extends zr{kr(e,t){try{const r=(function(o){let c="";for(let u=0;u<o.length;u++){const h=o.charAt(u);switch(h){case"_":c+=".";break;case"%":c+=".*";break;case"\\":case".":case"*":case"?":case"+":case"^":case"$":case"|":case"(":case")":case"[":case"]":case"{":case"}":c+="\\"+h;break;default:c+=h}}return"^"+c+"$"})(t),s=Tt.compile(r);return T.newValue({booleanValue:s.matches(e)})}catch(r){return kt(`Invalid LIKE pattern converted to regex: ${t}, returning error. Error: ${r}`),T.vr()}}}class Jm extends zr{kr(e,t){try{const r=Tt.compile(t);return T.newValue({booleanValue:r.matcher(e).find()})}catch{return kt(`Invalid regex pattern found in regex_contains: ${t}, returning error`),T.vr()}}}class Zm extends zr{kr(e,t){try{return T.newValue({booleanValue:Tt.compile(t).matches(e)})}catch{return kt(`Invalid regex pattern found in regex_match: ${t}, returning error`),T.vr()}}}class eg extends zr{kr(e,t){return T.newValue({booleanValue:e.includes(t)})}}class tg extends zr{kr(e,t){return T.newValue({booleanValue:e.startsWith(t)})}}class ng extends zr{kr(e,t){return T.newValue({booleanValue:e.endsWith(t)})}}class rg{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===1,29079);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"STRING":return T.newValue({stringValue:r.value?.stringValue?.toLowerCase()});case"NULL":return T.Dr();default:return T.vr()}}}class sg{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===1,60487);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"STRING":return T.newValue({stringValue:r.value?.stringValue?.toUpperCase()});case"NULL":return T.Dr();default:return T.vr()}}}class ig{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===1,28544);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"STRING":return T.newValue({stringValue:r.value?.stringValue?.trim()});case"NULL":return T.Dr();default:return T.vr()}}}class og{constructor(e){this.expr=e}evaluate(e,t){const r=this.expr.params.map((o=>K(o).evaluate(e,t)));let s="",i=!1;for(const o of r)switch(o.type){case"STRING":s+=o.value.stringValue;break;case"NULL":i=!0;break;default:return T.vr()}return i?T.Dr():T.newValue({stringValue:s})}}class ag{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===2,4483);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"UNSET":return T.Sr();case"MAP":break;default:return T.vr()}const s=K(this.expr.params[1]).evaluate(e,t);if(s.type!=="STRING")return T.vr();const i=r.value?.mapValue?.fields?.[s.value?.stringValue];return i===void 0?T.Sr():T.newValue(i)}}class nu{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===2,25231,`${this.expr.name}() function should have exactly 2 params`);let r=!1;const s=K(this.expr.params[0]).evaluate(e,t);switch(s.type){case"VECTOR":break;case"NULL":r=!0;break;default:return T.vr()}const i=K(this.expr.params[1]).evaluate(e,t);switch(i.type){case"VECTOR":break;case"NULL":r=!0;break;default:return T.vr()}if(r)return T.Dr();const o=fc(s.value),c=fc(i.value);if(o===void 0||c===void 0||o.values?.length!==c.values?.length)return T.vr();const u=this.qr(o,c);return u===void 0||isNaN(u)?T.vr():T.newValue({doubleValue:u})}}class cg extends nu{qr(e,t){const r=e?.values??[],s=t?.values??[];if(r.length===0)return;let i=0,o=0,c=0;for(let h=0;h<r.length;h++){if(!xn(r[h])||!xn(s[h]))return;const f=We(r[h]),p=We(s[h]);i+=f*p,o+=f*f,c+=p*p}const u=Math.sqrt(o)*Math.sqrt(c);if(u!==0)return 1-Math.max(-1,Math.min(1,i/u))}}class ug extends nu{qr(e,t){const r=e?.values??[],s=t?.values??[];if(r.length===0)return 0;let i=0;for(let o=0;o<r.length;o++){if(!xn(r[o])||!xn(s[o]))return;i+=We(r[o])*We(s[o])}return i}}class lg extends nu{qr(e,t){const r=e?.values??[],s=t?.values??[];if(r.length===0)return 0;let i=0;for(let o=0;o<r.length;o++){if(!xn(r[o])||!xn(s[o]))return;const c=We(r[o]),u=We(s[o]);i+=Math.pow(c-u,2)}return Math.sqrt(i)}}class hg{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===1,39044);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"VECTOR":{const s=fc(r.value);return T.newValue({integerValue:s?.values?.length??0})}case"NULL":return T.Dr();default:return T.vr()}}}const Qs=BigInt(-62135596800),Xs=BigInt(253402300799),Eo=BigInt(1e3),Nn=BigInt(1e6),dg=Qs*Eo,fg=Xs*Eo+BigInt(999),pg=Qs*Nn,mg=Xs*Nn+BigInt(999999);function ru(n){return n>=pg&&n<=mg}function Vd(n){return n>=Qs&&n<=Xs}function Js(n,e){const t=BigInt(n);return!(t<Qs||t>Xs)&&!(e<0||e>=1e9)&&(t!==Qs||e===0)&&!(t===Xs&&e>999999999)}function Ld(n,e){return e<0?{seconds:n-1,nanos:e+1e9}:{seconds:n,nanos:e}}function su(n){return BigInt(n.seconds)*Nn+BigInt(Math.trunc(n.nanoseconds/1e3))}class iu{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===1,49262,`${this.expr.name}() function should have exactly one parameter`);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"INT":return this.toTimestamp(BigInt(r.value.integerValue));case"NULL":return T.Dr();default:return T.vr()}}}class gg extends iu{toTimestamp(e){if(!ru(e))return T.vr();let t=Number(e/Nn),r=Number(e%Nn*BigInt(1e3));const s=Ld(t,r);return t=s.seconds,r=s.nanos,Js(t,r)?T.newValue({timestampValue:{seconds:t,nanos:r}}):T.vr()}}class _g extends iu{toTimestamp(e){if(!(function(o){return o>=dg&&o<=fg})(e))return T.vr();let t=Number(e/Eo),r=Number(e%Eo*BigInt(1e6));const s=Ld(t,r);return t=s.seconds,r=s.nanos,Js(t,r)?T.newValue({timestampValue:{seconds:t,nanos:r}}):T.vr()}}class Eg extends iu{toTimestamp(e){if(!Vd(e))return T.vr();const t=Number(e);return T.newValue({timestampValue:{seconds:t,nanos:0}})}}class ou{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===1,1265,`${this.expr.name}() function should have exactly one parameter`);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"TIMESTAMP":break;case"NULL":return T.Dr();default:return T.vr()}const s=qc(r.value.timestampValue);return Js(s.seconds,s.nanoseconds)?this.$r(s):T.vr()}}class yg extends ou{$r(e){const t=su(e);return ru(t)?T.newValue({integerValue:`${t.toString()}`}):T.vr()}}class wg extends ou{$r(e){const t=su(e),r=t/BigInt(1e3),s=t%BigInt(1e3);return r>BigInt(0)||s===BigInt(0)?T.newValue({integerValue:r.toString()}):T.newValue({integerValue:(r-BigInt(1)).toString()})}}class Ig extends ou{$r(e){const t=BigInt(e.seconds);return Vd(t)?T.newValue({integerValue:t.toString()}):T.vr()}}class xd{constructor(e){this.expr=e}evaluate(e,t){q(this.expr.params.length===3,2775,`${this.expr.name}() function should have exactly 3 parameters`);let r=!1;const s=K(this.expr.params[0]).evaluate(e,t);switch(s.type){case"TIMESTAMP":break;case"NULL":r=!0;break;default:return T.vr()}const i=K(this.expr.params[1]).evaluate(e,t);let o;switch(i.type){case"STRING":if(o=(function(te){switch(te){case"microsecond":return"microsecond";case"millisecond":return"millisecond";case"second":return"second";case"minute":return"minute";case"hour":return"hour";case"day":return"day";default:return}})(i.value.stringValue),o===void 0)return T.vr();break;case"NULL":r=!0;break;default:return T.vr()}const c=K(this.expr.params[2]).evaluate(e,t);switch(c.type){case"INT":break;case"NULL":r=!0;break;default:return T.vr()}if(r)return T.Dr();const u=BigInt(c.value.integerValue);let h;try{switch(o){case"microsecond":h=u;break;case"millisecond":h=u*BigInt(1e3);break;case"second":h=u*BigInt(1e6);break;case"minute":h=u*BigInt(6e7);break;case"hour":h=u*BigInt(36e8);break;case"day":h=u*BigInt(864e8);break;default:return T.vr()}if(o!=="microsecond"&&u!==BigInt(0)&&h/u!==BigInt(this.Kr(o)))return T.vr()}catch(z){return kt(`Error during timestamp arithmetic: ${z}`),T.vr()}const f=qc(s.value.timestampValue);if(!Js(f.seconds,f.nanoseconds))return T.vr();const p=su(f),w=this.Wr(p,h);if(!ru(w))return T.vr();const b=Number(w/Nn),P=w%Nn,L=Number((P<0?P+Nn:P)*BigInt(1e3)),x=P<0?b-1:b;return Js(x,L)?T.newValue({timestampValue:{seconds:x,nanos:L}}):T.vr()}Kr(e){switch(e){case"millisecond":return 1e3;case"second":return 1e6;case"minute":return 6e7;case"hour":return 36e8;case"day":return 864e8;default:return 1}}}class Tg extends xd{Wr(e,t){return e+t}}class Ag extends xd{Wr(e,t){return e-t}}function Zs(n){if((n=kd(n))instanceof jr)return`fld(${n.fieldName})`;if(n instanceof Gr)return`cst(${(function(t){return t===null?"null":typeof t=="number"?t.toString():typeof t=="string"?`"${t}"`:t instanceof ye?`ref(${t.path})`:t instanceof lt?`vec(${JSON.stringify(t)})`:JSON.stringify(t)})(n.value)})`;if(n instanceof k)return`fn(${n.name},[${n.params.map(Zs).join(",")}])`;if(n.expressionType==="ListOfExpressions")return`list([${n.Rr.map(Zs).join(",")}])`;throw new Error(`Unrecognized expr ${JSON.stringify(n,null,2)}`)}function Rg(n){if(n instanceof bd)return`${n._name}(${qi(n.fields)})`;if(n instanceof Nd){let e=`${n._name}(${qi(n.accumulators)})`;return n.groups.size>0&&(e+=`grouping(${qi(n.groups)})`),e}if(n instanceof Od)return`${n._name}(${qi(n.groups)})`;if(n instanceof zo)return`${n._name}(${n.Vr})`;if(n instanceof Ko)return`${n._name}(${n.collectionId})`;if(n instanceof Xc)return`${n._name}()`;if(n instanceof Jc)return`${n._name}(${n.dr.sort()})`;if(n instanceof Yo)return`${n._name}(${Zs(n.condition)})`;if(n instanceof ur)return`${n._name}(${n.limit})`;if(n instanceof Jt)return`${n._name}(${(function(t){return t.map((r=>`${Zs(r.expr)}${r.direction}`)).join(",")})(n.orderings)})`;throw new Error(`Unrecognized stage ${n._name}`)}function qi(n){return`${Array.from(n.entries()).sort().map((([e,t])=>`${e}=${Zs(t)}`)).join(",")}`}function rn(n){return n.stages.map((e=>Rg(e))).join("|")}function Md(n,e){return rn(n)===rn(e)}function Ue(n){return n instanceof rt}function uh(n){return Ue(n)?rn(n):bs(n)}function Ud(n){return Ue(n)?rn(n):(function(t){return`${W2($t(t))}|lt:${t.limitType}`})(n)}function Jo(n,e){return n instanceof rt&&e instanceof rt?Md(n,e):!(n instanceof rt&&!(e instanceof rt)||!(n instanceof rt)&&e instanceof rt)&&Z7(n,e)}function Fd(n){return Zn(n)?rn(n):W2(n)}function Bd(n,e){return n instanceof rt&&e instanceof rt?Md(n,e):!(n instanceof rt&&!(e instanceof rt)||!(n instanceof rt)&&e instanceof rt)&&z2(n,e)}function vg(n,e){const t=(function(s){let i=!1;const o=[];for(const c of s)if(c instanceof Jt)if(i=!0,c.orderings.some((u=>u.expr instanceof jr&&u.expr.fieldName===Mt)))o.push(c);else{const u=c.orderings.map((h=>h));u.push(Zi(Mt).ascending()),o.push(new Jt(u,{}))}else c instanceof ur&&(i||(o.push(new Jt([Zi(Mt).ascending()],{})),i=!0)),o.push(c);return i||o.push(new Jt([Zi(Mt).ascending()],{})),o})(n.stages);if(n.userDataReader){const r=n.userDataReader.createContext(3,"toCorePipeline");t.forEach((s=>s._readUserData(r)))}return new rt(n.userDataReader.serializer,t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cg{constructor(e,t,r,s){this.batchId=e,this.localWriteTime=t,this.baseMutations=r,this.mutations=s}applyToRemoteDocument(e,t){const r=t.mutationResults;for(let s=0;s<this.mutations.length;s++){const i=this.mutations[s];i.key.isEqual(e.key)&&x7(i,e,r[s])}}applyToLocalView(e,t){for(const r of this.baseMutations)r.key.isEqual(e.key)&&(t=Ss(r,e,t,this.localWriteTime));for(const r of this.mutations)r.key.isEqual(e.key)&&(t=Ss(r,e,t,this.localWriteTime));return t}applyToLocalDocumentSet(e,t){const r=Z2();return this.mutations.forEach((s=>{const i=e.get(s.key),o=i.overlayedDocument;let c=this.applyToLocalView(o,i.mutatedFields);c=t.has(s.key)?null:c;const u=U2(o,c);u!==null&&r.set(s.key,u),o.isValidDocument()||o.convertToNoDocument(Q.min())})),r}keys(){return this.mutations.reduce(((e,t)=>e.add(t.key)),ne())}isEqual(e){return this.batchId===e.batchId&&kr(this.mutations,e.mutations,((t,r)=>$l(t,r)))&&kr(this.baseMutations,e.baseMutations,((t,r)=>$l(t,r)))}}class au{constructor(e,t,r,s){this.batch=e,this.commitVersion=t,this.mutationResults=r,this.docVersions=s}static from(e,t,r){q(e.mutations.length===r.length,58842,{Qr:e.mutations.length,Gr:r.length});let s=(function(){return s4})();const i=e.mutations;for(let o=0;o<i.length;o++)s=s.insert(i[o].key,r[o].version);return new au(e,t,r,s)}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pg{constructor(e){this.zr=e}}function bg(n){const e=I4({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?gc(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ng{constructor(){this.Hi=new Og}addToCollectionParentIndex(e,t){return this.Hi.add(t),V.resolve()}getCollectionParents(e,t){return V.resolve(this.Hi.getEntries(t))}addFieldIndex(e,t){return V.resolve()}deleteFieldIndex(e,t){return V.resolve()}deleteAllFieldIndexes(e){return V.resolve()}createTargetIndexes(e,t){return V.resolve()}getDocumentsMatchingTarget(e,t){return V.resolve(null)}getIndexType(e,t){return V.resolve(0)}getFieldIndexes(e,t){return V.resolve([])}getNextCollectionGroupToUpdate(e){return V.resolve(null)}getMinOffset(e,t){return V.resolve(Dn.min())}getMinOffsetFromCollectionGroup(e,t){return V.resolve(Dn.min())}updateCollectionGroup(e,t,r){return V.resolve()}updateIndexEntries(e,t){return V.resolve()}}class Og{constructor(){this.index={}}add(e){const t=e.lastSegment(),r=e.popLast(),s=this.index[t]||new Oe(de.comparator),i=!s.has(r);return this.index[t]=s.add(r),i}has(e){const t=e.lastSegment(),r=e.popLast(),s=this.index[t];return s&&s.has(r)}getEntries(e){return(this.index[e]||new Oe(de.comparator)).toArray()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
function $d(n,e){let t=e;for(const r of n.stages)t=Dg({serializer:n.serializer,serverTimestampBehavior:n.listenOptions?.serverTimestampBehavior},r,t);return t}function Zo(n,e){return $d(n,[e]).length>0}function kg(n,e){return Ue(n)?Zo(n,e):qo(n,e)}function Dg(n,e,t){if(e instanceof zo)return(function(s,i,o){return o.filter((c=>c.isFoundDocument()&&`/${c.key.getCollectionPath().canonicalString()}`===i.Vr))})(0,e,t);if(e instanceof Yo)return(function(s,i,o){return o.filter((c=>{const u=ks(K(i.condition).evaluate(s,c));return u!==void 0&&Pt(u,dt)}))})(n,e,t);if(e instanceof Ko)return(function(s,i,o){return o.filter((c=>c.isFoundDocument()&&c.key.getCollectionPath().lastSegment()===i.collectionId))})(0,e,t);if(e instanceof Xc)return(function(s,i,o){return o.filter((c=>c.isFoundDocument()))})(0,0,t);if(e instanceof Jc)return(function(s,i,o){return o.filter((c=>c.isFoundDocument()&&i.mr.has(c.key.path.toStringWithLeadingSlash())))})(0,e,t);if(e instanceof ur)return(function(s,i,o){return o.slice(0,i.limit)})(0,e,t);if(e instanceof Jt)return(function(s,i,o){const c=i.orderings.map((u=>({ks:K(u.expr),direction:u.direction})));return[...o].sort(((u,h)=>{for(const{ks:f,direction:p}of c){const w=ks(f.evaluate(s,u)),b=ks(f.evaluate(s,h)),P=ft(w??Vr,b??Vr);if(P!==0)return p==="ascending"?P:-P}return 0}))})(n,e,t);throw new Error(`Unknown stage: ${e._name}`)}function Tc(n){const e=(function(r){for(let s=r.stages.length-1;s>=0;s--){const i=r.stages[s];if(i instanceof Jt)return i.orderings}throw new Error("Pipeline must contain at least one Sort stage")})(n);return(t,r)=>{for(const s of e){const i=ks(K(s.expr).evaluate({serializer:n.serializer},t)),o=ks(K(s.expr).evaluate({serializer:n.serializer},r)),c=ft(i||Vr,o||Vr);if(c!==0)return s.direction==="ascending"?c:-c}return 0}}function za(n){for(let e=n.stages.length-1;e>=0;e--){const t=n.stages[e];if(t instanceof ur)return{limit:t.limit}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mg{constructor(e){this.serializer=e,this.Hs=new Map,this.Js=new Map}getBundleMetadata(e,t){return V.resolve(this.Hs.get(t))}saveBundleMetadata(e,t){return this.Hs.set(t.id,(function(s){return{id:s.id,version:s.version,createTime:Ht(s.createTime)}})(t)),V.resolve()}getNamedQuery(e,t){return V.resolve(this.Js.get(t))}saveNamedQuery(e,t){return this.Js.set(t.name,(function(s){return{name:s.name,query:bg(s.bundledQuery),readTime:Ht(s.readTime)}})(t)),V.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ug{constructor(){this.overlays=new ge(j.comparator),this.Ys=new Map}getOverlay(e,t){return V.resolve(this.overlays.get(t))}getOverlays(e,t){const r=Tn();return V.forEach(t,(s=>this.getOverlay(e,s).next((i=>{i!==null&&r.set(s,i)})))).next((()=>r))}getAllOverlays(e,t){const r=Tn();return this.overlays.forEach(((s,i)=>{i.largestBatchId>t&&r.set(s,i)})),V.resolve(r)}saveOverlays(e,t,r){return r.forEach(((s,i)=>{this.Hr(e,t,i)})),V.resolve()}removeOverlaysForBatchId(e,t,r){const s=this.Ys.get(r);return s!==void 0&&(s.forEach((i=>this.overlays=this.overlays.remove(i))),this.Ys.delete(r)),V.resolve()}getOverlaysForCollection(e,t,r){const s=Tn(),i=t.length+1,o=new j(t.child("")),c=this.overlays.getIteratorFrom(o);for(;c.hasNext();){const u=c.getNext().value,h=u.getKey();if(!t.isPrefixOf(h.path))break;h.path.length===i&&u.largestBatchId>r&&s.set(u.getKey(),u)}return V.resolve(s)}getOverlaysForCollectionGroup(e,t,r,s){let i=new ge(((h,f)=>h-f));const o=this.overlays.getIterator();for(;o.hasNext();){const h=o.getNext().value;if(h.getKey().getCollectionGroup()===t&&h.largestBatchId>r){let f=i.get(h.largestBatchId);f===null&&(f=Tn(),i=i.insert(h.largestBatchId,f)),f.set(h.getKey(),h)}}const c=Tn(),u=i.getIterator();for(;u.hasNext()&&(u.getNext().value.forEach(((h,f)=>c.set(h,f))),!(c.size()>=s)););return V.resolve(c)}Hr(e,t,r){const s=this.overlays.get(r.key);if(s!==null){const o=this.Ys.get(s.largestBatchId).delete(r.key);this.Ys.set(s.largestBatchId,o)}this.overlays=this.overlays.insert(r.key,new Sg(t,r));let i=this.Ys.get(t);i===void 0&&(i=ne(),this.Ys.set(t,i)),this.Ys.set(t,i.add(r.key))}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fg{constructor(){this.sessionToken=ke.EMPTY_BYTE_STRING}getSessionToken(e){return V.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,V.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hd{constructor(e,t){this.d_={},this.overlays={},this.f_=new Vo(0),this.m_=!1,this.m_=!0,this.p_=new Fg,this.referenceDelegate=e(this),this.g_=new qg(this),this.indexManager=new Ng,this.remoteDocumentCache=(function(s){return new $g(s)})((r=>this.referenceDelegate.y_(r))),this.serializer=new Pg(t),this.w_=new Mg(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.m_=!1,Promise.resolve()}get started(){return this.m_}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new Ug,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let r=this.d_[e.toKey()];return r||(r=new Bg(t,this.referenceDelegate),this.d_[e.toKey()]=r),r}getGlobalsCache(){return this.p_}getTargetCache(){return this.g_}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.w_}runTransaction(e,t,r){H("MemoryPersistence","Starting transaction:",e);const s=new jg(this.f_.next());return this.referenceDelegate.b_(),r(s).next((i=>this.referenceDelegate.v_(s).next((()=>i)))).toPromise().then((i=>(s.raiseOnCommittedEvent(),i)))}S_(e,t){return V.or(Object.values(this.d_).map((r=>()=>r.containsKey(e,t))))}}class jg extends w7{constructor(e){super(),this.currentSequenceNumber=e}}class uu{constructor(e){this.persistence=e,this.D_=new cu,this.x_=null}static C_(e){return new uu(e)}get F_(){if(this.x_)return this.x_;throw W(60996)}addReference(e,t,r){return this.D_.addReference(r,t),this.F_.delete(r.toString()),V.resolve()}removeReference(e,t,r){return this.D_.removeReference(r,t),this.F_.add(r.toString()),V.resolve()}markPotentiallyOrphaned(e,t){return this.F_.add(t.toString()),V.resolve()}removeTarget(e,t){this.D_.s_(t.targetId).forEach((s=>this.F_.add(s.toString())));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,t.targetId).next((s=>{s.forEach((i=>this.F_.add(i.toString())))})).next((()=>r.removeTargetData(e,t)))}b_(){this.x_=new Set}v_(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return V.forEach(this.F_,(r=>{const s=j.fromPath(r);return this.O_(e,s).next((i=>{i||t.removeEntry(s,Q.min())}))})).next((()=>(this.x_=null,t.apply(e))))}updateLimboDocument(e,t){return this.O_(e,t).next((r=>{r?this.F_.delete(t.toString()):this.F_.add(t.toString())}))}y_(e){return 0}O_(e,t){return V.or([()=>V.resolve(this.D_.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.S_(e,t)])}}class yo{constructor(e,t){this.persistence=e,this.M_=new pr((r=>R7(r.path)),((r,s)=>r.isEqual(s))),this.garbageCollector=G4(this,t)}static C_(e,t){return new yo(e,t)}b_(){}v_(e){return V.resolve()}forEachTarget(e,t){return this.persistence.getTargetCache().forEachTarget(e,t)}lr(e){const t=this.Ls(e);return this.persistence.getTargetCache().getTargetCount(e).next((r=>t.next((s=>r+s))))}Ls(e){let t=0;return this.Er(e,(r=>{t++})).next((()=>t))}Er(e,t){return V.forEach(this.M_,((r,s)=>this.Us(e,r,s).next((i=>i?V.resolve():t(s)))))}removeTargets(e,t,r){return this.persistence.getTargetCache().removeTargets(e,t,r)}removeOrphanedDocuments(e,t){let r=0;const s=this.persistence.getRemoteDocumentCache(),i=s.newChangeBuffer();return s.P_(e,(o=>this.Us(e,o,t).next((c=>{c||(r++,i.removeEntry(o,Q.min()))})))).next((()=>i.apply(e))).next((()=>r))}markPotentiallyOrphaned(e,t){return this.M_.set(t,e.currentSequenceNumber),V.resolve()}removeTarget(e,t){const r=t.withSequenceNumber(e.currentSequenceNumber);return this.persistence.getTargetCache().updateTargetData(e,r)}addReference(e,t,r){return this.M_.set(r,e.currentSequenceNumber),V.resolve()}removeReference(e,t,r){return this.M_.set(r,e.currentSequenceNumber),V.resolve()}updateLimboDocument(e,t){return this.M_.set(t,e.currentSequenceNumber),V.resolve()}y_(e){let t=e.key.toString().length;return e.isFoundDocument()&&(t+=Yi(e.data.value)),t}Us(e,t,r){return V.or([()=>this.persistence.S_(e,t),()=>this.persistence.getTargetCache().containsKey(e,t),()=>{const s=this.M_.get(t);return V.resolve(s!==void 0&&s>r)}])}getCacheSize(e){return this.persistence.getRemoteDocumentCache().getSize(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gg(n,e){return j.comparator(n.key,e.key)}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zg{constructor(){this.So=!1,this.Do=!1,this.xo=100,this.Co=(function(){return Sp()?8:I7(Je())>0?6:4})()}initialize(e,t){this.Fo=e,this.indexManager=t,this.So=!0}getDocumentsMatchingQuery(e,t,r,s){const i={result:null};return this.Oo(e,t).next((o=>{i.result=o})).next((()=>{if(!i.result)return this.Mo(e,t,s,r).next((o=>{i.result=o}))})).next((()=>{if(i.result)return;const o=new Wg;return this.No(e,t,o).next((c=>{if(i.result=c,this.Do)return this.Lo(e,t,o,c.size)}))})).next((()=>i.result))}Lo(e,t,r,s){return Ue(t)?V.resolve():r.documentReadCount<this.xo?(wr()<=oe.DEBUG&&H("QueryEngine","SDK will not create cache indexes for query:",bs(t),"since it only creates cache indexes for collection contains","more than or equal to",this.xo,"documents"),V.resolve()):(wr()<=oe.DEBUG&&H("QueryEngine","Query:",bs(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Co*s?(wr()<=oe.DEBUG&&H("QueryEngine","The SDK decides to create cache indexes for query:",bs(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,$t(t))):V.resolve())}Oo(e,t){if(Ue(t))return V.resolve(null);let r=t;if(zl(r))return V.resolve(null);let s=$t(r);return this.indexManager.getIndexType(e,s).next((i=>i===0?null:(r.limit!==null&&i===1&&(r=gc(r,null,"F"),s=$t(r)),this.indexManager.getDocumentsMatchingTarget(e,s).next((o=>{const c=ne(...o);return this.Fo.getDocuments(e,c).next((u=>this.indexManager.getMinOffset(e,s).next((h=>{const f=this.Bo(r,u);return this.Uo(r,f,c,h.readTime)?this.Oo(e,gc(r,null,"F")):this.ko(e,f,r,h)}))))})))))}Mo(e,t,r,s){return(Ue(t)?(function(o){for(const c of o.stages){if(c instanceof ur||c instanceof ch)return!1;if(c instanceof Yo){if(c.condition instanceof Cd&&c.condition._expr.name==="exists"&&c.condition._expr.params[0]instanceof jr&&c.condition._expr.params[0].fieldName===Mt)continue;return!1}}return!0})(t):zl(t))||s.isEqual(Q.min())?V.resolve(null):this.Fo.getDocuments(e,r).next((i=>{const o=this.Bo(t,i);return this.Uo(t,o,r,s)?V.resolve(null):(wr()<=oe.DEBUG&&H("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),uh(t)),this.ko(e,o,t,g7(s,Fs)).next((c=>c)))}))}Bo(e,t){let r,s;return Ue(e)?(r=new Oe(Gg),s=i=>Zo(e,i)):(r=new Oe($c(e)),s=i=>qo(e,i)),t.forEach(((i,o)=>{s(o)&&(r=r.add(o))})),r}Uo(e,t,r,s){if(Ue(e))return(function(c){return c.stages.some((u=>u instanceof ur||u instanceof ch))})(e);if(e.limit===null)return!1;if(r.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}No(e,t,r){return wr()<=oe.DEBUG&&H("QueryEngine","Using full collection scan to execute query:",uh(t)),this.Fo.getDocumentsMatchingQuery(e,t,Dn.min(),r)}ko(e,t,r,s){return this.Fo.getDocumentsMatchingQuery(e,r,s).next((i=>(t.forEach((o=>{i=i.insert(o.key,o)})),i)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hu="LocalStore",Kg=3e8;class Yg{constructor(e,t,r,s){this.persistence=e,this.qo=t,this.serializer=s,this.$o=new ge(ie),this.Ko=new pr((i=>Fd(i)),Bd),this.Wo=new Map,this.Qo=e.getRemoteDocumentCache(),this.g_=e.getTargetCache(),this.w_=e.getBundleCache(),this.Go(r)}Go(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new xg(this.Qo,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.Qo.setIndexManager(this.indexManager),this.qo.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",(t=>e.collect(t,this.$o)))}}function Qg(n,e,t,r){return new Yg(n,e,t,r)}async function qd(n,e){const t=J(n);return await t.persistence.runTransaction("Handle user change","readonly",(r=>{let s;return t.mutationQueue.getAllMutationBatches(r).next((i=>(s=i,t.Go(e),t.mutationQueue.getAllMutationBatches(r)))).next((i=>{const o=[],c=[];let u=ne();for(const h of s){o.push(h.batchId);for(const f of h.mutations)u=u.add(f.key)}for(const h of i){c.push(h.batchId);for(const f of h.mutations)u=u.add(f.key)}return t.localDocuments.getDocuments(r,u).next((h=>({zo:h,removedBatchIds:o,addedBatchIds:c})))}))}))}function Xg(n,e){const t=J(n);return t.persistence.runTransaction("Acknowledge batch","readwrite-primary",(r=>{const s=e.batch.keys(),i=t.Qo.newChangeBuffer({trackRemovals:!0});return(function(c,u,h,f){const p=h.batch,w=p.keys();let b=V.resolve();return w.forEach((P=>{b=b.next((()=>f.getEntry(u,P))).next((L=>{const x=h.docVersions.get(P);q(x!==null,48541),L.version.compareTo(x)<0&&(p.applyToRemoteDocument(L,h),L.isValidDocument()&&(L.setReadTime(h.commitVersion),f.addEntry(L)))}))})),b.next((()=>c.mutationQueue.removeMutationBatch(u,p)))})(t,r,e,i).next((()=>i.apply(r))).next((()=>t.mutationQueue.performConsistencyCheck(r))).next((()=>t.documentOverlayCache.removeOverlaysForBatchId(r,s,e.batch.batchId))).next((()=>t.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(r,(function(c){let u=ne();for(let h=0;h<c.mutationResults.length;++h)c.mutationResults[h].transformResults.length>0&&(u=u.add(c.batch.mutations[h].key));return u})(e)))).next((()=>t.localDocuments.getDocuments(r,s)))}))}function jd(n){const e=J(n);return e.persistence.runTransaction("Get last remote snapshot version","readonly",(t=>e.g_.getLastRemoteSnapshotVersion(t)))}function Jg(n,e){const t=J(n),r=e.snapshotVersion;let s=t.$o;return t.persistence.runTransaction("Apply remote event","readwrite-primary",(i=>{const o=t.Qo.newChangeBuffer({trackRemovals:!0});s=t.$o;const c=[];e.targetChanges.forEach(((f,p)=>{const w=s.get(p);if(!w)return;c.push(t.g_.removeMatchingKeys(i,f.removedDocuments,p).next((()=>t.g_.addMatchingKeys(i,f.addedDocuments,p))));let b=w.withSequenceNumber(i.currentSequenceNumber);e.targetMismatches.get(p)!==null?b=b.withResumeToken(ke.EMPTY_BYTE_STRING,Q.min()).withLastLimboFreeSnapshotVersion(Q.min()):f.resumeToken.approximateByteSize()>0&&(b=b.withResumeToken(f.resumeToken,r)),s=s.insert(p,b),(function(L,x,z){return L.resumeToken.approximateByteSize()===0||x.snapshotVersion.toMicroseconds()-L.snapshotVersion.toMicroseconds()>=Kg?!0:z.addedDocuments.size+z.modifiedDocuments.size+z.removedDocuments.size>0})(w,b,f)&&c.push(t.g_.updateTargetData(i,b))}));let u=ut(),h=ne();if(e.documentUpdates.forEach((f=>{e.resolvedLimboDocuments.has(f)&&c.push(t.persistence.referenceDelegate.updateLimboDocument(i,f))})),c.push(Zg(i,o,e.documentUpdates).next((f=>{u=f.jo,h=f.Ho}))),!r.isEqual(Q.min())){const f=t.g_.getLastRemoteSnapshotVersion(i).next((p=>t.g_.setTargetsMetadata(i,i.currentSequenceNumber,r)));c.push(f)}return V.waitFor(c).next((()=>o.apply(i))).next((()=>t.localDocuments.getLocalViewOfDocuments(i,u,h))).next((()=>u))})).then((i=>(t.$o=s,i)))}function Zg(n,e,t){let r=ne(),s=ne();return t.forEach((i=>r=r.add(i))),e.getEntries(n,r).next((i=>{let o=ut();return t.forEach(((c,u)=>{const h=i.get(c);u.isFoundDocument()!==h.isFoundDocument()&&(s=s.add(c)),u.isNoDocument()&&u.version.isEqual(Q.min())?(e.removeEntry(c,u.readTime),o=o.insert(c,u)):!h.isValidDocument()||u.version.compareTo(h.version)>0||u.version.compareTo(h.version)===0&&h.hasPendingWrites?(e.addEntry(u),o=o.insert(c,u)):H(hu,"Ignoring outdated watch update for ",c,". Current version:",h.version," Watch version:",u.version)})),{jo:o,Ho:s}}))}function e3(n,e){const t=J(n);return t.persistence.runTransaction("Get next mutation batch","readonly",(r=>(e===void 0&&(e=Uc),t.mutationQueue.getNextMutationBatchAfterBatchId(r,e))))}function t3(n,e){const t=J(n);return t.persistence.runTransaction("Allocate target","readwrite",(r=>{let s;return t.g_.getTargetData(r,e).next((i=>i?(s=i,V.resolve(s)):t.g_.allocateTargetId(r).next((o=>(s=new Zt(e,o,"TargetPurposeListen",r.currentSequenceNumber),t.g_.addTargetData(r,s).next((()=>s)))))))})).then((r=>{const s=t.$o.get(r.targetId);return(s===null||r.snapshotVersion.compareTo(s.snapshotVersion)>0)&&(t.$o=t.$o.insert(r.targetId,r),t.Ko.set(e,r.targetId)),r}))}async function Ac(n,e,t){const r=J(n),s=r.$o.get(e),i=t?"readwrite":"readwrite-primary";try{t||await r.persistence.runTransaction("Release target",i,(o=>r.persistence.referenceDelegate.removeTarget(o,s)))}catch(o){if(!Hr(o))throw o;H(hu,`Failed to update sequence numbers for target ${e}: ${o}`)}r.$o=r.$o.remove(e),r.Ko.delete(s.target)}function lh(n,e,t){const r=J(n);let s=Q.min(),i=ne();return r.persistence.runTransaction("Execute query","readwrite",(o=>(function(u,h,f){const p=J(u),w=p.Ko.get(f);return w!==void 0?V.resolve(p.$o.get(w)):p.g_.getTargetData(h,f)})(r,o,Ue(e)?e:$t(e)).next((c=>{if(c)return s=c.lastLimboFreeSnapshotVersion,r.g_.getMatchingKeysForTargetId(o,c.targetId).next((u=>{i=u}))})).next((()=>r.qo.getDocumentsMatchingQuery(o,e,t?s:Q.min(),t?i:ne()))).next((c=>(n3(r,c),{documents:c,Jo:i})))))}function n3(n,e){e.forEach(((t,r)=>{const s=r.key.getCollectionGroup(),i=n.Wo.get(s)||Q.min();r.readTime.compareTo(i)>0&&n.Wo.set(s,r.readTime)}))}class hh{constructor(){this.activeTargetIds=a4()}na(e){this.activeTargetIds=this.activeTargetIds.add(e)}ra(e){this.activeTargetIds=this.activeTargetIds.delete(e)}ta(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class r3{constructor(){this.Ua=new hh,this.ka={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,t,r){}addLocalQueryTarget(e,t=!0){return t&&this.Ua.na(e),this.ka[e]||"not-current"}updateQueryState(e,t,r){this.ka[e]=t}removeLocalQueryTarget(e){this.Ua.ra(e)}isLocalQueryTarget(e){return this.Ua.activeTargetIds.has(e)}clearQueryState(e){delete this.ka[e]}getAllActiveQueryTargets(){return this.Ua.activeTargetIds}isActiveQueryTarget(e){return this.Ua.activeTargetIds.has(e)}start(){return this.Ua=new hh,Promise.resolve()}handleUserChange(e,t,r){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}function Ka(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class s3{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.qa=0,this.$a=null,this.Ka=!0}Wa(){this.qa===0&&(this.Qa("Unknown"),this.$a=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,(()=>(this.$a=null,this.Ga("Backend didn't respond within 10 seconds."),this.Qa("Offline"),Promise.resolve()))))}za(e){this.state==="Online"?this.Qa("Unknown"):(this.qa++,this.qa>=1&&(this.ja(),this.Ga(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.Qa("Offline")))}set(e){this.ja(),this.qa=0,e==="Online"&&(this.Ka=!1),this.Qa(e)}Qa(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}Ga(e){const t=`Could not reach Cloud Firestore backend. ${e}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gt="RemoteStore";class i3{constructor(e,t,r,s,i){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.Ha=[],this.Ja=new Map,this.Ya=new Map,this.Za=new Map,this.Xa=new $n(1e3),this.eu=new $n(1001),this.tu=new Set,this.nu=[],this.ru=i,this.ru.bt((o=>{r.enqueueAndForget((async()=>{gr(this)&&(H(Gt,"Restarting streams for network reachability change."),await(async function(u){const h=J(u);h.tu.add(4),await pi(h),h.iu.set("Unknown"),h.tu.delete(4),await ea(h)})(this))}))})),this.iu=new s3(r,s)}}async function ea(n){if(gr(n))for(const e of n.nu)await e(!0)}async function pi(n){for(const e of n.nu)await e(!1)}function Rc(n,e){return n.Ya.get(e)||void 0}function Gd(n,e){const t=J(n),r=Rc(t,e.targetId);if(r!==void 0&&t.Ja.has(r))return;const s=(function(c,u){const h=Rc(c,u);h!==void 0&&c.Za.delete(h);const f=(function(w,b){return b%2!=0?w.eu.next():w.Xa.next()})(c,u);return c.Ya.set(u,f),c.Za.set(f,u),f})(t,e.targetId);H(Gt,"remoteStoreListen mapping SDK target ID to remote",e.targetId,s);const i=new Zt(e.target,s,e.purpose,e.sequenceNumber,e.snapshotVersion,e.lastLimboFreeSnapshotVersion,e.resumeToken);t.Ja.set(s,i),mu(t)?pu(t):Kr(t).Fn()&&fu(t,i)}function du(n,e){const t=J(n),r=Kr(t),s=Rc(t,e);H(Gt,"remoteStoreUnlisten removing mapping of SDK target ID to remote",e,s),t.Ja.delete(s),t.Ya.delete(e),t.Za.delete(s),r.Fn()&&Wd(t,s),t.Ja.size===0&&(r.Fn()?r.Nn():gr(t)&&t.iu.set("Unknown"))}function fu(n,e){if(n.su.We(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(Q.min())>0){const t=n.Za.get(e.targetId);if(t===void 0)return void H(Gt,"SDK target ID not found for remote ID: "+e.targetId);const r=n.remoteSyncer.getRemoteKeysForTarget(t).size;e=e.withExpectedCount(r)}Kr(n).jn(e)}function Wd(n,e){n.su.We(e),Kr(n).Hn(e)}function pu(n){n.su=new l4({getRemoteKeysForTarget:e=>{const t=n.Za.get(e);return t!==void 0?n.remoteSyncer.getRemoteKeysForTarget(t):ne()},dt:e=>n.Ja.get(e)||null,Tt:()=>n.datastore.serializer.databaseId}),Kr(n).start(),n.iu.Wa()}function mu(n){return gr(n)&&!Kr(n).Cn()&&n.Ja.size>0}function gr(n){return J(n).tu.size===0}function zd(n){n.su=void 0}async function o3(n){n.iu.set("Online")}async function a3(n){n.Ja.forEach(((e,t)=>{fu(n,e)}))}async function c3(n,e){zd(n),mu(n)?(n.iu.za(e),pu(n)):n.iu.set("Unknown")}async function u3(n,e,t){if(n.iu.set("Online"),e instanceof td&&e.state===2&&e.cause)try{await(async function(s,i){const o=i.cause;for(const c of i.targetIds){if(s.Ja.has(c)){const u=s.Za.get(c);u!==void 0&&(await s.remoteSyncer.rejectListen(u,o),s.Ya.delete(u),s.Za.delete(c)),s.Ja.delete(c)}s.su.removeTarget(c)}})(n,e)}catch(r){H(Gt,"Failed to remove targets %s: %s ",e.targetIds.join(","),r),await wo(n,r)}else if(e instanceof Xi?n.su.et(e):e instanceof ed?n.su.ot(e):n.su.rt(e),!t.isEqual(Q.min()))try{const r=await jd(n.localStore);t.compareTo(r)>=0&&await(function(i,o){const c=i.su.Rt(o);c.targetChanges.forEach(((h,f)=>{if(h.resumeToken.approximateByteSize()>0){const p=i.Ja.get(f);p&&i.Ja.set(f,p.withResumeToken(h.resumeToken,o))}})),c.targetMismatches.forEach(((h,f)=>{const p=i.Ja.get(h);if(!p)return;i.Ja.set(h,p.withResumeToken(ke.EMPTY_BYTE_STRING,p.snapshotVersion)),Wd(i,h);const w=new Zt(p.target,h,f,p.sequenceNumber);fu(i,w)}));const u=(function(f,p){const w=new Map;p.targetChanges.forEach(((P,L)=>{const x=f.Za.get(L);x!==void 0&&w.set(x,P)}));let b=new ge(ie);return p.targetMismatches.forEach(((P,L)=>{const x=f.Za.get(P);x!==void 0&&(b=b.insert(x,L))})),new ci(p.snapshotVersion,w,b,p.documentUpdates,p.augmentedDocumentUpdates,p.resolvedLimboDocuments)})(i,c);return i.remoteSyncer.applyRemoteEvent(u)})(n,t)}catch(r){H(Gt,"Failed to raise snapshot:",r),await wo(n,r)}}async function wo(n,e,t){if(!Hr(e))throw e;n.tu.add(1),await pi(n),n.iu.set("Offline"),t||(t=()=>jd(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{H(Gt,"Retrying IndexedDB access"),await t(),n.tu.delete(1),await ea(n)}))}function Kd(n,e){return e().catch((t=>wo(n,t,e)))}async function ta(n){const e=J(n),t=Hn(e);let r=e.Ha.length>0?e.Ha[e.Ha.length-1].batchId:Uc;for(;l3(e);)try{const s=await e3(e.localStore,r);if(s===null){e.Ha.length===0&&t.Nn();break}r=s.batchId,h3(e,s)}catch(s){await wo(e,s)}Yd(e)&&Qd(e)}function l3(n){return gr(n)&&n.Ha.length<10}function h3(n,e){n.Ha.push(e);const t=Hn(n);t.Fn()&&t.Jn&&t.Yn(e.mutations)}function Yd(n){return gr(n)&&!Hn(n).Cn()&&n.Ha.length>0}function Qd(n){Hn(n).start()}async function d3(n){Hn(n).er()}async function f3(n){const e=Hn(n);for(const t of n.Ha)e.Yn(t.mutations)}async function p3(n,e,t){const r=n.Ha.shift(),s=au.from(r,e,t);await Kd(n,(()=>n.remoteSyncer.applySuccessfulWrite(s))),await ta(n)}async function m3(n,e){e&&Hn(n).Jn&&await(async function(r,s){if((function(o){return n4(o)&&o!==D.ABORTED})(s.code)){const i=r.Ha.shift();Hn(r).Mn(),await Kd(r,(()=>r.remoteSyncer.rejectFailedWrite(i.batchId,s))),await ta(r)}})(n,e),Yd(n)&&Qd(n)}async function dh(n,e){const t=J(n);t.asyncQueue.verifyOperationInProgress(),H(Gt,"RemoteStore received new credentials");const r=gr(t);t.tu.add(3),await pi(t),r&&t.iu.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.tu.delete(3),await ea(t)}async function g3(n,e){const t=J(n);e?(t.tu.delete(2),await ea(t)):e||(t.tu.add(2),await pi(t),t.iu.set("Unknown"))}function Kr(n){return n._u||(n._u=(function(t,r,s){const i=J(t);return i.nr(),new V4(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(n.datastore,n.asyncQueue,{Qt:o3.bind(null,n),zt:a3.bind(null,n),Ht:c3.bind(null,n),zn:u3.bind(null,n)}),n.nu.push((async e=>{e?(n._u.Mn(),mu(n)?pu(n):n.iu.set("Unknown")):(await n._u.stop(),zd(n))}))),n._u}function Hn(n){return n.ou||(n.ou=(function(t,r,s){const i=J(t);return i.nr(),new L4(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(n.datastore,n.asyncQueue,{Qt:()=>Promise.resolve(),zt:d3.bind(null,n),Ht:m3.bind(null,n),Zn:f3.bind(null,n),Xn:p3.bind(null,n)}),n.nu.push((async e=>{e?(n.ou.Mn(),await ta(n)):(await n.ou.stop(),n.Ha.length>0&&(H(Gt,`Stopping write stream with ${n.Ha.length} pending writes`),n.Ha=[]))}))),n.ou}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xd{constructor(e){this.key=e}}class Jd{constructor(e){this.key=e}}class I3{constructor(e,t){this.query=e,this.Ou=t,this.Mu=null,this.hasCachedResults=!1,this.current=!1,this.Nu=ne(),this.mutatedKeys=ne(),this.Lu=Ue(e)?Tc(e):$c(e),this.Bu=new nr(this.Lu)}get Uu(){return this.Ou}ku(e,t){const r=t?t.qu:new fh,s=t?t.Bu:this.Bu;let i=t?t.mutatedKeys:this.mutatedKeys,o=s,c=!1;const[u,h]=this.$u(this.query,s);e.inorderTraversal(((p,w)=>{const b=s.get(p),P=kg(this.query,w)?w:null,L=!!b&&this.mutatedKeys.has(b.key),x=!!P&&(P.hasLocalMutations||this.mutatedKeys.has(P.key)&&P.hasCommittedMutations);let z=!1;b&&P?b.data.isEqual(P.data)?L!==x&&(r.track({type:3,doc:P}),z=!0):this.Ku(b,P)||(r.track({type:2,doc:P}),z=!0,(u&&this.Lu(P,u)>0||h&&this.Lu(P,h)<0)&&(c=!0)):!b&&P?(r.track({type:0,doc:P}),z=!0):b&&!P&&(r.track({type:1,doc:b}),z=!0,(u||h)&&(c=!0)),z&&(P?(o=o.add(P),i=x?i.add(p):i.delete(p)):(o=o.delete(p),i=i.delete(p)))}));const f=this.Wu(this.query);if(f)if(Ue(this.query)){const p=[];o.forEach((P=>p.push(P)));const w=$d(this.query,p);let b=new nr(Tc(this.query));for(const P of w)b=b.add(P);o.forEach((P=>{b.has(P.key)||(i=i.delete(P.key),r.track({type:1,doc:P}))})),o=b}else{const p=this.Qu(this.query);for(;o.size>f;){const w=p==="F"?o.last():o.first();o=o.delete(w.key),i=i.delete(w.key),r.track({type:1,doc:w})}}return{Bu:o,qu:r,Uo:c,mutatedKeys:i}}Wu(e){return Ue(e)?za(e)?.limit:e.limit||void 0}Qu(e){if(Ue(e)){const t=za(e);return t&&t.limit<0?"L":"F"}return e.limitType}$u(e,t){if(Ue(e)){const r=za(e)?.limit;return[t.size===r?t.last():null,null]}return[e.limitType==="F"&&t.size===this.Wu(this.query)?t.last():null,e.limitType==="L"&&t.size===this.Wu(this.query)?t.first():null]}Ku(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,r,s){const i=this.Bu;this.Bu=e.Bu,this.mutatedKeys=e.mutatedKeys;const o=e.qu.cu();o.sort(((f,p)=>(function(b,P){const L=x=>{switch(x){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return W(20277,{ft:x})}};return L(b)-L(P)})(f.type,p.type)||this.Lu(f.doc,p.doc))),this.Gu(r),s=s??!1;const c=t&&!s?this.zu():[],u=this.Nu.size===0&&this.current&&!s?1:0,h=u!==this.Mu;return this.Mu=u,o.length!==0||h?{snapshot:new Ur(this.query,e.Bu,i,o,e.mutatedKeys,u===0,h,!1,!!r&&r.resumeToken.approximateByteSize()>0),ju:c}:{ju:c}}Ru(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({Bu:this.Bu,qu:new fh,mutatedKeys:this.mutatedKeys,Uo:!1},!1)):{ju:[]}}Hu(e){return!this.Ou.has(e)&&!!this.Bu.has(e)&&!this.Bu.get(e).hasLocalMutations}Gu(e){e&&(e.addedDocuments.forEach((t=>this.Ou=this.Ou.add(t))),e.modifiedDocuments.forEach((t=>{})),e.removedDocuments.forEach((t=>this.Ou=this.Ou.delete(t))),this.current=e.current)}zu(){if(!this.current)return[];const e=this.Nu;this.Nu=ne(),this.Bu.forEach((r=>{this.Hu(r.key)&&(this.Nu=this.Nu.add(r.key))}));const t=[];return e.forEach((r=>{this.Nu.has(r)||t.push(new Jd(r))})),this.Nu.forEach((r=>{e.has(r)||t.push(new Xd(r))})),t}Ju(e){this.Ou=e.Jo,this.Nu=ne();const t=this.ku(e.documents);return this.applyChanges(t,!0)}Yu(){return Ur.fromInitialDocuments(this.query,this.Bu,this.mutatedKeys,this.Mu===0,this.hasCachedResults)}}const Tu="SyncEngine";class T3{constructor(e,t,r){this.query=e,this.targetId=t,this.view=r}}class A3{constructor(e){this.key=e,this.Zu=!1}}class R3{constructor(e,t,r,s,i,o){this.localStore=e,this.remoteStore=t,this.eventManager=r,this.sharedClientState=s,this.currentUser=i,this.maxConcurrentLimboResolutions=o,this.Xu={},this.ec=new pr((c=>Ud(c)),Jo),this.tc=new Map,this.nc=new Set,this.rc=new ge(j.comparator),this.sc=new Map,this._c=new cu,this.oc={},this.ac=new Map,this.uc=$n.Cs(),this.onlineState="Unknown",this.cc=void 0}get isPrimaryClient(){return this.cc===!0}}async function v3(n,e,t=!0){const r=sf(n);let s;const i=r.ec.get(e);return i?(r.sharedClientState.addLocalQueryTarget(i.targetId),s=i.view.Yu()):s=await Zd(r,e,t,!0),s}async function C3(n,e){const t=sf(n);await Zd(t,e,!0,!1)}async function Zd(n,e,t,r){const s=await t3(n.localStore,Ue(e)?e:$t(e)),i=s.targetId,o=n.sharedClientState.addLocalQueryTarget(i,t);let c;return r&&(c=await S3(n,e,i,o==="current",s.resumeToken)),n.isPrimaryClient&&t&&Gd(n.remoteStore,s),c}async function S3(n,e,t,r,s){n.lc=(p,w,b)=>(async function(L,x,z,te){let re=x.view.ku(z);re.Uo&&(re=await lh(L.localStore,x.query,!1).then((({documents:A})=>x.view.ku(A,re))));const he=te&&te.targetChanges.get(x.targetId),Ve=te&&te.targetMismatches.get(x.targetId)!=null,_e=x.view.applyChanges(re,L.isPrimaryClient,he,Ve);return gh(L,x.targetId,_e.ju),_e.snapshot})(n,p,w,b);const i=await lh(n.localStore,e,!0),o=new I3(e,i.Jo),c=o.ku(i.documents),u=ui.createSynthesizedTargetChangeForCurrentChange(t,r&&n.onlineState!=="Offline",s),h=o.applyChanges(c,n.isPrimaryClient,u);gh(n,t,h.ju);const f=new T3(e,t,o);return n.ec.set(e,f),n.tc.has(t)?n.tc.get(t).push(e):n.tc.set(t,[e]),h.snapshot}async function P3(n,e,t){const r=J(n),s=r.ec.get(e),i=r.tc.get(s.targetId);if(i.length>1)return r.tc.set(s.targetId,i.filter((o=>!Jo(o,e)))),void r.ec.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(s.targetId),r.sharedClientState.isActiveQueryTarget(s.targetId)||await Ac(r.localStore,s.targetId,!1).then((()=>{r.sharedClientState.clearQueryState(s.targetId),t&&du(r.remoteStore,s.targetId),Cc(r,s.targetId)})).catch($r)):(Cc(r,s.targetId),await Ac(r.localStore,s.targetId,!0))}async function b3(n,e){const t=J(n),r=t.ec.get(e),s=t.tc.get(r.targetId);t.isPrimaryClient&&s.length===1&&(t.sharedClientState.removeLocalQueryTarget(r.targetId),du(t.remoteStore,r.targetId))}async function N3(n,e,t){const r=M3(n);try{const s=await(function(o,c){const u=J(o),h=me.now(),f=c.reduce(((b,P)=>b.add(P.key)),ne());let p,w;return u.persistence.runTransaction("Locally write mutations","readwrite",(b=>{let P=ut(),L=ne();return u.Qo.getEntries(b,f).next((x=>{P=x,P.forEach(((z,te)=>{te.isValidDocument()||(L=L.add(z))}))})).next((()=>u.localDocuments.getOverlayedDocuments(b,P))).next((x=>{p=x;const z=[];for(const te of c){const re=M7(te,p.get(te.key).overlayedDocument);re!=null&&z.push(new Gn(te.key,re,k2(re.value.mapValue),ot.exists(!0)))}return u.mutationQueue.addMutationBatch(b,h,z,c)})).next((x=>{w=x;const z=x.applyToLocalDocumentSet(p,L);return u.documentOverlayCache.saveOverlays(b,x.batchId,z)}))})).then((()=>({batchId:w.batchId,changes:J2(p)})))})(r.localStore,e);r.sharedClientState.addPendingMutation(s.batchId),(function(o,c,u){let h=o.oc[o.currentUser.toKey()];h||(h=new ge(ie)),h=h.insert(c,u),o.oc[o.currentUser.toKey()]=h})(r,s.batchId,t),await mi(r,s.changes),await ta(r.remoteStore)}catch(s){const i=_u(s,"Failed to persist write");t.reject(i)}}async function ef(n,e){const t=J(n);try{const r=await Jg(t.localStore,e);e.targetChanges.forEach(((s,i)=>{const o=t.sc.get(i);o&&(q(s.addedDocuments.size+s.modifiedDocuments.size+s.removedDocuments.size<=1,22616),s.addedDocuments.size>0?o.Zu=!0:s.modifiedDocuments.size>0?q(o.Zu,14607):s.removedDocuments.size>0&&(q(o.Zu,42227),o.Zu=!1))})),await mi(t,r,e)}catch(r){await $r(r)}}function mh(n,e,t){const r=J(n);if(r.isPrimaryClient&&t===0||!r.isPrimaryClient&&t===1){const s=[];r.ec.forEach(((i,o)=>{const c=o.view.Ru(e);c.snapshot&&s.push(c.snapshot)})),(function(o,c){const u=J(o);u.onlineState=c;let h=!1;u.queries.forEach(((f,p)=>{for(const w of p.Eu)w.Ru(c)&&(h=!0)})),h&&wu(u)})(r.eventManager,e),s.length&&r.Xu.zn(s),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function O3(n,e,t){const r=J(n);r.sharedClientState.updateQueryState(e,"rejected",t);const s=r.sc.get(e),i=s&&s.key;if(i){let o=new ge(j.comparator);o=o.insert(i,Xe.newNoDocument(i,Q.min()));const c=ne().add(i),u=new ci(Q.min(),new Map,new ge(ie),o,ut(),c);await ef(r,u),r.rc=r.rc.remove(i),r.sc.delete(e),Au(r)}else await Ac(r.localStore,e,!1).then((()=>Cc(r,e,t))).catch($r)}async function k3(n,e){const t=J(n),r=e.batch.batchId;try{const s=await Xg(t.localStore,e);nf(t,r,null),tf(t,r),t.sharedClientState.updateMutationState(r,"acknowledged"),await mi(t,s)}catch(s){await $r(s)}}async function D3(n,e,t){const r=J(n);try{const s=await(function(o,c){const u=J(o);return u.persistence.runTransaction("Reject batch","readwrite-primary",(h=>{let f;return u.mutationQueue.lookupMutationBatch(h,c).next((p=>(q(p!==null,37113),f=p.keys(),u.mutationQueue.removeMutationBatch(h,p)))).next((()=>u.mutationQueue.performConsistencyCheck(h))).next((()=>u.documentOverlayCache.removeOverlaysForBatchId(h,f,c))).next((()=>u.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(h,f))).next((()=>u.localDocuments.getDocuments(h,f)))}))})(r.localStore,e);nf(r,e,t),tf(r,e),r.sharedClientState.updateMutationState(e,"rejected",t),await mi(r,s)}catch(s){await $r(s)}}function tf(n,e){(n.ac.get(e)||[]).forEach((t=>{t.resolve()})),n.ac.delete(e)}function nf(n,e,t){const r=J(n);let s=r.oc[r.currentUser.toKey()];if(s){const i=s.get(e);i&&(t?i.reject(t):i.resolve(),s=s.remove(e)),r.oc[r.currentUser.toKey()]=s}}function Cc(n,e,t=null){n.sharedClientState.removeLocalQueryTarget(e);for(const r of n.tc.get(e))n.ec.delete(r),t&&n.Xu.Ec(r,t);n.tc.delete(e),n.isPrimaryClient&&n._c.s_(e).forEach((r=>{n._c.containsKey(r)||rf(n,r)}))}function rf(n,e){n.nc.delete(e.path.canonicalString());const t=n.rc.get(e);t!==null&&(du(n.remoteStore,t),n.rc=n.rc.remove(e),n.sc.delete(t),Au(n))}function gh(n,e,t){for(const r of t)r instanceof Xd?(n._c.addReference(r.key,e),V3(n,r)):r instanceof Jd?(H(Tu,"Document no longer in limbo: "+r.key),n._c.removeReference(r.key,e),n._c.containsKey(r.key)||rf(n,r.key)):W(19791,{hc:r})}function V3(n,e){const t=e.key,r=t.path.canonicalString();n.rc.get(t)||n.nc.has(r)||(H(Tu,"New document in limbo: "+t),n.nc.add(r),Au(n))}function Au(n){for(;n.nc.size>0&&n.rc.size<n.maxConcurrentLimboResolutions;){const e=n.nc.values().next().value;n.nc.delete(e);const t=new j(de.fromString(e)),r=n.uc.next();n.sc.set(r,new A3(t)),n.rc=n.rc.insert(t,r),Gd(n.remoteStore,new Zt($t(Ho(t.path)),r,"TargetPurposeLimboResolution",Vo.ce))}}async function mi(n,e,t){const r=J(n),s=[],i=[],o=[];r.ec.isEmpty()||(r.ec.forEach(((c,u)=>{o.push(r.lc(u,e,t).then((h=>{if((h||t)&&r.isPrimaryClient){const f=h?!h.fromCache:t?.targetChanges.get(u.targetId)?.current;r.sharedClientState.updateQueryState(u.targetId,f?"current":"not-current")}if(h){s.push(h);const f=lu.vo(u.targetId,h);i.push(f)}})))})),await Promise.all(o),r.Xu.zn(s),await(async function(u,h){const f=J(u);try{await f.persistence.runTransaction("notifyLocalViewChanges","readwrite",(p=>V.forEach(h,(w=>V.forEach(w.wo,(b=>f.persistence.referenceDelegate.addReference(p,w.targetId,b))).next((()=>V.forEach(w.bo,(b=>f.persistence.referenceDelegate.removeReference(p,w.targetId,b)))))))))}catch(p){if(!Hr(p))throw p;H(hu,"Failed to update sequence numbers: "+p)}for(const p of h){const w=p.targetId;if(!p.fromCache){const b=f.$o.get(w),P=b.snapshotVersion,L=b.withLastLimboFreeSnapshotVersion(P);f.$o=f.$o.insert(w,L)}}})(r.localStore,i))}async function L3(n,e){const t=J(n);if(!t.currentUser.isEqual(e)){H(Tu,"User change. New user:",e.toKey());const r=await qd(t.localStore,e);t.currentUser=e,(function(i,o){i.ac.forEach((c=>{c.forEach((u=>{u.reject(new F(D.CANCELLED,o))}))})),i.ac.clear()})(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await mi(t,r.zo)}}function x3(n,e){const t=J(n),r=t.sc.get(e);if(r&&r.Zu)return ne().add(r.key);{let s=ne();const i=t.tc.get(e);if(!i)return s;for(const o of i??[]){const c=t.ec.get(o);s=s.unionWith(c.view.Uu)}return s}}function sf(n){const e=J(n);return e.remoteStore.remoteSyncer.applyRemoteEvent=ef.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=x3.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=O3.bind(null,e),e.Xu.zn=y3.bind(null,e.eventManager),e.Xu.Ec=w3.bind(null,e.eventManager),e}function M3(n){const e=J(n);return e.remoteStore.remoteSyncer.applySuccessfulWrite=k3.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=D3.bind(null,e),e}class Io{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=jo(e.databaseInfo.databaseId),this.sharedClientState=this.Rc(e),this.persistence=this.Ic(e),await this.persistence.start(),this.localStore=this.Ac(e),this.gcScheduler=this.Vc(e,this.localStore),this.indexBackfillerScheduler=this.dc(e,this.localStore)}Vc(e,t){return null}dc(e,t){return null}Ac(e){return Qg(this.persistence,new zg,e.initialUser,this.serializer)}Ic(e){return new Hd(uu.C_,this.serializer)}Rc(e){return new r3}async terminate(){this.gcScheduler?.stop(),this.indexBackfillerScheduler?.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Io.provider={build:()=>new Io};class U3 extends Io{constructor(e){super(),this.cacheSizeBytes=e}Vc(e,t){q(this.persistence.referenceDelegate instanceof yo,46915);const r=this.persistence.referenceDelegate.garbageCollector;return new q4(r,e.asyncQueue,t)}Ic(e){const t=this.cacheSizeBytes!==void 0?ct.withCacheSize(this.cacheSizeBytes):ct.DEFAULT;return new Hd((r=>yo.C_(r,t)),this.serializer)}}class Sc{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>mh(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=L3.bind(null,this.syncEngine),await g3(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return(function(){return new E3})()}createDatastore(e){const t=jo(e.databaseInfo.databaseId),r=D4(e.databaseInfo);return U4(e.authCredentials,e.appCheckCredentials,r,t)}createRemoteStore(e){return(function(r,s,i,o,c){return new i3(r,s,i,o,c)})(this.localStore,this.datastore,e.asyncQueue,(t=>mh(this.syncEngine,t,0)),(function(){return eh.C()?new eh:new b4})())}createSyncEngine(e,t){return(function(s,i,o,c,u,h,f){const p=new R3(s,i,o,c,u,h);return f&&(p.cc=!0),p})(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){await(async function(t){const r=J(t);H(Gt,"RemoteStore shutting down."),r.tu.add(5),await pi(r),r.ru.shutdown(),r.iu.set("Unknown")})(this.remoteStore),this.datastore?.terminate(),this.eventManager?.terminate()}}Sc.provider={build:()=>new Sc};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Eh="AsyncQueue";class yh{constructor(e=Promise.resolve()){this.qc=[],this.$c=!1,this.Kc=[],this.Wc=null,this.Qc=!1,this.Gc=!1,this.zc=[],this.xn=new dd(this,"async_queue_retry"),this.jc=()=>{const r=Ka();r&&H(Eh,"Visibility state changed to "+r.visibilityState),this.xn.gn()},this.Hc=e;const t=Ka();t&&typeof t.addEventListener=="function"&&t.addEventListener("visibilitychange",this.jc)}get isShuttingDown(){return this.$c}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.Jc(),this.Yc(e)}enterRestrictedMode(e){if(!this.$c){this.$c=!0,this.Gc=e||!1;const t=Ka();t&&typeof t.removeEventListener=="function"&&t.removeEventListener("visibilitychange",this.jc)}}enqueue(e){if(this.Jc(),this.$c)return new Promise((()=>{}));const t=new nn;return this.Yc((()=>this.$c&&this.Gc?Promise.resolve():(e().then(t.resolve,t.reject),t.promise))).then((()=>t.promise))}enqueueRetryable(e){this.enqueueAndForget((()=>(this.qc.push(e),this.Zc())))}async Zc(){if(this.qc.length!==0){try{await this.qc[0](),this.qc.shift(),this.xn.reset()}catch(e){if(!Hr(e))throw e;H(Eh,"Operation failed with retryable error: "+e)}this.qc.length>0&&this.xn.mn((()=>this.Zc()))}}Yc(e){const t=this.Hc.then((()=>(this.Qc=!0,e().catch((r=>{throw this.Wc=r,this.Qc=!1,an("INTERNAL UNHANDLED ERROR: ",wh(r)),r})).then((r=>(this.Qc=!1,r))))));return this.Hc=t,t}enqueueAfterDelay(e,t,r){this.Jc(),this.zc.indexOf(e)>-1&&(t=0);const s=gu.createAndSchedule(this,e,t,r,(i=>this.Xc(i)));return this.Kc.push(s),s}Jc(){this.Wc&&W(47125,{el:wh(this.Wc)})}verifyOperationInProgress(){}async tl(){let e;do e=this.Hc,await e;while(e!==this.Hc)}nl(e){for(const t of this.Kc)if(t.timerId===e)return!0;return!1}rl(e){return this.tl().then((()=>{this.Kc.sort(((t,r)=>t.targetTimeMs-r.targetTimeMs));for(const t of this.Kc)if(t.skipDelay(),e!=="all"&&t.timerId===e)break;return this.tl()}))}il(e){this.zc.push(e)}Xc(e){const t=this.Kc.indexOf(e);this.Kc.splice(t,1)}}function wh(n){let e=n.message||"";return n.stack&&(e=n.stack.includes(n.message)?n.stack:n.message+`
`+n.stack),e}class Wt extends Go{constructor(e,t,r,s){super(e,t,r,s),this.type="firestore",this._queue=new yh,this._persistenceKey=s?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new yh(e),this._firestoreClient=void 0,await e}}}function mE(n,e){const t=typeof n=="object"?n:Lc(),r=typeof n=="string"?n:e,s=Oo(t,"firestore").getImmediate({identifier:r});if(!s._initialized){const i=s2("firestore");i&&W4(s,...i)}return s}function gi(n){if(n._terminated)throw new F(D.FAILED_PRECONDITION,"The client has already been terminated.");return n._firestoreClient||W3(n),n._firestoreClient}function W3(n){const e=n._freezeSettings(),t=B4(n._databaseId,n._app?.options.appId||"",n._persistenceKey,n._app?.options.apiKey,e);n._componentsProvider||e.localCache?._offlineComponentProvider&&e.localCache?._onlineComponentProvider&&(n._componentsProvider={_offline:e.localCache._offlineComponentProvider,_online:e.localCache._onlineComponentProvider}),n._firestoreClient=new F3(n._authCredentials,n._appCheckCredentials,n._queue,t,n._componentsProvider&&(function(s){const i=s?._online.build();return{_offline:s?._offline.build(i),_online:i}})(n._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class z3{convertValue(e,t="none"){switch(De(e)){case 0:return null;case 1:return e.booleanValue;case 2:return Ee(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,t);case 5:return e.stringValue;case 6:return this.convertBytes(Ln(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,t);case 11:return this.convertObject(e.mapValue,t);case 10:return this.convertVectorValue(e.mapValue);default:throw W(62114,{value:e})}}convertObject(e,t){return this.convertObjectMap(e.fields,t)}convertObjectMap(e,t="none"){const r={};return jn(e,((s,i)=>{r[s]=this.convertValue(i,t)})),r}convertVectorValue(e){const t=e.fields?.[Hs].arrayValue?.values?.map((r=>Ee(r.doubleValue)));return new lt(t)}convertGeoPoint(e){return new qt(Ee(e.latitude),Ee(e.longitude))}convertArray(e,t){return(e.values||[]).map((r=>this.convertValue(r,t)))}convertServerTimestamp(e,t){switch(t){case"previous":const r=oi(e);return r==null?null:this.convertValue(r,t);case"estimate":return this.convertTimestamp(Dr(e));default:return null}}convertTimestamp(e){const t=Vn(e);return new me(t.seconds,t.nanos)}convertDocumentKey(e,t){const r=de.fromString(e);q(cd(r),9688,{name:e});const s=new $s(r.get(1),r.get(3)),i=new j(r.popFirst(5));return s.isEqual(t)||an(`Document ${i} contains a document reference within a different database (${s.projectId}/${s.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`),i}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vu extends z3{constructor(e){super(),this.firestore=e}convertBytes(e){return new At(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new ye(this.firestore,null,t)}}const Ih="@firebase/firestore",Th="4.16.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class af{constructor(e,t,r,s,i){this._firestore=e,this._userDataWriter=t,this._key=r,this._document=s,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new ye(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const e=new K3(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}_fieldsProto(){return this._document?.data.clone().value.mapValue.fields??void 0}get(e){if(this._document){const t=this._document.data.field(Un("DocumentSnapshot.get",e));if(t!==null)return this._userDataWriter.convertValue(t)}}}class K3 extends af{data(){return super.data()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cf(n){if(n.limitType==="L"&&n.explicitOrderBy.length===0)throw new F(D.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class Cu{}class uf extends Cu{}function gE(n,e,...t){let r=[];e instanceof Cu&&r.push(e),r=r.concat(t),(function(i){const o=i.filter((u=>u instanceof Su)).length,c=i.filter((u=>u instanceof na)).length;if(o>1||o>0&&c>0)throw new F(D.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")})(r);for(const s of r)n=s._apply(n);return n}class na extends uf{constructor(e,t,r){super(),this._field=e,this._op=t,this._value=r,this.type="where"}static _create(e,t,r){return new na(e,t,r)}_apply(e){const t=this._parse(e);return lf(e._query,t),new Wn(e.firestore,e.converter,mc(e._query,t))}_parse(e){const t=di(e.firestore);return(function(i,o,c,u,h,f,p){let w;if(h.isKeyField()){if(f==="array-contains"||f==="array-contains-any")throw new F(D.INVALID_ARGUMENT,`Invalid Query. You can't perform '${f}' queries on documentId().`);if(f==="in"||f==="not-in"){vh(p,f);const P=[];for(const L of p)P.push(Rh(u,i,L));w={arrayValue:{values:P}}}else w=Rh(u,i,p)}else f!=="in"&&f!=="not-in"&&f!=="array-contains-any"||vh(p,f),w=X4(c,o,p,f==="in"||f==="not-in");return be.create(h,f,w)})(e._query,"where",t,e.firestore._databaseId,this._field,this._op,this._value)}}function _E(n,e,t){const r=e,s=Un("where",n);return na._create(s,r,t)}class Su extends Cu{constructor(e,t){super(),this.type=e,this._queryConstraints=t}static _create(e,t){return new Su(e,t)}_parse(e){const t=this._queryConstraints.map((r=>r._parse(e))).filter((r=>r.getFilters().length>0));return t.length===1?t[0]:Dt.create(t,this._getOperator())}_apply(e){const t=this._parse(e);return t.getFilters().length===0?e:((function(s,i){let o=s;const c=i.getFlattenedFilters();for(const u of c)lf(o,u),o=mc(o,u)})(e._query,t),new Wn(e.firestore,e.converter,mc(e._query,t)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return this.type==="and"?"and":"or"}}class Pu extends uf{constructor(e,t){super(),this._field=e,this._direction=t,this.type="orderBy"}static _create(e,t){return new Pu(e,t)}_apply(e){const t=(function(s,i,o){if(s.startAt!==null)throw new F(D.INVALID_ARGUMENT,"Invalid query. You must not call startAt() or startAfter() before calling orderBy().");if(s.endAt!==null)throw new F(D.INVALID_ARGUMENT,"Invalid query. You must not call endAt() or endBefore() before calling orderBy().");return new zs(i,o)})(e._query,this._field,this._direction);return new Wn(e.firestore,e.converter,J7(e._query,t))}}function EE(n,e="asc"){const t=e,r=Un("orderBy",n);return Pu._create(r,t)}function Rh(n,e,t){if(typeof(t=X(t))=="string"){if(t==="")throw new F(D.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!Y2(e)&&t.indexOf("/")!==-1)throw new F(D.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${t}' contains a '/' character.`);const r=e.path.child(de.fromString(t));if(!j.isDocumentKey(r))throw new F(D.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);return Fl(n,new j(r))}if(t instanceof ye)return Fl(n,t._key);throw new F(D.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Do(t)}.`)}function vh(n,e){if(!Array.isArray(n)||n.length===0)throw new F(D.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${e.toString()}' filters.`)}function lf(n,e){const t=(function(s,i){for(const o of s)for(const c of o.getFlattenedFilters())if(i.indexOf(c.op)>=0)return c.op;return null})(n.filters,(function(s){switch(s){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}})(e.op));if(t!==null)throw t===e.op?new F(D.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${e.op.toString()}' filter.`):new F(D.INVALID_ARGUMENT,`Invalid query. You cannot use '${e.op.toString()}' filters with '${t.toString()}' filters.`)}function bu(n,e,t){let r;return r=n?t&&(t.merge||t.mergeFields)?n.toFirestore(e,t):n.toFirestore(e):e,r}class Ts{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class rr extends af{constructor(e,t,r,s,i,o){super(e,t,r,s,o),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new eo(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const r=this._document.data.field(Un("DocumentSnapshot.get",e));if(r!==null)return this._userDataWriter.convertValue(r,t.serverTimestamps)}}toJSON(){if(this.metadata.hasPendingWrites)throw new F(D.FAILED_PRECONDITION,"DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const e=this._document,t={};return t.type=rr._jsonSchemaVersion,t.bundle="",t.bundleSource="DocumentSnapshot",t.bundleName=this._key.toString(),!e||!e.isValidDocument()||!e.isFoundDocument()?t:(this._userDataWriter.convertObjectMap(e.data.value.mapValue.fields,"previous"),t.bundle=(this._firestore,this.ref.path,"NOT SUPPORTED"),t)}}rr._jsonSchemaVersion="firestore/documentSnapshot/1.0",rr._jsonSchema={type:Ne("string",rr._jsonSchemaVersion),bundleSource:Ne("string","DocumentSnapshot"),bundleName:Ne("string"),bundle:Ne("string")};class eo extends rr{data(e={}){return super.data(e)}}class sr{constructor(e,t,r,s){this._firestore=e,this._userDataWriter=t,this._snapshot=s,this.metadata=new Ts(s.hasPendingWrites,s.fromCache),this.query=r}get docs(){const e=[];return this.forEach((t=>e.push(t))),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,t){this._snapshot.docs.forEach((r=>{e.call(t,new eo(this._firestore,this._userDataWriter,r.key,r,new Ts(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))}))}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new F(D.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=(function(s,i){if(s._snapshot.oldDocs.isEmpty()){let o=0;return s._snapshot.docChanges.map((c=>{Ue(s._snapshot.query)?Tc(s._snapshot.query):$c(s.query._query);const u=new eo(s._firestore,s._userDataWriter,c.doc.key,c.doc,new Ts(s._snapshot.mutatedKeys.has(c.doc.key),s._snapshot.fromCache),s.query.converter);return c.doc,{type:"added",doc:u,oldIndex:-1,newIndex:o++}}))}{let o=s._snapshot.oldDocs;return s._snapshot.docChanges.filter((c=>i||c.type!==3)).map((c=>{const u=new eo(s._firestore,s._userDataWriter,c.doc.key,c.doc,new Ts(s._snapshot.mutatedKeys.has(c.doc.key),s._snapshot.fromCache),s.query.converter);let h=-1,f=-1;return c.type!==0&&(h=o.indexOf(c.doc.key),o=o.delete(c.doc.key)),c.type!==1&&(o=o.add(c.doc),f=o.indexOf(c.doc.key)),{type:Y3(c.type),doc:u,oldIndex:h,newIndex:f}}))}})(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}toJSON(){if(this.metadata.hasPendingWrites)throw new F(D.FAILED_PRECONDITION,"QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const e={};e.type=sr._jsonSchemaVersion,e.bundleSource="QuerySnapshot",e.bundleName=Mc.newId(),this._firestore._databaseId.database,this._firestore._databaseId.projectId;const t=[],r=[],s=[];return this.docs.forEach((i=>{i._document!==null&&(t.push(i._document),r.push(this._userDataWriter.convertObjectMap(i._document.data.value.mapValue.fields,"previous")),s.push(i.ref.path))})),e.bundle=(this._firestore,this.query._query,e.bundleName,"NOT SUPPORTED"),e}}function Y3(n){switch(n){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return W(61501,{type:n})}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yE(n){n=it(n,ye);const e=it(n.firestore,Wt),t=gi(e);return q3(t,n._key).then((r=>hf(e,n,r)))}function wE(n){n=it(n,Wn);const e=it(n.firestore,Wt),t=gi(e),r=new vu(e);return cf(n._query),j3(t,n._query).then((s=>new sr(e,r,n,s)))}function IE(n,e,t){n=it(n,ye);const r=it(n.firestore,Wt),s=bu(n.converter,e,t),i=di(r);return _i(r,[Wc(i,"setDoc",n._key,s,n.converter!==null,t).toMutation(n._key,ot.none())])}function TE(n,e,t,...r){n=it(n,ye);const s=it(n.firestore,Wt),i=di(s);let o;return o=typeof(e=X(e))=="string"||e instanceof li?yd(i,"updateDoc",n._key,e,t,r):Ed(i,"updateDoc",n._key,e),_i(s,[o.toMutation(n._key,ot.exists(!0))])}function AE(n){return _i(it(n.firestore,Wt),[new $o(n._key,ot.none())])}function RE(n,e){const t=it(n.firestore,Wt),r=z4(n),s=bu(n.converter,e),i=di(n.firestore);return _i(t,[Wc(i,"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,ot.exists(!1))]).then((()=>r))}function vE(n,...e){n=X(n);let t={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||Ah(e[r])||(t=e[r++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(Ah(e[r])){const h=e[r];e[r]=h.next?.bind(h),e[r+1]=h.error?.bind(h),e[r+2]=h.complete?.bind(h)}let i,o,c;if(n instanceof ye)o=it(n.firestore,Wt),c=Ho(n._key.path),i={next:h=>{e[r]&&e[r](hf(o,n,h))},error:e[r+1],complete:e[r+2]};else{const h=it(n,Wn);o=it(h.firestore,Wt),c=h._query;const f=new vu(o);i={next:p=>{e[r]&&e[r](new sr(o,f,h,p))},error:e[r+1],complete:e[r+2]},cf(n._query)}const u=gi(o);return H3(u,c,s,i)}function _i(n,e){const t=gi(n);return G3(t,e)}function hf(n,e,t){const r=t.docs.get(e._key),s=new vu(n);return new rr(n,s,e._key,r,new Ts(t.hasPendingWrites,t.fromCache),e.converter)}function CE(n){return n=it(n,Wt),gi(n),new Q3(n,(e=>_i(n,e)))}(function(e,t=!0){s7(fr),ar(new kn("firestore",((r,{instanceIdentifier:s,options:i})=>{const o=r.getProvider("app").getImmediate(),c=new Wt(new a7(r.getProvider("auth-internal")),new l7(o,r.getProvider("app-check-internal")),b7(o,s),o);return i={useFetchStreams:t,...i},c._setSettings(i),c}),"PUBLIC").setMultipleInstances(!0)),Bt(Ih,Th,e),Bt(Ih,Th,"esm2020")})();function df(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const X3=df,ff=new ri("auth","Firebase",df());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bt(n,...e){throw Ou(n,...e)}function ht(n,...e){return Ou(n,...e)}function Nu(n,e,t){const r={...X3(),[e]:t};return new ri("auth","Firebase",r).create(e,{appName:n.name})}function at(n){return Nu(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function ra(n,e,t){const r=t;if(!(e instanceof r))throw r.name!==e.constructor.name&&bt(n,"argument-error"),Nu(n,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function Ou(n,...e){if(typeof n!="string"){const t=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=n.name),n._errorFactory.create(t,...r)}return ff.create(n,...e)}function $(n,e,...t){if(!n)throw Ou(e,...t)}function en(n){const e="INTERNAL ASSERTION FAILED: "+n;throw to(e),new Error(e)}function un(n,e){n||en(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ei(){return typeof self<"u"&&self.location?.href||""}function ku(){return Ch()==="http:"||Ch()==="https:"}function Ch(){return typeof self<"u"&&self.location?.protocol||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Z3(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(ku()||Rp()||"connection"in navigator)?navigator.onLine:!0}function e9(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ei{constructor(e,t){this.shortDelay=e,this.longDelay=t,un(t>e,"Short delay should be less than long delay!"),this.isMobile=Ip()||vp()}get(){return Z3()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Du(n,e){un(n.emulator,"Emulator should always be set here");const{url:t}=n.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const n9=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],r9=new Ei(3e4,6e4);function Fe(n,e){return n.tenantId&&!e.tenantId?{...e,tenantId:n.tenantId}:e}async function Be(n,e,t,r,s={}){return mf(n,s,async()=>{let i={},o={};r&&(e==="GET"?o=r:i={body:JSON.stringify(r)});const c=Fr({...o,key:n.config.apiKey}).slice(1),u=await n._getAdditionalHeaders();u["Content-Type"]="application/json",n.languageCode&&(u["X-Firebase-Locale"]=n.languageCode);const h={method:e,headers:u,...i};return Ap()||(h.referrerPolicy="strict-origin-when-cross-origin"),n.emulatorConfig&&dr(n.emulatorConfig.host)&&(h.credentials="include"),pf.fetch()(await gf(n,n.config.apiHost,t,c),h)})}async function mf(n,e,t){n._canInitEmulator=!1;const r={...t9,...e};try{const s=new i9(n),i=await Promise.race([t(),s.promise]);s.clearNetworkTimeout();const o=await i.json();if("needConfirmation"in o)throw As(n,"account-exists-with-different-credential",o);if(i.ok&&!("errorMessage"in o))return o;{const c=i.ok?o.errorMessage:o.error.message,[u,h]=c.split(" : ");if(u==="FEDERATED_USER_ID_ALREADY_LINKED")throw As(n,"credential-already-in-use",o);if(u==="EMAIL_EXISTS")throw As(n,"email-already-in-use",o);if(u==="USER_DISABLED")throw As(n,"user-disabled",o);const f=r[u]||u.toLowerCase().replace(/[_\s]+/g,"-");if(h)throw Nu(n,f,h);bt(n,f)}}catch(s){if(s instanceof Yt)throw s;bt(n,"network-request-failed",{message:String(s)})}}async function hn(n,e,t,r,s={}){const i=await Be(n,e,t,r,s);return"mfaPendingCredential"in i&&bt(n,"multi-factor-auth-required",{_serverResponse:i}),i}async function gf(n,e,t,r){const s=`${e}${t}?${r}`,i=n,o=i.config.emulator?Du(n.config,s):`${n.config.apiScheme}://${s}`;return n9.includes(t)&&(await i._persistenceManagerAvailable,i._getPersistenceType()==="COOKIE")?i._getPersistence()._getFinalTarget(o).toString():o}function s9(n){switch(n){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class i9{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,r)=>{this.timer=setTimeout(()=>r(ht(this.auth,"network-request-failed")),r9.get())})}}function As(n,e,t){const r={appName:n.name};t.email&&(r.email=t.email),t.phoneNumber&&(r.phoneNumber=t.phoneNumber);const s=ht(n,e,r);return s.customData._tokenResponse=t,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function o9(n){return(await Be(n,"GET","/v1/recaptchaParams")).recaptchaSiteKey||""}async function Ef(n,e){return Be(n,"GET","/v2/recaptchaConfig",Fe(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ds(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function u9(n,e=!1){const t=X(n),r=await t.getIdToken(e),s=sa(r);$(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,o=i?.sign_in_provider;return{claims:s,token:r,authTime:Ds(Xa(s.auth_time)),issuedAtTime:Ds(Xa(s.iat)),expirationTime:Ds(Xa(s.exp)),signInProvider:o||null,signInSecondFactor:i?.sign_in_second_factor||null}}function Xa(n){return Number(n)*1e3}function sa(n){const[e,t,r]=n.split(".");if(e===void 0||t===void 0||r===void 0)return to("JWT malformed, contained fewer than 3 sections"),null;try{const s=n2(t);return s?JSON.parse(s):(to("Failed to decode base64 JWT payload"),null)}catch(s){return to("Caught error parsing JWT payload as JSON",s?.toString()),null}}function bh(n){const e=sa(n);return $(e,"internal-error"),$(typeof e.exp<"u","internal-error"),$(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ti(n){const e=n.auth,t=await n.getIdToken(),r=await lr(n,Ro(e,{idToken:t}));$(r?.users.length,e,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const i=s.providerUserInfo?.length?wf(s.providerUserInfo):[],o=d9(n.providerData,i),c=n.isAnonymous,u=!(n.email&&s.passwordHash)&&!o?.length,h=c?u:!1,f={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:o,metadata:new Pc(s.createdAt,s.lastLoginAt),isAnonymous:h};Object.assign(n,f)}async function yf(n){const e=X(n);await ti(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function d9(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function wf(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function f9(n,e){const t=await mf(n,{},async()=>{const r=Fr({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:i}=n.config,o=await gf(n,s,"/v1/token",`key=${i}`),c=await n._getAdditionalHeaders();c["Content-Type"]="application/x-www-form-urlencoded";const u={method:"POST",headers:c,body:r};return n.emulatorConfig&&dr(n.emulatorConfig.host)&&(u.credentials="include"),pf.fetch()(o,u)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function p9(n,e){return Be(n,"POST","/v2/accounts:revokeToken",Fe(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nh=new Map;function tn(n){un(n instanceof Function,"Expected a class definition");let e=Nh.get(n);return e?(un(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,Nh.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class If{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}If.type="NONE";const bc=If;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oh(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(vf(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Tf(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Sf(e))return"Blackberry";if(Pf(e))return"Webos";if(Af(e))return"Safari";if((e.includes("chrome/")||Rf(e))&&!e.includes("edge/"))return"Chrome";if(Cf(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if(r?.length===2)return r[1]}return"Other"}function Tf(n=Je()){return/firefox\//i.test(n)}function Af(n=Je()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Rf(n=Je()){return/crios\//i.test(n)}function vf(n=Je()){return/iemobile/i.test(n)}function Cf(n=Je()){return/android/i.test(n)}function Sf(n=Je()){return/blackberry/i.test(n)}function Pf(n=Je()){return/webos/i.test(n)}function Vu(n=Je()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function m9(n=Je()){return Vu(n)&&!!window.navigator?.standalone}function g9(){return Cp()&&document.documentMode===10}function bf(n=Je()){return Vu(n)||Cf(n)||Pf(n)||Sf(n)||/windows phone/i.test(n)||vf(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nf(n,e=[]){let t;switch(n){case"Browser":t=Oh(Je());break;case"Worker":t=`${Oh(Je())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${fr}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function L9(n,e){const t=Oo(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(or(i,e??{}))return s;bt(s,"already-initialized")}return t.initialize({options:e})}function x9(n,e){const t=e?.persistence||[],r=(Array.isArray(t)?t:[t]).map(tn);e?.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e?.popupRedirectResolver)}function Nc(n,e,t){const r=je(n);$(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=kf(e),{host:o,port:c}=M9(e),u=c===null?"":`:${c}`,h={url:`${i}//${o}${u}/`},f=Object.freeze({host:o,port:c,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){$(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),$(or(h,r.config.emulator)&&or(f,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=h,r.emulatorConfig=f,r.settings.appVerificationDisabledForTesting=!0,dr(o)?kc(`${i}//${o}${u}`):U9()}function kf(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function M9(n){const e=kf(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:Vh(r.substr(i.length+1))}}else{const[i,o]=r.split(":");return{host:i,port:Vh(o)}}}function Vh(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function U9(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ls extends ia{constructor(e){super("phone","phone"),this.params=e}static _fromVerification(e,t){return new Ls({verificationId:e,verificationCode:t})}static _fromTokenResponse(e,t){return new Ls({phoneNumber:e,temporaryProof:t})}_getIdTokenResponse(e){return X9(e,this._makeVerificationRequest())}_linkToIdToken(e,t){return J9(e,{idToken:t,...this._makeVerificationRequest()})}_getReauthenticationResolver(e){return e8(e,this._makeVerificationRequest())}_makeVerificationRequest(){const{temporaryProof:e,phoneNumber:t,verificationId:r,verificationCode:s}=this.params;return e&&t?{temporaryProof:e,phoneNumber:t}:{sessionInfo:r,code:s}}toJSON(){const e={providerId:this.providerId};return this.params.phoneNumber&&(e.phoneNumber=this.params.phoneNumber),this.params.temporaryProof&&(e.temporaryProof=this.params.temporaryProof),this.params.verificationCode&&(e.verificationCode=this.params.verificationCode),this.params.verificationId&&(e.verificationId=this.params.verificationId),e}static fromJSON(e){typeof e=="string"&&(e=JSON.parse(e));const{verificationId:t,verificationCode:r,phoneNumber:s,temporaryProof:i}=e;return!r&&!t&&!s&&!i?null:new Ls({verificationId:t,verificationCode:r,phoneNumber:s,temporaryProof:i})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function t8(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function n8(n){const e=_s(Es(n)).link,t=e?_s(Es(e)).deep_link_id:null,r=_s(Es(n)).deep_link_id;return(r?_s(Es(r)).link:null)||r||t||e||n}class aa{constructor(e){const t=_s(Es(e)),r=t.apiKey??null,s=t.oobCode??null,i=t8(t.mode??null);$(r&&s&&i,"argument-error"),this.apiKey=r,this.operation=i,this.code=s,this.continueUrl=t.continueUrl??null,this.languageCode=t.lang??null,this.tenantId=t.tenantId??null}static parseLink(e){const t=n8(e);try{return new aa(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ln{constructor(){this.providerId=ln.PROVIDER_ID}static credential(e,t){return ni._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=aa.parseLink(t);return $(r,"argument-error"),ni._fromEmailAndCode(e,r.code,r.tenantId)}}ln.PROVIDER_ID="password";ln.EMAIL_PASSWORD_SIGN_IN_METHOD="password";ln.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rt extends Qr{constructor(){super("facebook.com")}static credential(e){return zt._fromParams({providerId:Rt.PROVIDER_ID,signInMethod:Rt.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Rt.credentialFromTaggedObject(e)}static credentialFromError(e){return Rt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Rt.credential(e.oauthAccessToken)}catch{return null}}}Rt.FACEBOOK_SIGN_IN_METHOD="facebook.com";Rt.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vt extends Qr{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return zt._fromParams({providerId:vt.PROVIDER_ID,signInMethod:vt.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return vt.credentialFromTaggedObject(e)}static credentialFromError(e){return vt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return vt.credential(t,r)}catch{return null}}}vt.GOOGLE_SIGN_IN_METHOD="google.com";vt.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ct extends Qr{constructor(){super("github.com")}static credential(e){return zt._fromParams({providerId:Ct.PROVIDER_ID,signInMethod:Ct.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Ct.credentialFromTaggedObject(e)}static credentialFromError(e){return Ct.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Ct.credential(e.oauthAccessToken)}catch{return null}}}Ct.GITHUB_SIGN_IN_METHOD="github.com";Ct.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class St extends Qr{constructor(){super("twitter.com")}static credential(e,t){return zt._fromParams({providerId:St.PROVIDER_ID,signInMethod:St.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return St.credentialFromTaggedObject(e)}static credentialFromError(e){return St.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:r}=e;if(!t||!r)return null;try{return St.credential(t,r)}catch{return null}}}St.TWITTER_SIGN_IN_METHOD="twitter.com";St.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Df(n,e){return hn(n,"POST","/v1/accounts:signUp",Fe(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function s8(n,e){const t=X(n);await ca(!0,t,e);const{providerUserInfo:r}=await c9(t.auth,{idToken:await t.getIdToken(),deleteProvider:[e]}),s=Lf(r||[]);return t.providerData=t.providerData.filter(i=>s.has(i.providerId)),s.has("phone")||(t.phoneNumber=null),await t.auth._persistUserIfCurrent(t),t}async function xf(n,e,t=!1){const r=await lr(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return Kt._forOperation(n,"link",r)}async function ca(n,e,t){await ti(e);const r=Lf(e.providerData),s=n===!1?"provider-already-linked":"no-such-provider";$(r.has(t)===n,e.auth,s)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Uf(n,e,t=!1){if(Pe(n.app))return Promise.reject(at(n));const r="signIn",s=await Vf(n,r,e),i=await Kt._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(i.user),i}async function xu(n,e){return Uf(je(n),e)}async function Ff(n,e){const t=X(n);return await ca(!1,t,e.providerId),xf(t,e)}async function SE(n,e){return Mf(X(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Mu(n){const e=je(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function a8(n,e,t){const r=je(n),s={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};t&&ua(r,s,t),await On(r,s,"getOobCode",G9,"EMAIL_PASSWORD_PROVIDER")}async function c8(n,e,t){await F9(X(n),{oobCode:e,newPassword:t}).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&Mu(n),r})}async function u8(n,e){await H9(X(n),{oobCode:e})}async function l8(n,e,t){if(Pe(n.app))return Promise.reject(at(n));const r=je(n),o=await On(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Df,"EMAIL_PASSWORD_PROVIDER").catch(u=>{throw u.code==="auth/password-does-not-meet-requirements"&&Mu(n),u}),c=await Kt._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(c.user),c}function h8(n,e,t){return Pe(n.app)?Promise.reject(at(n)):xu(X(n),ln.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&Mu(n),r})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function d8(n,e,t){const r=je(n),s={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function i(o,c){$(c.handleCodeInApp,r,"argument-error"),c&&ua(r,o,c)}i(s,t),await On(r,s,"getOobCode",W9,"EMAIL_PASSWORD_PROVIDER")}function f8(n,e){return aa.parseLink(e)?.operation==="EMAIL_SIGNIN"}async function p8(n,e,t){if(Pe(n.app))return Promise.reject(at(n));const r=X(n),s=ln.credentialWithLink(e,t||ei());return $(s._tenantId===(r.tenantId||null),r,"tenant-id-mismatch"),xu(r,s)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function A8(n){if(!n)return null;const{providerId:e}=n,t=n.rawUserInfo?JSON.parse(n.rawUserInfo):{},r=n.isNewUser||n.kind==="identitytoolkit#SignupNewUserResponse";if(!e&&n?.idToken){const s=sa(n.idToken)?.firebase?.sign_in_provider;if(s){const i=s!=="anonymous"&&s!=="custom"?s:null;return new Nr(r,i)}}if(!e)return null;switch(e){case"facebook.com":return new R8(r,t);case"github.com":return new v8(r,t);case"google.com":return new C8(r,t);case"twitter.com":return new S8(r,t,n.screenName||null);case"custom":case"anonymous":return new Nr(r,null);default:return new Nr(r,e,t)}}class Nr{constructor(e,t,r={}){this.isNewUser=e,this.providerId=t,this.profile=r}}class $f extends Nr{constructor(e,t,r,s){super(e,t,r),this.username=s}}class R8 extends Nr{constructor(e,t){super(e,"facebook.com",t)}}class v8 extends $f{constructor(e,t){super(e,"github.com",t,typeof t?.login=="string"?t?.login:null)}}class C8 extends Nr{constructor(e,t){super(e,"google.com",t)}}class S8 extends $f{constructor(e,t,r){super(e,"twitter.com",t,r)}}function P8(n){const{user:e,_tokenResponse:t}=n;return e.isAnonymous&&!t?{providerId:null,isNewUser:!1,profile:null}:A8(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mh(n,e){return Be(n,"POST","/v2/accounts/mfaEnrollment:start",Fe(n,e))}const Co="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gf extends Hf{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}Gf.type="SESSION";const Uu=Gf;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fu(){return typeof Se().WorkerGlobalScope<"u"&&typeof Se().importScripts=="function"}async function U8(){if(!navigator?.serviceWorker)return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function F8(){return navigator?.serviceWorker?.controller||null}function B8(){return Fu()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bh(n,e){return Be(n,"POST","/v2/accounts/mfaSignIn:start",Fe(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ja=Of("rcb"),W8=new Ei(3e4,6e4);class z8{constructor(){this.hostLanguage="",this.counter=0,this.librarySeparatelyLoaded=!!Se().grecaptcha?.render}load(e,t=""){return $(K8(t),e,"argument-error"),this.shouldResolveImmediately(t)&&Sh(Se().grecaptcha)?Promise.resolve(Se().grecaptcha):new Promise((r,s)=>{const i=Se().setTimeout(()=>{s(ht(e,"network-request-failed"))},W8.get());Se()[Ja]=()=>{Se().clearTimeout(i),delete Se()[Ja];const c=Se().grecaptcha;if(!c||!Sh(c)){s(ht(e,"internal-error"));return}const u=c.render;c.render=(h,f)=>{const p=u(h,f);return this.counter++,p},this.hostLanguage=t,r(c)};const o=`${A9()}?${Fr({onload:Ja,render:"explicit",hl:t})}`;Lu(o).catch(()=>{clearTimeout(i),s(ht(e,"internal-error"))})})}clearedOneInstance(){this.counter--}shouldResolveImmediately(e){return!!Se().grecaptcha?.render&&(e===this.hostLanguage||this.counter>0||this.librarySeparatelyLoaded)}}function K8(n){return n.length<=6&&/^\s*[a-zA-Z0-9\-]*\s*$/.test(n)}class Y8{async load(e){return new P9(e)}clearedOneInstance(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xf{constructor(e,t){this.verificationId=e,this.onConfirmation=t}confirm(e){const t=Ls._fromVerification(this.verificationId,e);return this.onConfirmation(t)}}async function J8(n,e,t){if(Pe(n.app))return Promise.reject(at(n));const r=je(n),s=await Jf(r,e,X(t));return new Xf(s,i=>xu(r,i))}async function Z8(n,e,t){const r=X(n);await ca(!1,r,"phone");const s=await Jf(r.auth,e,X(t));return new Xf(s,i=>Ff(r,i))}async function Jf(n,e,t){if(!n._getRecaptchaConfig())try{await V9(n)}catch{console.log("Failed to initialize reCAPTCHA Enterprise config. Triggering the reCAPTCHA v2 verification.")}try{let r;if(typeof e=="string"?r={phoneNumber:e}:r=e,"session"in r){const s=r.session;if("phoneNumber"in r){$(s.type==="enroll",n,"internal-error");const i={idToken:s.credential,phoneEnrollmentInfo:{phoneNumber:r.phoneNumber,clientType:"CLIENT_TYPE_WEB"}};return(await On(n,i,"mfaSmsEnrollment",async(h,f)=>{if(f.phoneEnrollmentInfo.captchaResponse===Vs){$(t?.type===xs,h,"argument-error");const p=await Za(h,f,t);return Mh(h,p)}return Mh(h,f)},"PHONE_PROVIDER").catch(h=>Promise.reject(h))).phoneSessionInfo.sessionInfo}else{$(s.type==="signin",n,"internal-error");const i=r.multiFactorHint?.uid||r.multiFactorUid;$(i,n,"missing-multi-factor-info");const o={mfaPendingCredential:s.credential,mfaEnrollmentId:i,phoneSignInInfo:{clientType:"CLIENT_TYPE_WEB"}};return(await On(n,o,"mfaSmsSignIn",async(f,p)=>{if(p.phoneSignInInfo.captchaResponse===Vs){$(t?.type===xs,f,"argument-error");const w=await Za(f,p,t);return Bh(f,w)}return Bh(f,p)},"PHONE_PROVIDER").catch(f=>Promise.reject(f))).phoneResponseInfo.sessionInfo}}else{const s={phoneNumber:r.phoneNumber,clientType:"CLIENT_TYPE_WEB"};return(await On(n,s,"sendVerificationCode",async(u,h)=>{if(h.captchaResponse===Vs){$(t?.type===xs,u,"argument-error");const f=await Za(u,h,t);return Lh(u,f)}return Lh(u,h)},"PHONE_PROVIDER").catch(u=>Promise.reject(u))).sessionInfo}}finally{t?._reset()}}async function Za(n,e,t){$(t.type===xs,n,"argument-error");const r=await t.verify();$(typeof r=="string",n,"argument-error");const s={...e};if("phoneEnrollmentInfo"in s){const i=s.phoneEnrollmentInfo.phoneNumber,o=s.phoneEnrollmentInfo.captchaResponse,c=s.phoneEnrollmentInfo.clientType,u=s.phoneEnrollmentInfo.recaptchaVersion;return Object.assign(s,{phoneEnrollmentInfo:{phoneNumber:i,recaptchaToken:r,captchaResponse:o,clientType:c,recaptchaVersion:u}}),s}else if("phoneSignInInfo"in s){const i=s.phoneSignInInfo.captchaResponse,o=s.phoneSignInInfo.clientType,c=s.phoneSignInInfo.recaptchaVersion;return Object.assign(s,{phoneSignInInfo:{recaptchaToken:r,captchaResponse:i,clientType:o,recaptchaVersion:c}}),s}else return Object.assign(s,{recaptchaToken:r}),s}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const o_="pendingRedirect",ro=new Map;class a_ extends Zf{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=ro.get(this.auth._key());if(!e){try{const r=await c_(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}ro.set(this.auth._key(),e)}return this.bypassAuthState||ro.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function c_(n,e){const t=n6(e),r=t6(n);if(!await r._isAvailable())return!1;const s=await r._get(t)==="true";return await r._remove(t),s}async function e6(n,e){return t6(n)._set(n6(e),"true")}function u_(n,e){ro.set(n._key(),e)}function t6(n){return tn(n._redirectPersistence)}function n6(n){return no(o_,n.config.apiKey,n.name)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function l_(n,e,t){return h_(n,e,t)}async function h_(n,e,t){if(Pe(n.app))return Promise.reject(at(n));const r=je(n);ra(n,e,Yr),await r._initializationPromise;const s=Ii(r,t);return await e6(s,r),s._openRedirect(r,e,"signInViaRedirect")}function d_(n,e,t){return f_(n,e,t)}async function f_(n,e,t){const r=X(n);ra(r.auth,e,Yr),await r.auth._initializationPromise;const s=Ii(r.auth,t);await ca(!1,r,e.providerId),await e6(s,r.auth);const i=await m_(r);return s._openRedirect(r.auth,e,"linkViaRedirect",i)}async function p_(n,e){return await je(n)._initializationPromise,r6(n,e,!1)}async function r6(n,e,t=!1){if(Pe(n.app))return Promise.reject(at(n));const r=je(n),s=Ii(r,e),o=await new a_(r,s,t).execute();return o&&!t&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}async function m_(n){const e=ha(`${n.uid}:::`);return n._redirectEventId=e,await n.auth._setRedirectUser(n),await n.auth._persistUserIfCurrent(n),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const g_=600*1e3;class __{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach(r=>{this.isEventForConsumer(e,r)&&(t=!0,this.sendToConsumer(e,r),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!E_(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){if(e.error&&!s6(e)){const r=e.error.code?.split("auth/")[1]||"internal-error";t.onError(ht(this.auth,r))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const r=t.eventId===null||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&r}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=g_&&this.cachedEventUids.clear(),this.cachedEventUids.has(Hh(e))}saveEventToCache(e){this.cachedEventUids.add(Hh(e)),this.lastProcessedEventTime=Date.now()}}function Hh(n){return[n.type,n.eventId,n.sessionId,n.tenantId].filter(e=>e).join("-")}function s6({type:n,error:e}){return n==="unknown"&&e?.code==="auth/no-auth-event"}function E_(n){switch(n.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return s6(n);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const R_=new Ei(3e4,6e4);function qh(){const n=Se().___jsl;if(n?.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function v_(n){return new Promise((e,t)=>{function r(){qh(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{qh(),t(ht(n,"network-request-failed"))},timeout:R_.get()})}if(Se().gapi?.iframes?.Iframe)e(gapi.iframes.getContext());else if(Se().gapi?.load)r();else{const s=Of("iframefcb");return Se()[s]=()=>{gapi.load?r():t(ht(n,"network-request-failed"))},Lu(`${v9()}?onload=${s}`).catch(i=>t(i))}}).catch(e=>{throw so=null,e})}let so=null;function C_(n){return so=so||v_(n),so}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const V_={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},L_=500,x_=600,M_="_blank",U_="http://localhost";class jh{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function F_(n,e,t,r=L_,s=x_){const i=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-r)/2,0).toString();let c="";const u={...V_,width:r.toString(),height:s.toString(),top:i,left:o},h=Je().toLowerCase();t&&(c=Rf(h)?M_:t),Tf(h)&&(e=e||U_,u.scrollbars="yes");const f=Object.entries(u).reduce((w,[b,P])=>`${w}${b}=${P},`,"");if(m9(h)&&c!=="_self")return B_(e||"",c),new jh(null);const p=window.open(e||"",c,f);$(p,n,"popup-blocked");try{p.focus()}catch{}return new jh(p)}function B_(n,e){const t=document.createElement("a");t.href=n,t.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $_="__/auth/handler",H_="emulator/auth/handler",q_=encodeURIComponent("fac");async function Gh(n,e,t,r,s,i){$(n.config.authDomain,n,"auth-domain-config-required"),$(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:fr,eventId:s};if(e instanceof Yr){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",Dp(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,p]of Object.entries({}))o[f]=p}if(e instanceof Qr){const f=e.getScopes().filter(p=>p!=="");f.length>0&&(o.scopes=f.join(","))}n.tenantId&&(o.tid=n.tenantId);const c=o;for(const f of Object.keys(c))c[f]===void 0&&delete c[f];const u=await n._getAppCheckToken(),h=u?`#${q_}=${encodeURIComponent(u)}`:"";return`${j_(n)}?${Fr(c).slice(1)}${h}`}function j_({config:n}){return n.emulator?Du(n,H_):`https://${n.authDomain}/${$_}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function K_(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Y_(n){ar(new kn("auth",(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:o,authDomain:c}=r.options;$(o&&!o.includes(":"),"invalid-api-key",{appName:r.name});const u={apiKey:o,authDomain:c,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Nf(n)},h=new I9(r,s,i,u);return x9(h,t),h},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider("auth-internal").initialize()})),ar(new kn("auth-internal",e=>{const t=je(e.getProvider("auth").getImmediate());return(r=>new z_(r))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Bt(Wh,zh,K_(n)),Bt(Wh,zh,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Q_=300,X_=o2("authIdTokenMaxAge")||Q_;let Kh=null;const J_=n=>async e=>{const t=e&&await e.getIdTokenResult(),r=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(r&&r>X_)return;const s=t?.token;Kh!==s&&(Kh=s,await fetch(n,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function se(n=Lc()){const e=Oo(n,"auth");if(e.isInitialized())return e.getImmediate();const t=L9(n,{popupRedirectResolver:W_,persistence:[Qf,jf,Uu]}),r=o2("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const o=J_(i.toString());N8(t,o,()=>o(t.currentUser)),b8(t,c=>o(c))}}const s=r2("auth");return s&&Nc(t,`http://${s}`),t}function Z_(){return document.getElementsByTagName("head")?.[0]??document}T9({loadJS(n){return new Promise((e,t)=>{const r=document.createElement("script");r.setAttribute("src",n),r.onload=e,r.onerror=s=>{const i=ht("internal-error");i.customData=s,t(i)},r.type="text/javascript",r.charset="UTF-8",Z_().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Y_("Browser");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i6="firebasestorage.googleapis.com",o6="storageBucket",e5=120*1e3,t5=600*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function y5(n){return n!==void 0}function w5(n){return typeof n=="object"&&!Array.isArray(n)}function Hu(n){return typeof n=="string"||n instanceof String}function Yh(n){return qu()&&n instanceof Blob}function qu(){return typeof Blob<"u"}function Qh(n,e,t,r){if(r<e)throw Oc(`Invalid value for '${n}'. Expected ${e} or greater.`);if(r>t)throw Oc(`Invalid value for '${n}'. Expected ${t} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ju(n,e,t){let r=e;return t==null&&(r=`https://${e}`),`${t}://${r}/v0${n}`}function c6(n){const e=encodeURIComponent;let t="?";for(const r in n)if(n.hasOwnProperty(r)){const s=e(r)+"="+e(n[r]);t=t+s+"&"}return t=t.slice(0,-1),t}var ir;(function(n){n[n.NO_ERROR=0]="NO_ERROR",n[n.NETWORK_ERROR=1]="NETWORK_ERROR",n[n.ABORT=2]="ABORT"})(ir||(ir={}));/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ft={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class nc{constructor(e,t){this.data=e,this.contentType=t||null}}function k5(n,e){switch(n){case Ft.RAW:return new nc(u6(e));case Ft.BASE64:case Ft.BASE64URL:return new nc(l6(n,e));case Ft.DATA_URL:return new nc(V5(e),L5(e))}throw $u()}function u6(n){const e=[];for(let t=0;t<n.length;t++){let r=n.charCodeAt(t);if(r<=127)e.push(r);else if(r<=2047)e.push(192|r>>6,128|r&63);else if((r&64512)===55296)if(!(t<n.length-1&&(n.charCodeAt(t+1)&64512)===56320))e.push(239,191,189);else{const i=r,o=n.charCodeAt(++t);r=65536|(i&1023)<<10|o&1023,e.push(240|r>>18,128|r>>12&63,128|r>>6&63,128|r&63)}else(r&64512)===56320?e.push(239,191,189):e.push(224|r>>12,128|r>>6&63,128|r&63)}return new Uint8Array(e)}function D5(n){let e;try{e=decodeURIComponent(n)}catch{throw Ms(Ft.DATA_URL,"Malformed data URL.")}return u6(e)}function l6(n,e){switch(n){case Ft.BASE64:{const s=e.indexOf("-")!==-1,i=e.indexOf("_")!==-1;if(s||i)throw Ms(n,"Invalid character '"+(s?"-":"_")+"' found: is it base64url encoded?");break}case Ft.BASE64URL:{const s=e.indexOf("+")!==-1,i=e.indexOf("/")!==-1;if(s||i)throw Ms(n,"Invalid character '"+(s?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let t;try{t=O5(e)}catch(s){throw s.message.includes("polyfill")?s:Ms(n,"Invalid character found")}const r=new Uint8Array(t.length);for(let s=0;s<t.length;s++)r[s]=t.charCodeAt(s);return r}class h6{constructor(e){this.base64=!1,this.contentType=null;const t=e.match(/^data:([^,]+)?,/);if(t===null)throw Ms(Ft.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const r=t[1]||null;r!=null&&(this.base64=x5(r,";base64"),this.contentType=this.base64?r.substring(0,r.length-7):r),this.rest=e.substring(e.indexOf(",")+1)}}function V5(n){const e=new h6(n);return e.base64?l6(Ft.BASE64,e.rest):D5(e.rest)}function L5(n){return new h6(n).contentType}function x5(n,e){return n.length>=e.length?n.substring(n.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class An{constructor(e,t){let r=0,s="";Yh(e)?(this.data_=e,r=e.size,s=e.type):e instanceof ArrayBuffer?(t?this.data_=new Uint8Array(e):(this.data_=new Uint8Array(e.byteLength),this.data_.set(new Uint8Array(e))),r=this.data_.length):e instanceof Uint8Array&&(t?this.data_=e:(this.data_=new Uint8Array(e.length),this.data_.set(e)),r=e.length),this.size_=r,this.type_=s}size(){return this.size_}type(){return this.type_}slice(e,t){if(Yh(this.data_)){const r=this.data_,s=N5(r,e,t);return s===null?null:new An(s)}else{const r=new Uint8Array(this.data_.buffer,e,t-e);return new An(r,!0)}}static getBlob(...e){if(qu()){const t=e.map(r=>r instanceof An?r.data_:r);return new An(b5.apply(null,t))}else{const t=e.map(o=>Hu(o)?k5(Ft.RAW,o).data:o.data_);let r=0;t.forEach(o=>{r+=o.byteLength});const s=new Uint8Array(r);let i=0;return t.forEach(o=>{for(let c=0;c<o.length;c++)s[i++]=o[c]}),new An(s,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function d6(n){let e;try{e=JSON.parse(n)}catch{return null}return w5(e)?e:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function M5(n){if(n.length===0)return null;const e=n.lastIndexOf("/");return e===-1?"":n.slice(0,e)}function U5(n,e){const t=e.split("/").filter(r=>r.length>0).join("/");return n.length===0?t:n+"/"+t}function f6(n){const e=n.lastIndexOf("/",n.length-2);return e===-1?n:n.slice(e+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function F5(n,e){return e}class nt{constructor(e,t,r,s){this.server=e,this.local=t||e,this.writable=!!r,this.xform=s||F5}}let zi=null;function B5(n){return!Hu(n)||n.length<2?n:f6(n)}function p6(){if(zi)return zi;const n=[];n.push(new nt("bucket")),n.push(new nt("generation")),n.push(new nt("metageneration")),n.push(new nt("name","fullPath",!0));function e(i,o){return B5(o)}const t=new nt("name");t.xform=e,n.push(t);function r(i,o){return o!==void 0?Number(o):o}const s=new nt("size");return s.xform=r,n.push(s),n.push(new nt("timeCreated")),n.push(new nt("updated")),n.push(new nt("md5Hash",null,!0)),n.push(new nt("cacheControl",null,!0)),n.push(new nt("contentDisposition",null,!0)),n.push(new nt("contentEncoding",null,!0)),n.push(new nt("contentLanguage",null,!0)),n.push(new nt("contentType",null,!0)),n.push(new nt("metadata","customMetadata",!0)),zi=n,zi}function $5(n,e){function t(){const r=n.bucket,s=n.fullPath,i=new yt(r,s);return e._makeStorageReference(i)}Object.defineProperty(n,"ref",{get:t})}function H5(n,e,t){const r={};r.type="file";const s=t.length;for(let i=0;i<s;i++){const o=t[i];r[o.local]=o.xform(r,e[o.server])}return $5(r,n),r}function m6(n,e,t){const r=d6(e);return r===null?null:H5(n,r,t)}function q5(n,e,t,r){const s=d6(e);if(s===null||!Hu(s.downloadTokens))return null;const i=s.downloadTokens;if(i.length===0)return null;const o=encodeURIComponent;return i.split(",").map(h=>{const f=n.bucket,p=n.fullPath,w="/b/"+o(f)+"/o/"+o(p),b=ju(w,t,r),P=c6({alt:"media",token:h});return b+P})[0]}function j5(n,e){const t={},r=e.length;for(let s=0;s<r;s++){const i=e[s];i.writable&&(t[i.server]=n[i.local])}return JSON.stringify(t)}class g6{constructor(e,t,r,s){this.url=e,this.method=t,this.handler=r,this.timeout=s,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _6(n){if(!n)throw $u()}function G5(n,e){function t(r,s){const i=m6(n,s,e);return _6(i!==null),i}return t}function W5(n,e){function t(r,s){const i=m6(n,s,e);return _6(i!==null),q5(i,s,n.host,n._protocol)}return t}function E6(n){function e(t,r){let s;return t.getStatus()===401?t.getErrorText().includes("Firebase App Check token is invalid")?s=i5():s=s5():t.getStatus()===402?s=r5(n.bucket):t.getStatus()===403?s=o5(n.path):s=r,s.status=t.getStatus(),s.serverResponse=r.serverResponse,s}return e}function z5(n){const e=E6(n);function t(r,s){let i=e(r,s);return r.getStatus()===404&&(i=n5(n.path)),i.serverResponse=s.serverResponse,i}return t}function K5(n,e,t){const r=e.fullServerUrl(),s=ju(r,n.host,n._protocol),i="GET",o=n.maxOperationRetryTime,c=new g6(s,i,W5(n,t),o);return c.errorHandler=z5(e),c}function Y5(n,e){return n&&n.contentType||e&&e.type()||"application/octet-stream"}function Q5(n,e,t){const r=Object.assign({},t);return r.fullPath=n.path,r.size=e.size(),r.contentType||(r.contentType=Y5(null,e)),r}function X5(n,e,t,r,s){const i=e.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};function c(){let re="";for(let he=0;he<2;he++)re=re+Math.random().toString().slice(2);return re}const u=c();o["Content-Type"]="multipart/related; boundary="+u;const h=Q5(e,r,s),f=j5(h,t),p="--"+u+`\r
...
\r
`,w=`\r
--`+u+"--",b=An.getBlob(p,r,w);if(b===null)throw d5();const P={name:h.fullPath},L=ju(i,n.host,n._protocol),x="POST",z=n.maxUploadRetryTime,te=new g6(L,x,G5(n,t),z);return te.urlParams=P,te.headers=o,te.body=b.uploadData(),te.errorHandler=E6(e),te}class J5{constructor(){this.sent_=!1,this.xhr_=new XMLHttpRequest,this.initXhr(),this.errorCode_=ir.NO_ERROR,this.sendPromise_=new Promise(e=>{this.xhr_.addEventListener("abort",()=>{this.errorCode_=ir.ABORT,e()}),this.xhr_.addEventListener("error",()=>{this.errorCode_=ir.NETWORK_ERROR,e()}),this.xhr_.addEventListener("load",()=>{e()})})}send(e,t,r,s,i){if(this.sent_)throw gs("cannot .send() more than once");if(dr(e)&&r&&(this.xhr_.withCredentials=!0),this.sent_=!0,this.xhr_.open(t,e,!0),i!==void 0)for(const o in i)i.hasOwnProperty(o)&&this.xhr_.setRequestHeader(o,i[o].toString());return s!==void 0?this.xhr_.send(s):this.xhr_.send(),this.sendPromise_}getErrorCode(){if(!this.sent_)throw gs("cannot .getErrorCode() before sending");return this.errorCode_}getStatus(){if(!this.sent_)throw gs("cannot .getStatus() before sending");try{return this.xhr_.status}catch{return-1}}getResponse(){if(!this.sent_)throw gs("cannot .getResponse() before sending");return this.xhr_.response}getErrorText(){if(!this.sent_)throw gs("cannot .getErrorText() before sending");return this.xhr_.statusText}abort(){this.xhr_.abort()}getResponseHeader(e){return this.xhr_.getResponseHeader(e)}addUploadProgressListener(e){this.xhr_.upload!=null&&this.xhr_.upload.addEventListener("progress",e)}removeUploadProgressListener(e){this.xhr_.upload!=null&&this.xhr_.upload.removeEventListener("progress",e)}}class Z5 extends J5{initXhr(){this.xhr_.responseType="text"}}function y6(){return new Z5}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hr{constructor(e,t){this._service=e,t instanceof yt?this._location=t:this._location=yt.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new hr(e,t)}get root(){const e=new yt(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return f6(this._location.path)}get storage(){return this._service}get parent(){const e=M5(this._location.path);if(e===null)return null;const t=new yt(this._location.bucket,e);return new hr(this._service,t)}_throwIfRoot(e){if(this._location.path==="")throw m5(e)}}function eE(n,e,t){n._throwIfRoot("uploadBytes");const r=X5(n.storage,n._location,p6(),new An(e,!0),t);return n.storage.makeRequestWithTokens(r,y6).then(s=>({metadata:s,ref:n}))}function tE(n){n._throwIfRoot("getDownloadURL");const e=K5(n.storage,n._location,p6());return n.storage.makeRequestWithTokens(e,y6).then(t=>{if(t===null)throw f5();return t})}function nE(n,e){const t=U5(n._location.path,e),r=new yt(n._location.bucket,t);return new hr(n.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rE(n){return/^[A-Za-z]+:\/\//.test(n)}function sE(n,e){return new hr(n,e)}function w6(n,e){if(n instanceof Gu){const t=n;if(t._bucket==null)throw h5();const r=new hr(t,t._bucket);return e!=null?w6(r,e):r}else return e!==void 0?nE(n,e):n}function iE(n,e){if(e&&rE(e)){if(n instanceof Gu)return sE(n,e);throw Oc("To use ref(service, url), the first argument must be a Storage instance.")}else return w6(n,e)}function Xh(n,e){const t=e?.[o6];return t==null?null:yt.makeFromBucketSpec(t,n)}function oE(n,e,t,r={}){n.host=`${e}:${t}`;const s=dr(e);s&&kc(`https://${n.host}/b`),n._isUsingEmulator=!0,n._protocol=s?"https":"http";const{mockUserToken:i}=r;i&&(n._overrideAuthToken=typeof i=="string"?i:c2(i,n.app.options.projectId))}class Gu{constructor(e,t,r,s,i,o=!1){this.app=e,this._authProvider=t,this._appCheckProvider=r,this._url=s,this._firebaseVersion=i,this._isUsingEmulator=o,this._bucket=null,this._host=i6,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=e5,this._maxUploadRetryTime=t5,this._requests=new Set,s!=null?this._bucket=yt.makeFromBucketSpec(s,this._host):this._bucket=Xh(this._host,this.app.options)}get host(){return this._host}set host(e){this._host=e,this._url!=null?this._bucket=yt.makeFromBucketSpec(this._url,e):this._bucket=Xh(e,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(e){Qh("time",0,Number.POSITIVE_INFINITY,e),this._maxUploadRetryTime=e}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(e){Qh("time",0,Number.POSITIVE_INFINITY,e),this._maxOperationRetryTime=e}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const e=this._authProvider.getImmediate({optional:!0});if(e){const t=await e.getToken();if(t!==null)return t.accessToken}return null}async _getAppCheckToken(){if(Pe(this.app)&&this.app.settings.appCheckToken)return this.app.settings.appCheckToken;const e=this._appCheckProvider.getImmediate({optional:!0});return e?(await e.getToken()).token:null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach(e=>e.cancel()),this._requests.clear()),Promise.resolve()}_makeStorageReference(e){return new hr(this,e)}_makeRequest(e,t,r,s,i=!0){if(this._deleted)return new g5(a6());{const o=S5(e,this._appId,r,s,t,this._firebaseVersion,i,this._isUsingEmulator);return this._requests.add(o),o.getPromise().then(()=>this._requests.delete(o),()=>this._requests.delete(o)),o}}async makeRequestWithTokens(e,t){const[r,s]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(e,t,r,s).getPromise()}}const Jh="@firebase/storage",Zh="0.14.3";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
