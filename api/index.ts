...
app.post("/api/generate-trivia", async (req, res) => {
  try {
    const gradeLevel = req.body.gradeLevel || req.body.userGrade || req.body.studyLevel;
    const academicStream = req.body.academicStream || req.body.stream || "General Science & Logic";
